...
$viewdocumentooficialcredito_add = NULL; // Initialize page object first

class cviewdocumentooficialcredito_add extends cviewdocumentooficialcredito {
	...
	// Page object name
	var $PageObjName = 'viewdocumentooficialcredito_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "viewdocumentooficialcreditoview.php")
	...
	function AddRow($rsold = NULL) {
		...
		if ($this->path_drive->getSessionValue() <> "") {
			$sMasterFilter = str_replace("@id@", ew_AdjustSql($this->path_drive->getSessionValue(), "DB"), $sMasterFilter);
		} else {
		...
		// path_drive
		if ($this->path_drive->getSessionValue() <> "") {
			$rsnew['path_drive'] = $this->path_drive->getSessionValue();
		}
...
// Create page object
if (!isset($viewdocumentooficialcredito_add)) $viewdocumentooficialcredito_add = new cviewdocumentooficialcredito_add();

// Page init
$viewdocumentooficialcredito_add->Page_Init();

// Page main
$viewdocumentooficialcredito_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$viewdocumentooficialcredito_add->Page_Render();
?>
...
var CurrentForm = fviewdocumentooficialcreditoadd = new ew_Form("fviewdocumentooficialcreditoadd", "add");

// Validate form
fviewdocumentooficialcreditoadd.Validate = function() {
...
fviewdocumentooficialcreditoadd.Form_CustomValidate = 
...
fviewdocumentooficialcreditoadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fviewdocumentooficialcreditoadd.Lists["x_avaluo"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_tipoinmueble","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"avaluo"};
fviewdocumentooficialcreditoadd.Lists["x_avaluo"].Data = "<?php echo $viewdocumentooficialcredito_add->avaluo->LookupFilterQuery(FALSE, "add") ?>";
fviewdocumentooficialcreditoadd.Lists["x_id_tipodocumento"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipodocumento"};
fviewdocumentooficialcreditoadd.Lists["x_id_tipodocumento"].Data = "<?php echo $viewdocumentooficialcredito_add->id_tipodocumento->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $viewdocumentooficialcredito_add->ShowPageHeader(); ?>
<?php
$viewdocumentooficialcredito_add->ShowMessage();
?>
<form name="fviewdocumentooficialcreditoadd" id="fviewdocumentooficialcreditoadd" class="<?php echo $viewdocumentooficialcredito_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($viewdocumentooficialcredito_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $viewdocumentooficialcredito_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="viewdocumentooficialcredito">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($viewdocumentooficialcredito_add->IsModal) ?>">
...
<?php } ?>
<?php if (!$viewdocumentooficialcredito_add->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($viewdocumentooficialcredito_add->IsMobileOrModal) { ?>
<div class="ewAddDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_viewdocumentooficialcreditoadd" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($viewdocumentooficialcredito->descripcion->Visible) { // descripcion ?>
<?php if ($viewdocumentooficialcredito_add->IsMobileOrModal) { ?>
	<div id="r_descripcion" class="form-group">
		<label id="elh_viewdocumentooficialcredito_descripcion" for="x_descripcion" class="<?php echo $viewdocumentooficialcredito_add->LeftColumnClass ?>"><?php echo $viewdocumentooficialcredito->descripcion->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $viewdocumentooficialcredito_add->RightColumnClass ?>"><div<?php echo $viewdocumentooficialcredito->descripcion->CellAttributes() ?>>
...
<?php if ($viewdocumentooficialcredito_add->IsMobileOrModal) { ?>
	<div id="r_imagen" class="form-group">
		<label id="elh_viewdocumentooficialcredito_imagen" class="<?php echo $viewdocumentooficialcredito_add->LeftColumnClass ?>"><?php echo $viewdocumentooficialcredito->imagen->FldCaption() ?></label>
...
<?php if ($viewdocumentooficialcredito_add->IsMobileOrModal) { ?>
	<div id="r_avaluo" class="form-group">
		<label id="elh_viewdocumentooficialcredito_avaluo" for="x_avaluo" class="<?php echo $viewdocumentooficialcredito_add->LeftColumnClass ?>"><?php echo $viewdocumentooficialcredito->avaluo->FldCaption() ?></label>
		<div class="<?php echo $viewdocumentooficialcredito_add->RightColumnClass ?>"><div<?php echo $viewdocumentooficialcredito->avaluo->CellAttributes() ?>>
...
<?php if ($viewdocumentooficialcredito_add->IsMobileOrModal) { ?>
	<div id="r_id_tipodocumento" class="form-group">
		<label id="elh_viewdocumentooficialcredito_id_tipodocumento" for="x_id_tipodocumento" class="<?php echo $viewdocumentooficialcredito_add->LeftColumnClass ?>"><?php echo $viewdocumentooficialcredito->id_tipodocumento->FldCaption() ?></label>
...
<?php } ?>
<?php if (strval($viewdocumentooficialcredito->path_drive->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_path_drive" id="x_path_drive" value="<?php echo ew_HtmlEncode(strval($viewdocumentooficialcredito->path_drive->getSessionValue())) ?>">
<?php } ?>
<?php if (!$viewdocumentooficialcredito_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $viewdocumentooficialcredito_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $viewdocumentooficialcredito_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fviewdocumentooficialcreditoadd.Init();
</script>
<?php
$viewdocumentooficialcredito_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$viewdocumentooficialcredito_add->Page_Terminate();
?>
