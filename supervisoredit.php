...
$supervisor_edit = NULL; // Initialize page object first

class csupervisor_edit extends csupervisor {
	...
	// Page object name
	var $PageObjName = 'supervisor_edit';
...
// Create page object
if (!isset($supervisor_edit)) $supervisor_edit = new csupervisor_edit();

// Page init
$supervisor_edit->Page_Init();

// Page main
$supervisor_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$supervisor_edit->Page_Render();
?>
...
var CurrentForm = fsupervisoredit = new ew_Form("fsupervisoredit", "edit");

// Validate form
fsupervisoredit.Validate = function() {
...
fsupervisoredit.Form_CustomValidate = 
...
fsupervisoredit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fsupervisoredit.Lists["x_id_rol"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"userlevels"};
fsupervisoredit.Lists["x_id_rol"].Data = "<?php echo $supervisor_edit->id_rol->LookupFilterQuery(FALSE, "edit") ?>";
fsupervisoredit.Lists["x_id_sucursal"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"sucursal"};
fsupervisoredit.Lists["x_id_sucursal"].Data = "<?php echo $supervisor_edit->id_sucursal->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $supervisor_edit->ShowPageHeader(); ?>
<?php
$supervisor_edit->ShowMessage();
?>
<form name="fsupervisoredit" id="fsupervisoredit" class="<?php echo $supervisor_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($supervisor_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $supervisor_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="supervisor">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($supervisor_edit->IsModal) ?>">
<?php if (!$supervisor_edit->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($supervisor_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_supervisoredit" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($supervisor->nombre->Visible) { // nombre ?>
<?php if ($supervisor_edit->IsMobileOrModal) { ?>
	<div id="r_nombre" class="form-group">
		<label id="elh_supervisor_nombre" for="x_nombre" class="<?php echo $supervisor_edit->LeftColumnClass ?>"><?php echo $supervisor->nombre->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $supervisor_edit->RightColumnClass ?>"><div<?php echo $supervisor->nombre->CellAttributes() ?>>
...
<?php if ($supervisor_edit->IsMobileOrModal) { ?>
	<div id="r_apellido" class="form-group">
		<label id="elh_supervisor_apellido" for="x_apellido" class="<?php echo $supervisor_edit->LeftColumnClass ?>"><?php echo $supervisor->apellido->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $supervisor_edit->RightColumnClass ?>"><div<?php echo $supervisor->apellido->CellAttributes() ?>>
...
<?php if ($supervisor_edit->IsMobileOrModal) { ?>
	<div id="r__login" class="form-group">
		<label id="elh_supervisor__login" for="x__login" class="<?php echo $supervisor_edit->LeftColumnClass ?>"><?php echo $supervisor->_login->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $supervisor_edit->RightColumnClass ?>"><div<?php echo $supervisor->_login->CellAttributes() ?>>
<span id="el_supervisor__login">
<span<?php echo $supervisor->_login->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $supervisor->_login->EditValue ?></p></span>
</span>
<input type="hidden" data-table="supervisor" data-field="x__login" name="x__login" id="x__login" value="<?php echo ew_HtmlEncode($supervisor->_login->CurrentValue) ?>">
...
<?php if ($supervisor_edit->IsMobileOrModal) { ?>
	<div id="r_password" class="form-group">
		<label id="elh_supervisor_password" for="x_password" class="<?php echo $supervisor_edit->LeftColumnClass ?>"><?php echo $supervisor->password->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $supervisor_edit->RightColumnClass ?>"><div<?php echo $supervisor->password->CellAttributes() ?>>
<span id="el_supervisor_password">
<div class="input-group" id="ig_password">
<input type="password" data-password-generated="pgt_password" data-table="supervisor" data-field="x_password" name="x_password" id="x_password" value="<?php echo $supervisor->password->EditValue ?>" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($supervisor->password->getPlaceHolder()) ?>"<?php echo $supervisor->password->EditAttributes() ?>>
...
<?php if ($supervisor_edit->IsMobileOrModal) { ?>
	<div id="r_ci" class="form-group">
		<label id="elh_supervisor_ci" for="x_ci" class="<?php echo $supervisor_edit->LeftColumnClass ?>"><?php echo $supervisor->ci->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $supervisor_edit->RightColumnClass ?>"><div<?php echo $supervisor->ci->CellAttributes() ?>>
...
<?php if ($supervisor_edit->IsMobileOrModal) { ?>
	<div id="r_id_rol" class="form-group">
		<label id="elh_supervisor_id_rol" for="x_id_rol" class="<?php echo $supervisor_edit->LeftColumnClass ?>"><?php echo $supervisor->id_rol->FldCaption() ?></label>
		<div class="<?php echo $supervisor_edit->RightColumnClass ?>"><div<?php echo $supervisor->id_rol->CellAttributes() ?>>
<span id="el_supervisor_id_rol">
<span<?php echo $supervisor->id_rol->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $supervisor->id_rol->EditValue ?></p></span>
</span>
<input type="hidden" data-table="supervisor" data-field="x_id_rol" name="x_id_rol" id="x_id_rol" value="<?php echo ew_HtmlEncode($supervisor->id_rol->CurrentValue) ?>">
<?php echo $supervisor->id_rol->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_id_rol">
		<td class="col-sm-3"><span id="elh_supervisor_id_rol"><?php echo $supervisor->id_rol->FldCaption() ?></span></td>
...
<?php if ($supervisor_edit->IsMobileOrModal) { ?>
	<div id="r_id_sucursal" class="form-group">
		<label id="elh_supervisor_id_sucursal" for="x_id_sucursal" class="<?php echo $supervisor_edit->LeftColumnClass ?>"><?php echo $supervisor->id_sucursal->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $supervisor_edit->RightColumnClass ?>"><div<?php echo $supervisor->id_sucursal->CellAttributes() ?>>
...
<?php if ($supervisor_edit->IsMobileOrModal) { ?>
	<div id="r__email" class="form-group">
		<label id="elh_supervisor__email" for="x__email" class="<?php echo $supervisor_edit->LeftColumnClass ?>"><?php echo $supervisor->_email->FldCaption() ?></label>
		<div class="<?php echo $supervisor_edit->RightColumnClass ?>"><div<?php echo $supervisor->_email->CellAttributes() ?>>
...
<?php if ($supervisor_edit->IsMobileOrModal) { ?>
	<div id="r_telefono_fijo01" class="form-group">
		<label id="elh_supervisor_telefono_fijo01" for="x_telefono_fijo01" class="<?php echo $supervisor_edit->LeftColumnClass ?>"><?php echo $supervisor->telefono_fijo01->FldCaption() ?></label>
		<div class="<?php echo $supervisor_edit->RightColumnClass ?>"><div<?php echo $supervisor->telefono_fijo01->CellAttributes() ?>>
...
<?php if ($supervisor_edit->IsMobileOrModal) { ?>
	<div id="r_telefono_fijo02" class="form-group">
		<label id="elh_supervisor_telefono_fijo02" for="x_telefono_fijo02" class="<?php echo $supervisor_edit->LeftColumnClass ?>"><?php echo $supervisor->telefono_fijo02->FldCaption() ?></label>
		<div class="<?php echo $supervisor_edit->RightColumnClass ?>"><div<?php echo $supervisor->telefono_fijo02->CellAttributes() ?>>
...
<?php if ($supervisor_edit->IsMobileOrModal) { ?>
	<div id="r_celular" class="form-group">
		<label id="elh_supervisor_celular" for="x_celular" class="<?php echo $supervisor_edit->LeftColumnClass ?>"><?php echo $supervisor->celular->FldCaption() ?></label>
		<div class="<?php echo $supervisor_edit->RightColumnClass ?>"><div<?php echo $supervisor->celular->CellAttributes() ?>>
...
<?php if ($supervisor_edit->IsMobileOrModal) { ?>
	<div id="r_celular2" class="form-group">
		<label id="elh_supervisor_celular2" for="x_celular2" class="<?php echo $supervisor_edit->LeftColumnClass ?>"><?php echo $supervisor->celular2->FldCaption() ?></label>
		<div class="<?php echo $supervisor_edit->RightColumnClass ?>"><div<?php echo $supervisor->celular2->CellAttributes() ?>>
...
<?php if ($supervisor_edit->IsMobileOrModal) { ?>
	<div id="r_direccion" class="form-group">
		<label id="elh_supervisor_direccion" for="x_direccion" class="<?php echo $supervisor_edit->LeftColumnClass ?>"><?php echo $supervisor->direccion->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $supervisor_edit->RightColumnClass ?>"><div<?php echo $supervisor->direccion->CellAttributes() ?>>
...
<?php if ($supervisor_edit->IsMobileOrModal) { ?>
	<div id="r_cargo" class="form-group">
		<label id="elh_supervisor_cargo" for="x_cargo" class="<?php echo $supervisor_edit->LeftColumnClass ?>"><?php echo $supervisor->cargo->FldCaption() ?></label>
		<div class="<?php echo $supervisor_edit->RightColumnClass ?>"><div<?php echo $supervisor->cargo->CellAttributes() ?>>
...
<?php if ($supervisor_edit->IsMobileOrModal) { ?>
	<div id="r_id_institucion" class="form-group">
		<label id="elh_supervisor_id_institucion" for="x_id_institucion" class="<?php echo $supervisor_edit->LeftColumnClass ?>"><?php echo $supervisor->id_institucion->FldCaption() ?></label>
		<div class="<?php echo $supervisor_edit->RightColumnClass ?>"><div<?php echo $supervisor->id_institucion->CellAttributes() ?>>
...
<?php if ($supervisor_edit->IsMobileOrModal) { ?>
	<div id="r_especialidad" class="form-group">
		<label id="elh_supervisor_especialidad" for="x_especialidad" class="<?php echo $supervisor_edit->LeftColumnClass ?>"><?php echo $supervisor->especialidad->FldCaption() ?></label>
		<div class="<?php echo $supervisor_edit->RightColumnClass ?>"><div<?php echo $supervisor->especialidad->CellAttributes() ?>>
...
<?php if ($supervisor_edit->IsMobileOrModal) { ?>
	<div id="r_codigo" class="form-group">
		<label id="elh_supervisor_codigo" for="x_codigo" class="<?php echo $supervisor_edit->LeftColumnClass ?>"><?php echo $supervisor->codigo->FldCaption() ?></label>
		<div class="<?php echo $supervisor_edit->RightColumnClass ?>"><div<?php echo $supervisor->codigo->CellAttributes() ?>>
...
<?php } ?>
<?php if (!$supervisor_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $supervisor_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $supervisor_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fsupervisoredit.Init();
</script>
<?php
$supervisor_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$supervisor_edit->Page_Terminate();
?>
