...
$viewdocumentooficialcredito_grid = NULL; // Initialize page object first

class cviewdocumentooficialcredito_grid extends cviewdocumentooficialcredito {
	...
	// Page object name
	var $PageObjName = 'viewdocumentooficialcredito_grid';

	// Grid form hidden field names
	var $FormName = 'fviewdocumentooficialcreditogrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["viewdocumentooficialcredito"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "viewavaluo") {
			$this->path_drive->Visible = FALSE;
			if ($GLOBALS["viewavaluo"]->EventCancelled) $this->EventCancelled = TRUE;
