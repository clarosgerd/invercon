...
$viewdocumentooficialcredito_view = NULL; // Initialize page object first

class cviewdocumentooficialcredito_view extends cviewdocumentooficialcredito {
	...
	// Page object name
	var $PageObjName = 'viewdocumentooficialcredito_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "viewdocumentooficialcreditolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "viewdocumentooficialcreditolist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "viewdocumentooficialcreditolist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($viewdocumentooficialcredito_view)) $viewdocumentooficialcredito_view = new cviewdocumentooficialcredito_view();

// Page init
$viewdocumentooficialcredito_view->Page_Init();

// Page main
$viewdocumentooficialcredito_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$viewdocumentooficialcredito_view->Page_Render();
?>
...
var CurrentForm = fviewdocumentooficialcreditoview = new ew_Form("fviewdocumentooficialcreditoview", "view");

// Form_CustomValidate event
fviewdocumentooficialcreditoview.Form_CustomValidate = 
...
fviewdocumentooficialcreditoview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fviewdocumentooficialcreditoview.Lists["x_avaluo"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_tipoinmueble","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"avaluo"};
fviewdocumentooficialcreditoview.Lists["x_avaluo"].Data = "<?php echo $viewdocumentooficialcredito_view->avaluo->LookupFilterQuery(FALSE, "view") ?>";
fviewdocumentooficialcreditoview.Lists["x_id_tipodocumento"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipodocumento"};
fviewdocumentooficialcreditoview.Lists["x_id_tipodocumento"].Data = "<?php echo $viewdocumentooficialcredito_view->id_tipodocumento->LookupFilterQuery(FALSE, "view") ?>";
...
<div class="ewToolbar">
<?php $viewdocumentooficialcredito_view->ExportOptions->Render("body") ?>
<?php
	foreach ($viewdocumentooficialcredito_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $viewdocumentooficialcredito_view->ShowPageHeader(); ?>
<?php
$viewdocumentooficialcredito_view->ShowMessage();
?>
<form name="fviewdocumentooficialcreditoview" id="fviewdocumentooficialcreditoview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($viewdocumentooficialcredito_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $viewdocumentooficialcredito_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="viewdocumentooficialcredito">
<input type="hidden" name="modal" value="<?php echo intval($viewdocumentooficialcredito_view->IsModal) ?>">
...
<?php if ($viewdocumentooficialcredito->id->Visible) { // id ?>
	<tr id="r_id">
		...
		<td data-name="id"<?php echo $viewdocumentooficialcredito->id->CellAttributes() ?>>
<span id="el_viewdocumentooficialcredito_id">
<span<?php echo $viewdocumentooficialcredito->id->ViewAttributes() ?>>
<?php echo $viewdocumentooficialcredito->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($viewdocumentooficialcredito->descripcion->Visible) { // descripcion ?>
	<tr id="r_descripcion">
		<td class="col-sm-3"><span id="elh_viewdocumentooficialcredito_descripcion"><?php echo $viewdocumentooficialcredito->descripcion->FldCaption() ?></span></td>
...
<?php echo $viewdocumentooficialcredito->descripcion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo ew_GetFileViewTag($viewdocumentooficialcredito->imagen, $viewdocumentooficialcredito->imagen->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php echo $viewdocumentooficialcredito->avaluo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $viewdocumentooficialcredito->id_tipodocumento->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fviewdocumentooficialcreditoview.Init();
</script>
<?php
$viewdocumentooficialcredito_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$viewdocumentooficialcredito_view->Page_Terminate();
?>
