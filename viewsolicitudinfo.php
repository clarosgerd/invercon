...
class cviewsolicitud extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'viewsolicitud';
		$this->TableName = 'viewsolicitud';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`viewsolicitud`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('viewsolicitud', 'viewsolicitud', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// name
		$this->name = new cField('viewsolicitud', 'viewsolicitud', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// address
		$this->address = new cField('viewsolicitud', 'viewsolicitud', 'x_address', 'address', '`address`', '`address`', 200, -1, FALSE, '`address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// longitud
		$this->longitud = new cField('viewsolicitud', 'viewsolicitud', 'x_longitud', 'longitud', '`longitud`', '`longitud`', 5, -1, FALSE, '`longitud`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tipoinmueble
		$this->tipoinmueble = new cField('viewsolicitud', 'viewsolicitud', 'x_tipoinmueble', 'tipoinmueble', '`tipoinmueble`', '`tipoinmueble`', 200, -1, FALSE, '`tipoinmueble`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// imagen_inmueble01
		$this->imagen_inmueble01 = new cField('viewsolicitud', 'viewsolicitud', 'x_imagen_inmueble01', 'imagen_inmueble01', '`imagen_inmueble01`', '`imagen_inmueble01`', 205, -1, TRUE, '`imagen_inmueble01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		...
		// imagen_inmueble06
		$this->imagen_inmueble06 = new cField('viewsolicitud', 'viewsolicitud', 'x_imagen_inmueble06', 'imagen_inmueble06', '`imagen_inmueble06`', '`imagen_inmueble06`', 205, -1, TRUE, '`imagen_inmueble06`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_inmueble06->Sortable = FALSE; // Allow sort
		$this->fields['imagen_inmueble06'] = &$this->imagen_inmueble06;

		// imagen_inmueble07
		$this->imagen_inmueble07 = new cField('viewsolicitud', 'viewsolicitud', 'x_imagen_inmueble07', 'imagen_inmueble07', '`imagen_inmueble07`', '`imagen_inmueble07`', 205, -1, TRUE, '`imagen_inmueble07`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_inmueble07->Sortable = FALSE; // Allow sort
		$this->fields['imagen_inmueble07'] = &$this->imagen_inmueble07;

		// imagen_inmueble08
		$this->imagen_inmueble08 = new cField('viewsolicitud', 'viewsolicitud', 'x_imagen_inmueble08', 'imagen_inmueble08', '`imagen_inmueble08`', '`imagen_inmueble08`', 205, -1, TRUE, '`imagen_inmueble08`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_inmueble08->Sortable = FALSE; // Allow sort
		$this->fields['imagen_inmueble08'] = &$this->imagen_inmueble08;

		// tipovehiculo
		$this->tipovehiculo = new cField('viewsolicitud', 'viewsolicitud', 'x_tipovehiculo', 'tipovehiculo', '`tipovehiculo`', '`tipovehiculo`', 200, -1, FALSE, '`tipovehiculo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// imagen_vehiculo01
		$this->imagen_vehiculo01 = new cField('viewsolicitud', 'viewsolicitud', 'x_imagen_vehiculo01', 'imagen_vehiculo01', '`imagen_vehiculo01`', '`imagen_vehiculo01`', 205, -1, TRUE, '`imagen_vehiculo01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_vehiculo01->Sortable = FALSE; // Allow sort
		$this->fields['imagen_vehiculo01'] = &$this->imagen_vehiculo01;

		// imagen_vehiculo02
		$this->imagen_vehiculo02 = new cField('viewsolicitud', 'viewsolicitud', 'x_imagen_vehiculo02', 'imagen_vehiculo02', '`imagen_vehiculo02`', '`imagen_vehiculo02`', 205, -1, TRUE, '`imagen_vehiculo02`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_vehiculo02->Sortable = FALSE; // Allow sort
		$this->fields['imagen_vehiculo02'] = &$this->imagen_vehiculo02;

		// imagen_vehiculo03
		$this->imagen_vehiculo03 = new cField('viewsolicitud', 'viewsolicitud', 'x_imagen_vehiculo03', 'imagen_vehiculo03', '`imagen_vehiculo03`', '`imagen_vehiculo03`', 205, -1, TRUE, '`imagen_vehiculo03`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_vehiculo03->Sortable = FALSE; // Allow sort
		$this->fields['imagen_vehiculo03'] = &$this->imagen_vehiculo03;

		// imagen_vehiculo04
		$this->imagen_vehiculo04 = new cField('viewsolicitud', 'viewsolicitud', 'x_imagen_vehiculo04', 'imagen_vehiculo04', '`imagen_vehiculo04`', '`imagen_vehiculo04`', 205, -1, TRUE, '`imagen_vehiculo04`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		...
		// imagen_vehiculo08
		$this->imagen_vehiculo08 = new cField('viewsolicitud', 'viewsolicitud', 'x_imagen_vehiculo08', 'imagen_vehiculo08', '`imagen_vehiculo08`', '`imagen_vehiculo08`', 205, -1, TRUE, '`imagen_vehiculo08`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_vehiculo08->Sortable = FALSE; // Allow sort
		$this->fields['imagen_vehiculo08'] = &$this->imagen_vehiculo08;

		// tipomaquinaria
		$this->tipomaquinaria = new cField('viewsolicitud', 'viewsolicitud', 'x_tipomaquinaria', 'tipomaquinaria', '`tipomaquinaria`', '`tipomaquinaria`', 200, -1, FALSE, '`tipomaquinaria`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// imagen_maquinaria01
		$this->imagen_maquinaria01 = new cField('viewsolicitud', 'viewsolicitud', 'x_imagen_maquinaria01', 'imagen_maquinaria01', '`imagen_maquinaria01`', '`imagen_maquinaria01`', 205, -1, TRUE, '`imagen_maquinaria01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_maquinaria01->Sortable = FALSE; // Allow sort
		$this->fields['imagen_maquinaria01'] = &$this->imagen_maquinaria01;

		// imagen_maquinaria02
		$this->imagen_maquinaria02 = new cField('viewsolicitud', 'viewsolicitud', 'x_imagen_maquinaria02', 'imagen_maquinaria02', '`imagen_maquinaria02`', '`imagen_maquinaria02`', 205, -1, TRUE, '`imagen_maquinaria02`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_maquinaria02->Sortable = FALSE; // Allow sort
		$this->fields['imagen_maquinaria02'] = &$this->imagen_maquinaria02;

		// imagen_maquinaria03
		$this->imagen_maquinaria03 = new cField('viewsolicitud', 'viewsolicitud', 'x_imagen_maquinaria03', 'imagen_maquinaria03', '`imagen_maquinaria03`', '`imagen_maquinaria03`', 205, -1, TRUE, '`imagen_maquinaria03`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_maquinaria03->Sortable = FALSE; // Allow sort
		$this->fields['imagen_maquinaria03'] = &$this->imagen_maquinaria03;

		// imagen_maquinaria04
		$this->imagen_maquinaria04 = new cField('viewsolicitud', 'viewsolicitud', 'x_imagen_maquinaria04', 'imagen_maquinaria04', '`imagen_maquinaria04`', '`imagen_maquinaria04`', 205, -1, TRUE, '`imagen_maquinaria04`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		...
		// imagen_maquinaria08
		$this->imagen_maquinaria08 = new cField('viewsolicitud', 'viewsolicitud', 'x_imagen_maquinaria08', 'imagen_maquinaria08', '`imagen_maquinaria08`', '`imagen_maquinaria08`', 205, -1, TRUE, '`imagen_maquinaria08`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_maquinaria08->Sortable = FALSE; // Allow sort
		$this->fields['imagen_maquinaria08'] = &$this->imagen_maquinaria08;

		// tipomercaderia
		$this->tipomercaderia = new cField('viewsolicitud', 'viewsolicitud', 'x_tipomercaderia', 'tipomercaderia', '`tipomercaderia`', '`tipomercaderia`', 200, -1, FALSE, '`tipomercaderia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// imagen_mercaderia01
		$this->imagen_mercaderia01 = new cField('viewsolicitud', 'viewsolicitud', 'x_imagen_mercaderia01', 'imagen_mercaderia01', '`imagen_mercaderia01`', '`imagen_mercaderia01`', 205, -1, TRUE, '`imagen_mercaderia01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		...
		// tipoespecial
		$this->tipoespecial = new cField('viewsolicitud', 'viewsolicitud', 'x_tipoespecial', 'tipoespecial', '`tipoespecial`', '`tipoespecial`', 200, -1, FALSE, '`tipoespecial`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->imagen_tipoespecial01 = new cField('viewsolicitud', 'viewsolicitud', 'x_imagen_tipoespecial01', 'imagen_tipoespecial01', '`imagen_tipoespecial01`', '`imagen_tipoespecial01`', 205, -1, TRUE, '`imagen_tipoespecial01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_tipoespecial01->Sortable = FALSE; // Allow sort
		$this->fields['imagen_tipoespecial01'] = &$this->imagen_tipoespecial01;

		// is_active
		$this->is_active = new cField('viewsolicitud', 'viewsolicitud', 'x_is_active', 'is_active', '`is_active`', '`is_active`', 16, -1, FALSE, '`is_active`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// documentos
		$this->documentos = new cField('viewsolicitud', 'viewsolicitud', 'x_documentos', 'documentos', '`documentos`', '`documentos`', 200, -1, FALSE, '`documentos`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->documentos->Sortable = TRUE; // Allow sort
		$this->fields['documentos'] = &$this->documentos;

		// created_at
		$this->created_at = new cField('viewsolicitud', 'viewsolicitud', 'x_created_at', 'created_at', '`created_at`', ew_CastDateFieldForLike('`created_at`', 0, "DB"), 135, 0, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DateModified
		$this->DateModified = new cField('viewsolicitud', 'viewsolicitud', 'x_DateModified', 'DateModified', '`DateModified`', ew_CastDateFieldForLike('`DateModified`', 0, "DB"), 135, 0, FALSE, '`DateModified`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DateDeleted
		$this->DateDeleted = new cField('viewsolicitud', 'viewsolicitud', 'x_DateDeleted', 'DateDeleted', '`DateDeleted`', ew_CastDateFieldForLike('`DateDeleted`', 0, "DB"), 135, 0, FALSE, '`DateDeleted`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CreatedBy
		$this->CreatedBy = new cField('viewsolicitud', 'viewsolicitud', 'x_CreatedBy', 'CreatedBy', '`CreatedBy`', '`CreatedBy`', 200, -1, FALSE, '`CreatedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreatedBy->Sortable = FALSE; // Allow sort
		$this->fields['CreatedBy'] = &$this->CreatedBy;

		// ModifiedBy
		$this->ModifiedBy = new cField('viewsolicitud', 'viewsolicitud', 'x_ModifiedBy', 'ModifiedBy', '`ModifiedBy`', '`ModifiedBy`', 200, -1, FALSE, '`ModifiedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ModifiedBy->Sortable = FALSE; // Allow sort
		$this->fields['ModifiedBy'] = &$this->ModifiedBy;

		// DeletedBy
		$this->DeletedBy = new cField('viewsolicitud', 'viewsolicitud', 'x_DeletedBy', 'DeletedBy', '`DeletedBy`', '`DeletedBy`', 200, -1, FALSE, '`DeletedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "viewavaluo") {
			$sDetailUrl = $GLOBALS["viewavaluo"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "viewsolicitudlist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`viewsolicitud`";
	}
	...
	function getSqlWhere() { // Where
		...
		$this->TableFilter = "`email_contacto`='".$_SESSION["usr"]."'";
	...
	function Update(&$rs, $where = "", $rsold = NULL, $curfilter = TRUE) {
		...
		// Cascade Update detail table 'viewavaluo'
		...
		if ($bCascadeUpdate) {
			...
			$rswrk = $GLOBALS["viewavaluo"]->LoadRs("`id_solicitud` = " . ew_QuotedValue($rsold['id'], EW_DATATYPE_NUMBER, 'DB')); 
			while ($rswrk && !$rswrk->EOF) {
				...
				$bUpdate = $GLOBALS["viewavaluo"]->Row_Updating($rsdtlold, $rsdtlnew);
				if ($bUpdate)
					$bUpdate = $GLOBALS["viewavaluo"]->Update($rscascade, $rskey, $rswrk->fields);
				if (!$bUpdate) return FALSE;

				// Call Row_Updated event
				$GLOBALS["viewavaluo"]->Row_Updated($rsdtlold, $rsdtlnew);
				$rswrk->MoveNext();
			}
		}
	...
	function Delete(&$rs, $where = "", $curfilter = TRUE) {
		...
		// Cascade delete detail table 'viewavaluo'
		if (!isset($GLOBALS["viewavaluo"])) $GLOBALS["viewavaluo"] = new cviewavaluo();
		$rscascade = $GLOBALS["viewavaluo"]->LoadRs("`id_solicitud` = " . ew_QuotedValue($rs['id'], EW_DATATYPE_NUMBER, "DB")); 
		$dtlrows = ($rscascade) ? $rscascade->GetRows() : array();

		// Call Row Deleting event
		foreach ($dtlrows as $dtlrow) {
			$bDelete = $GLOBALS["viewavaluo"]->Row_Deleting($dtlrow);
			if (!$bDelete) break;
		}
		if ($bDelete) {
			foreach ($dtlrows as $dtlrow) {
				$bDelete = $GLOBALS["viewavaluo"]->Delete($dtlrow); // Delete
				if ($bDelete === FALSE)
					break;
			}
		}
		...
		if ($bDelete) {
			foreach ($dtlrows as $dtlrow) {
				$GLOBALS["viewavaluo"]->Row_Deleted($dtlrow);
			}
		}
		if ($bDelete)
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "viewsolicitudedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "viewsolicitudadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("viewsolicitudview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("viewsolicitudview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "viewsolicitudadd.php?" . $this->UrlParm($parm);
		else
			$url = "viewsolicitudadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("viewsolicitudedit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("viewsolicitudedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("viewsolicitudadd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("viewsolicitudadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("viewsolicituddelete.php", $this->UrlParm());
	}
	...
	// Common render codes
		...
		if (!ew_Empty($this->imagen_inmueble01->Upload->DbValue)) {
			$this->imagen_inmueble01->ViewValue = "viewsolicitud_imagen_inmueble01_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_inmueble06->Upload->DbValue)) {
			$this->imagen_inmueble06->ViewValue = "viewsolicitud_imagen_inmueble06_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_inmueble07->Upload->DbValue)) {
			$this->imagen_inmueble07->ViewValue = "viewsolicitud_imagen_inmueble07_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_inmueble08->Upload->DbValue)) {
			$this->imagen_inmueble08->ViewValue = "viewsolicitud_imagen_inmueble08_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_vehiculo01->Upload->DbValue)) {
			$this->imagen_vehiculo01->ViewValue = "viewsolicitud_imagen_vehiculo01_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_vehiculo02->Upload->DbValue)) {
			$this->imagen_vehiculo02->ViewValue = "viewsolicitud_imagen_vehiculo02_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_vehiculo03->Upload->DbValue)) {
			$this->imagen_vehiculo03->ViewValue = "viewsolicitud_imagen_vehiculo03_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_vehiculo04->Upload->DbValue)) {
			$this->imagen_vehiculo04->ViewValue = "viewsolicitud_imagen_vehiculo04_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_vehiculo08->Upload->DbValue)) {
			$this->imagen_vehiculo08->ViewValue = "viewsolicitud_imagen_vehiculo08_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_maquinaria01->Upload->DbValue)) {
			$this->imagen_maquinaria01->ViewValue = "viewsolicitud_imagen_maquinaria01_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_maquinaria02->Upload->DbValue)) {
			$this->imagen_maquinaria02->ViewValue = "viewsolicitud_imagen_maquinaria02_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_maquinaria03->Upload->DbValue)) {
			$this->imagen_maquinaria03->ViewValue = "viewsolicitud_imagen_maquinaria03_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_maquinaria04->Upload->DbValue)) {
			$this->imagen_maquinaria04->ViewValue = "viewsolicitud_imagen_maquinaria04_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_maquinaria08->Upload->DbValue)) {
			$this->imagen_maquinaria08->ViewValue = "viewsolicitud_imagen_maquinaria08_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_mercaderia01->Upload->DbValue)) {
			$this->imagen_mercaderia01->ViewValue = "viewsolicitud_imagen_mercaderia01_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_tipoespecial01->Upload->DbValue)) {
			$this->imagen_tipoespecial01->ViewValue = "viewsolicitud_imagen_tipoespecial01_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_inmueble01->Upload->DbValue)) {
			$this->imagen_inmueble01->HrefValue = "viewsolicitud_imagen_inmueble01_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_inmueble01->HrefValue2 = "viewsolicitud_imagen_inmueble01_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_inmueble06->Upload->DbValue)) {
			$this->imagen_inmueble06->HrefValue = "viewsolicitud_imagen_inmueble06_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_inmueble06->HrefValue2 = "viewsolicitud_imagen_inmueble06_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_inmueble07->Upload->DbValue)) {
			$this->imagen_inmueble07->HrefValue = "viewsolicitud_imagen_inmueble07_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_inmueble07->HrefValue2 = "viewsolicitud_imagen_inmueble07_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_inmueble08->Upload->DbValue)) {
			$this->imagen_inmueble08->HrefValue = "viewsolicitud_imagen_inmueble08_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_inmueble08->HrefValue2 = "viewsolicitud_imagen_inmueble08_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_vehiculo01->Upload->DbValue)) {
			$this->imagen_vehiculo01->HrefValue = "viewsolicitud_imagen_vehiculo01_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_vehiculo01->HrefValue2 = "viewsolicitud_imagen_vehiculo01_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_vehiculo02->Upload->DbValue)) {
			$this->imagen_vehiculo02->HrefValue = "viewsolicitud_imagen_vehiculo02_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_vehiculo02->HrefValue2 = "viewsolicitud_imagen_vehiculo02_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_vehiculo03->Upload->DbValue)) {
			$this->imagen_vehiculo03->HrefValue = "viewsolicitud_imagen_vehiculo03_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_vehiculo03->HrefValue2 = "viewsolicitud_imagen_vehiculo03_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_vehiculo04->Upload->DbValue)) {
			$this->imagen_vehiculo04->HrefValue = "viewsolicitud_imagen_vehiculo04_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_vehiculo04->HrefValue2 = "viewsolicitud_imagen_vehiculo04_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_vehiculo08->Upload->DbValue)) {
			$this->imagen_vehiculo08->HrefValue = "viewsolicitud_imagen_vehiculo08_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_vehiculo08->HrefValue2 = "viewsolicitud_imagen_vehiculo08_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_maquinaria01->Upload->DbValue)) {
			$this->imagen_maquinaria01->HrefValue = "viewsolicitud_imagen_maquinaria01_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_maquinaria01->HrefValue2 = "viewsolicitud_imagen_maquinaria01_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_maquinaria02->Upload->DbValue)) {
			$this->imagen_maquinaria02->HrefValue = "viewsolicitud_imagen_maquinaria02_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_maquinaria02->HrefValue2 = "viewsolicitud_imagen_maquinaria02_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_maquinaria03->Upload->DbValue)) {
			$this->imagen_maquinaria03->HrefValue = "viewsolicitud_imagen_maquinaria03_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_maquinaria03->HrefValue2 = "viewsolicitud_imagen_maquinaria03_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_maquinaria04->Upload->DbValue)) {
			$this->imagen_maquinaria04->HrefValue = "viewsolicitud_imagen_maquinaria04_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_maquinaria04->HrefValue2 = "viewsolicitud_imagen_maquinaria04_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_maquinaria08->Upload->DbValue)) {
			$this->imagen_maquinaria08->HrefValue = "viewsolicitud_imagen_maquinaria08_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_maquinaria08->HrefValue2 = "viewsolicitud_imagen_maquinaria08_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_mercaderia01->Upload->DbValue)) {
			$this->imagen_mercaderia01->HrefValue = "viewsolicitud_imagen_mercaderia01_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_mercaderia01->HrefValue2 = "viewsolicitud_imagen_mercaderia01_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_tipoespecial01->Upload->DbValue)) {
			$this->imagen_tipoespecial01->HrefValue = "viewsolicitud_imagen_tipoespecial01_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_tipoespecial01->HrefValue2 = "viewsolicitud_imagen_tipoespecial01_bv.php?id=" . $this->id->CurrentValue;
	...
	function RenderEditRow() {
		...
		if (!ew_Empty($this->imagen_inmueble01->Upload->DbValue)) {
			$this->imagen_inmueble01->EditValue = "viewsolicitud_imagen_inmueble01_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_inmueble01->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_inmueble01->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_inmueble06->Upload->DbValue)) {
			$this->imagen_inmueble06->EditValue = "viewsolicitud_imagen_inmueble06_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_inmueble06->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_inmueble06->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_inmueble07->Upload->DbValue)) {
			$this->imagen_inmueble07->EditValue = "viewsolicitud_imagen_inmueble07_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_inmueble07->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_inmueble07->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_inmueble08->Upload->DbValue)) {
			$this->imagen_inmueble08->EditValue = "viewsolicitud_imagen_inmueble08_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_inmueble08->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_inmueble08->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_vehiculo01->Upload->DbValue)) {
			$this->imagen_vehiculo01->EditValue = "viewsolicitud_imagen_vehiculo01_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_vehiculo01->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_vehiculo01->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_vehiculo02->Upload->DbValue)) {
			$this->imagen_vehiculo02->EditValue = "viewsolicitud_imagen_vehiculo02_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_vehiculo02->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_vehiculo02->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_vehiculo03->Upload->DbValue)) {
			$this->imagen_vehiculo03->EditValue = "viewsolicitud_imagen_vehiculo03_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_vehiculo03->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_vehiculo03->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_vehiculo04->Upload->DbValue)) {
			$this->imagen_vehiculo04->EditValue = "viewsolicitud_imagen_vehiculo04_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_vehiculo04->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_vehiculo04->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_vehiculo08->Upload->DbValue)) {
			$this->imagen_vehiculo08->EditValue = "viewsolicitud_imagen_vehiculo08_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_vehiculo08->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_vehiculo08->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_maquinaria01->Upload->DbValue)) {
			$this->imagen_maquinaria01->EditValue = "viewsolicitud_imagen_maquinaria01_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_maquinaria01->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_maquinaria01->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_maquinaria02->Upload->DbValue)) {
			$this->imagen_maquinaria02->EditValue = "viewsolicitud_imagen_maquinaria02_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_maquinaria02->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_maquinaria02->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_maquinaria03->Upload->DbValue)) {
			$this->imagen_maquinaria03->EditValue = "viewsolicitud_imagen_maquinaria03_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_maquinaria03->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_maquinaria03->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_maquinaria04->Upload->DbValue)) {
			$this->imagen_maquinaria04->EditValue = "viewsolicitud_imagen_maquinaria04_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_maquinaria04->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_maquinaria04->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_maquinaria08->Upload->DbValue)) {
			$this->imagen_maquinaria08->EditValue = "viewsolicitud_imagen_maquinaria08_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_maquinaria08->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_maquinaria08->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_mercaderia01->Upload->DbValue)) {
			$this->imagen_mercaderia01->EditValue = "viewsolicitud_imagen_mercaderia01_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_mercaderia01->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_mercaderia01->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_tipoespecial01->Upload->DbValue)) {
			$this->imagen_tipoespecial01->EditValue = "viewsolicitud_imagen_tipoespecial01_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_tipoespecial01->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_tipoespecial01->Upload->DbValue, 0, 11)));
		} else {
