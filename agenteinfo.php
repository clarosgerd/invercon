...
//
// Table class for agente
//
class cagente extends cTable {
	var $id;
	var $name;
	var $lastname;
	var $day_of_birth;
	...
	function __construct() {
		...
		$this->TableVar = 'agente';
		$this->TableName = 'agente';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`agente`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('agente', 'agente', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// name
		$this->name = new cField('agente', 'agente', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->name->Sortable = TRUE; // Allow sort
		$this->fields['name'] = &$this->name;

		// lastname
		$this->lastname = new cField('agente', 'agente', 'x_lastname', 'lastname', '`lastname`', '`lastname`', 200, -1, FALSE, '`lastname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->lastname->Sortable = TRUE; // Allow sort
		$this->fields['lastname'] = &$this->lastname;

		// day_of_birth
		$this->day_of_birth = new cField('agente', 'agente', 'x_day_of_birth', 'day_of_birth', '`day_of_birth`', ew_CastDateFieldForLike('`day_of_birth`', 0, "DB"), 133, 0, FALSE, '`day_of_birth`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->day_of_birth->Sortable = TRUE; // Allow sort
		$this->day_of_birth->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['day_of_birth'] = &$this->day_of_birth;

		// email
		$this->_email = new cField('agente', 'agente', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->fields['email'] = &$this->_email;

		// address
		$this->address = new cField('agente', 'agente', 'x_address', 'address', '`address`', '`address`', 200, -1, FALSE, '`address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->address->Sortable = TRUE; // Allow sort
		$this->fields['address'] = &$this->address;

		// phone
		$this->phone = new cField('agente', 'agente', 'x_phone', 'phone', '`phone`', '`phone`', 200, -1, FALSE, '`phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->phone->Sortable = TRUE; // Allow sort
		$this->fields['phone'] = &$this->phone;

		// phone_cell
		$this->phone_cell = new cField('agente', 'agente', 'x_phone_cell', 'phone_cell', '`phone_cell`', '`phone_cell`', 200, -1, FALSE, '`phone_cell`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->phone_cell->Sortable = TRUE; // Allow sort
		$this->fields['phone_cell'] = &$this->phone_cell;

		// is_active
		$this->is_active = new cField('agente', 'agente', 'x_is_active', 'is_active', '`is_active`', '`is_active`', 16, -1, FALSE, '`is_active`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// created_at
		$this->created_at = new cField('agente', 'agente', 'x_created_at', 'created_at', '`created_at`', ew_CastDateFieldForLike('`created_at`', 0, "DB"), 135, 0, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`agente`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "agenteedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "agenteadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("agenteview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("agenteview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "agenteadd.php?" . $this->UrlParm($parm);
		else
			$url = "agenteadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("agenteedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("agenteadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("agentedelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->day_of_birth->setDbValue($rs->fields('day_of_birth'));
	...
	function RenderEditRow() {
		...
		$this->day_of_birth->EditValue = ew_FormatDateTime($this->day_of_birth->CurrentValue, 8);
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->day_of_birth->Exportable) $Doc->ExportCaption($this->day_of_birth);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->day_of_birth->Exportable) $Doc->ExportField($this->day_of_birth);
