...
$viewsolicitud_imagen_vehiculo01_blobview = NULL; // Initialize page object first

class cviewsolicitud_imagen_vehiculo01_blobview extends cviewsolicitud {
	...
	// Page object name
	var $PageObjName = 'viewsolicitud_imagen_vehiculo01_blobview';
...
// Create page object
if (!isset($viewsolicitud_imagen_vehiculo01_blobview)) $viewsolicitud_imagen_vehiculo01_blobview = new cviewsolicitud_imagen_vehiculo01_blobview();

// Page init
$viewsolicitud_imagen_vehiculo01_blobview->Page_Init();

// Page main
$viewsolicitud_imagen_vehiculo01_blobview->Page_Main();
?>
<?php
$viewsolicitud_imagen_vehiculo01_blobview->Page_Terminate();
?>
