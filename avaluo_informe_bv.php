...
$avaluo_informe_blobview = NULL; // Initialize page object first

class cavaluo_informe_blobview extends cavaluo {
	...
	// Page object name
	var $PageObjName = 'avaluo_informe_blobview';
...
// Create page object
if (!isset($avaluo_informe_blobview)) $avaluo_informe_blobview = new cavaluo_informe_blobview();

// Page init
$avaluo_informe_blobview->Page_Init();

// Page main
$avaluo_informe_blobview->Page_Main();
?>
<?php
$avaluo_informe_blobview->Page_Terminate();
?>
