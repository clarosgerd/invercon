...
$documentosavaluo_imagen_blobview = NULL; // Initialize page object first

class cdocumentosavaluo_imagen_blobview extends cdocumentosavaluo {
	...
	// Page object name
	var $PageObjName = 'documentosavaluo_imagen_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'documentosavaluo');
...
// Create page object
if (!isset($documentosavaluo_imagen_blobview)) $documentosavaluo_imagen_blobview = new cdocumentosavaluo_imagen_blobview();

// Page init
$documentosavaluo_imagen_blobview->Page_Init();

// Page main
$documentosavaluo_imagen_blobview->Page_Main();
?>
<?php
$documentosavaluo_imagen_blobview->Page_Terminate();
?>
