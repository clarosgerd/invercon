...
$usuario_avatar_blobview = NULL; // Initialize page object first

class cusuario_avatar_blobview extends cusuario {
	...
	// Page object name
	var $PageObjName = 'usuario_avatar_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'usuario');
...
// Create page object
if (!isset($usuario_avatar_blobview)) $usuario_avatar_blobview = new cusuario_avatar_blobview();

// Page init
$usuario_avatar_blobview->Page_Init();

// Page main
$usuario_avatar_blobview->Page_Main();
?>
<?php
$usuario_avatar_blobview->Page_Terminate();
?>
