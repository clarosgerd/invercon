...
fusuarioadd.Lists["x_id_sucursal"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"sucursal"};
fusuarioadd.Lists["x_id_sucursal"].Data = "<?php echo $usuario_add->id_sucursal->LookupFilterQuery(FALSE, "add") ?>";
fusuarioadd.Lists["x_id_institucion"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_short_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"banco"};
fusuarioadd.Lists["x_id_institucion"].Data = "<?php echo $usuario_add->id_institucion->LookupFilterQuery(FALSE, "add") ?>";
...
<?php } else { ?>
<table id="tbl_usuarioadd" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
...
<?php if ($usuario_add->IsMobileOrModal) { ?>
	<div id="r_status" class="form-group">
		<label id="elh_usuario_status" class="<?php echo $usuario_add->LeftColumnClass ?>"><?php echo $usuario->status->FldCaption() ?></label>
		<div class="<?php echo $usuario_add->RightColumnClass ?>"><div<?php echo $usuario->status->CellAttributes() ?>>
<span id="el_usuario_status">
<input type="text" data-table="usuario" data-field="x_status" name="x_status" id="x_status" size="30" placeholder="<?php echo ew_HtmlEncode($usuario->status->getPlaceHolder()) ?>" value="<?php echo $usuario->status->EditValue ?>"<?php echo $usuario->status->EditAttributes() ?>>
</span>
<?php echo $usuario->status->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_status">
		<td class="col-sm-3"><span id="elh_usuario_status"><?php echo $usuario->status->FldCaption() ?></span></td>
		<td<?php echo $usuario->status->CellAttributes() ?>>
<span id="el_usuario_status">
<input type="text" data-table="usuario" data-field="x_status" name="x_status" id="x_status" size="30" placeholder="<?php echo ew_HtmlEncode($usuario->status->getPlaceHolder()) ?>" value="<?php echo $usuario->status->EditValue ?>"<?php echo $usuario->status->EditAttributes() ?>>
</span>
<?php echo $usuario->status->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if ($usuario_add->IsMobileOrModal) { ?>
	<div id="r_id_sucursal" class="form-group">
		<label id="elh_usuario_id_sucursal" for="x_id_sucursal" class="<?php echo $usuario_add->LeftColumnClass ?>"><?php echo $usuario->id_sucursal->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $usuario_add->RightColumnClass ?>"><div<?php echo $usuario->id_sucursal->CellAttributes() ?>>
...
<?php if ($usuario_add->IsMobileOrModal) { ?>
	<div id="r__email" class="form-group">
		<label id="elh_usuario__email" for="x__email" class="<?php echo $usuario_add->LeftColumnClass ?>"><?php echo $usuario->_email->FldCaption() ?></label>
...
<?php if ($usuario_add->IsMobileOrModal) { ?>
	<div id="r_telefono_fijo01" class="form-group">
		<label id="elh_usuario_telefono_fijo01" for="x_telefono_fijo01" class="<?php echo $usuario_add->LeftColumnClass ?>"><?php echo $usuario->telefono_fijo01->FldCaption() ?></label>
		<div class="<?php echo $usuario_add->RightColumnClass ?>"><div<?php echo $usuario->telefono_fijo01->CellAttributes() ?>>
...
<?php if ($usuario_add->IsMobileOrModal) { ?>
	<div id="r_telefono_fijo02" class="form-group">
		<label id="elh_usuario_telefono_fijo02" for="x_telefono_fijo02" class="<?php echo $usuario_add->LeftColumnClass ?>"><?php echo $usuario->telefono_fijo02->FldCaption() ?></label>
		<div class="<?php echo $usuario_add->RightColumnClass ?>"><div<?php echo $usuario->telefono_fijo02->CellAttributes() ?>>
...
<?php if ($usuario_add->IsMobileOrModal) { ?>
	<div id="r_celular" class="form-group">
		<label id="elh_usuario_celular" for="x_celular" class="<?php echo $usuario_add->LeftColumnClass ?>"><?php echo $usuario->celular->FldCaption() ?></label>
		<div class="<?php echo $usuario_add->RightColumnClass ?>"><div<?php echo $usuario->celular->CellAttributes() ?>>
...
<?php if ($usuario_add->IsMobileOrModal) { ?>
	<div id="r_cargo" class="form-group">
		<label id="elh_usuario_cargo" for="x_cargo" class="<?php echo $usuario_add->LeftColumnClass ?>"><?php echo $usuario->cargo->FldCaption() ?></label>
		<div class="<?php echo $usuario_add->RightColumnClass ?>"><div<?php echo $usuario->cargo->CellAttributes() ?>>
<?php if (!$Security->IsAdmin() && $Security->IsLoggedIn()) { // Non system admin ?>
...
<?php if ($usuario_add->IsMobileOrModal) { ?>
	<div id="r_id_institucion" class="form-group">
		<label id="elh_usuario_id_institucion" for="x_id_institucion" class="<?php echo $usuario_add->LeftColumnClass ?>"><?php echo $usuario->id_institucion->FldCaption() ?></label>
		<div class="<?php echo $usuario_add->RightColumnClass ?>"><div<?php echo $usuario->id_institucion->CellAttributes() ?>>
...
<?php if ($usuario_add->IsMobileOrModal) { ?>
	<div id="r_celular2" class="form-group">
		<label id="elh_usuario_celular2" for="x_celular2" class="<?php echo $usuario_add->LeftColumnClass ?>"><?php echo $usuario->celular2->FldCaption() ?></label>
		<div class="<?php echo $usuario_add->RightColumnClass ?>"><div<?php echo $usuario->celular2->CellAttributes() ?>>
...
<?php if ($usuario_add->IsMobileOrModal) { ?>
	<div id="r_direccion" class="form-group">
		<label id="elh_usuario_direccion" for="x_direccion" class="<?php echo $usuario_add->LeftColumnClass ?>"><?php echo $usuario->direccion->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $usuario_add->RightColumnClass ?>"><div<?php echo $usuario->direccion->CellAttributes() ?>>
...
<?php if ($usuario_add->IsMobileOrModal) { ?>
	<div id="r_especialidad" class="form-group">
		<label id="elh_usuario_especialidad" for="x_especialidad" class="<?php echo $usuario_add->LeftColumnClass ?>"><?php echo $usuario->especialidad->FldCaption() ?></label>
		<div class="<?php echo $usuario_add->RightColumnClass ?>"><div<?php echo $usuario->especialidad->CellAttributes() ?>>
...
<?php if ($usuario_add->IsMobileOrModal) { ?>
	<div id="r_avatar" class="form-group">
		<label id="elh_usuario_avatar" class="<?php echo $usuario_add->LeftColumnClass ?>"><?php echo $usuario->avatar->FldCaption() ?></label>
...
<script type="text/javascript">ew_CheckFileUpload("fusuarioadd", "x_avatar");</script>
<?php } ?>
</span>
...
<?php if ($usuario_add->IsMobileOrModal) { ?>
	<div id="r_color" class="form-group">
		<label id="elh_usuario_color" for="x_color" class="<?php echo $usuario_add->LeftColumnClass ?>"><?php echo $usuario->color->FldCaption() ?></label>
		<div class="<?php echo $usuario_add->RightColumnClass ?>"><div<?php echo $usuario->color->CellAttributes() ?>>
