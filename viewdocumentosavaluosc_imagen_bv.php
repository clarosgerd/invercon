...
$viewdocumentosavaluosc_imagen_blobview = NULL; // Initialize page object first

class cviewdocumentosavaluosc_imagen_blobview extends cviewdocumentosavaluosc {
	...
	// Page object name
	var $PageObjName = 'viewdocumentosavaluosc_imagen_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'viewdocumentosavaluosc');
	...
	function Page_Main() {
		...
		// SQL constructor in viewdocumentosavaluosc class, viewdocumentosavaluoscinfo.php
...
// Create page object
if (!isset($viewdocumentosavaluosc_imagen_blobview)) $viewdocumentosavaluosc_imagen_blobview = new cviewdocumentosavaluosc_imagen_blobview();

// Page init
$viewdocumentosavaluosc_imagen_blobview->Page_Init();

// Page main
$viewdocumentosavaluosc_imagen_blobview->Page_Main();
?>
<?php
$viewdocumentosavaluosc_imagen_blobview->Page_Terminate();
?>
