...
$viewavaluoinspector_grid = NULL; // Initialize page object first

class cviewavaluoinspector_grid extends cviewavaluoinspector {
	...
	// Page object name
	var $PageObjName = 'viewavaluoinspector_grid';

	// Grid form hidden field names
	var $FormName = 'fviewavaluoinspectorgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["viewavaluoinspector"];

		}
		$this->AddUrl = "viewavaluoinspectoradd.php";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "viewsolicitudinspector") {
			...
			if ($GLOBALS["viewsolicitudinspector"]->EventCancelled) $this->EventCancelled = TRUE;
		}
