...
<?php if ($userlevelpermissions->userlevelid->Visible) { // userlevelid ?>
	<tr id="r_userlevelid">
		<td class="col-sm-3"><span id="elh_userlevelpermissions_userlevelid"><?php echo $userlevelpermissions->userlevelid->FldCaption() ?></span></td>
...
<?php if ($userlevelpermissions->_tablename->Visible) { // tablename ?>
	<tr id="r__tablename">
		<td class="col-sm-3"><span id="elh_userlevelpermissions__tablename"><?php echo $userlevelpermissions->_tablename->FldCaption() ?></span></td>
...
<?php if ($userlevelpermissions->permission->Visible) { // permission ?>
	<tr id="r_permission">
		<td class="col-sm-3"><span id="elh_userlevelpermissions_permission"><?php echo $userlevelpermissions->permission->FldCaption() ?></span></td>
...
<?php if (!isset($userlevelpermissions_view->Pager)) $userlevelpermissions_view->Pager = new cNumericPager($userlevelpermissions_view->StartRec, $userlevelpermissions_view->DisplayRecs, $userlevelpermissions_view->TotalRecs, $userlevelpermissions_view->RecRange, $userlevelpermissions_view->AutoHidePager) ?>
