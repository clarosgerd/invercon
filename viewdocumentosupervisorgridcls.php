...
$viewdocumentosupervisor_grid = NULL; // Initialize page object first

class cviewdocumentosupervisor_grid extends cviewdocumentosupervisor {
	...
	// Page object name
	var $PageObjName = 'viewdocumentosupervisor_grid';

	// Grid form hidden field names
	var $FormName = 'fviewdocumentosupervisorgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["viewdocumentosupervisor"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "viewavaluosupervisor") {
			$this->avaluo->Visible = FALSE;
			if ($GLOBALS["viewavaluosupervisor"]->EventCancelled) $this->EventCancelled = TRUE;
		}
