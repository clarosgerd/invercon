...
$viewdocumentosupervisor_imagen_blobview = NULL; // Initialize page object first

class cviewdocumentosupervisor_imagen_blobview extends cviewdocumentosupervisor {
	...
	// Page object name
	var $PageObjName = 'viewdocumentosupervisor_imagen_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'viewdocumentosupervisor');
	...
	function Page_Main() {
		...
		// SQL constructor in viewdocumentosupervisor class, viewdocumentosupervisorinfo.php
...
// Create page object
if (!isset($viewdocumentosupervisor_imagen_blobview)) $viewdocumentosupervisor_imagen_blobview = new cviewdocumentosupervisor_imagen_blobview();

// Page init
$viewdocumentosupervisor_imagen_blobview->Page_Init();

// Page main
$viewdocumentosupervisor_imagen_blobview->Page_Main();
?>
<?php
$viewdocumentosupervisor_imagen_blobview->Page_Terminate();
?>
