...
$viewsolicitud_imagen_vehiculo06_blobview = NULL; // Initialize page object first

class cviewsolicitud_imagen_vehiculo06_blobview extends cviewsolicitud {
	...
	// Page object name
	var $PageObjName = 'viewsolicitud_imagen_vehiculo06_blobview';
...
// Create page object
if (!isset($viewsolicitud_imagen_vehiculo06_blobview)) $viewsolicitud_imagen_vehiculo06_blobview = new cviewsolicitud_imagen_vehiculo06_blobview();

// Page init
$viewsolicitud_imagen_vehiculo06_blobview->Page_Init();

// Page main
$viewsolicitud_imagen_vehiculo06_blobview->Page_Main();
?>
<?php
$viewsolicitud_imagen_vehiculo06_blobview->Page_Terminate();
?>
