...
$notificaciones_view = NULL; // Initialize page object first

class cnotificaciones_view extends cnotificaciones {
	...
	// Page object name
	var $PageObjName = 'notificaciones_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			$sReturnUrl = "notificacioneslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($notificaciones_view)) $notificaciones_view = new cnotificaciones_view();

// Page init
$notificaciones_view->Page_Init();

// Page main
$notificaciones_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$notificaciones_view->Page_Render();
?>
...
var CurrentForm = fnotificacionesview = new ew_Form("fnotificacionesview", "view");

// Form_CustomValidate event
fnotificacionesview.Form_CustomValidate = 
...
fnotificacionesview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<div class="ewToolbar">
<?php $notificaciones_view->ExportOptions->Render("body") ?>
<?php
	foreach ($notificaciones_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $notificaciones_view->ShowPageHeader(); ?>
<?php
$notificaciones_view->ShowMessage();
?>
<form name="fnotificacionesview" id="fnotificacionesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($notificaciones_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $notificaciones_view->Token ?>">
<?php } ?>
...
<?php echo $notificaciones->mensaje->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $notificaciones->creadopor->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $notificaciones->recibidopor->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $notificaciones->leido->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
$notificaciones_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$notificaciones_view->Page_Terminate();
?>
