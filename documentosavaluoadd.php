...
$documentosavaluo_add = NULL; // Initialize page object first

class cdocumentosavaluo_add extends cdocumentosavaluo {
	...
	// Page object name
	var $PageObjName = 'documentosavaluo_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "documentosavaluoview.php")
...
// Create page object
if (!isset($documentosavaluo_add)) $documentosavaluo_add = new cdocumentosavaluo_add();

// Page init
$documentosavaluo_add->Page_Init();

// Page main
$documentosavaluo_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$documentosavaluo_add->Page_Render();
?>
...
var CurrentForm = fdocumentosavaluoadd = new ew_Form("fdocumentosavaluoadd", "add");

// Validate form
fdocumentosavaluoadd.Validate = function() {
...
fdocumentosavaluoadd.Form_CustomValidate = 
...
fdocumentosavaluoadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fdocumentosavaluoadd.Lists["x_avaluo"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_codigoavaluo","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"avaluo"};
fdocumentosavaluoadd.Lists["x_avaluo"].Data = "<?php echo $documentosavaluo_add->avaluo->LookupFilterQuery(FALSE, "add") ?>";
fdocumentosavaluoadd.Lists["x_id_tipodocumento"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipodocumento"};
fdocumentosavaluoadd.Lists["x_id_tipodocumento"].Data = "<?php echo $documentosavaluo_add->id_tipodocumento->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $documentosavaluo_add->ShowPageHeader(); ?>
<?php
$documentosavaluo_add->ShowMessage();
?>
<form name="fdocumentosavaluoadd" id="fdocumentosavaluoadd" class="<?php echo $documentosavaluo_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($documentosavaluo_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $documentosavaluo_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="documentosavaluo">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($documentosavaluo_add->IsModal) ?>">
...
<?php } ?>
<?php if (!$documentosavaluo_add->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($documentosavaluo_add->IsMobileOrModal) { ?>
<div class="ewAddDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_documentosavaluoadd" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($documentosavaluo->descripcion->Visible) { // descripcion ?>
<?php if ($documentosavaluo_add->IsMobileOrModal) { ?>
	<div id="r_descripcion" class="form-group">
		<label id="elh_documentosavaluo_descripcion" for="x_descripcion" class="<?php echo $documentosavaluo_add->LeftColumnClass ?>"><?php echo $documentosavaluo->descripcion->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $documentosavaluo_add->RightColumnClass ?>"><div<?php echo $documentosavaluo->descripcion->CellAttributes() ?>>
...
<?php if ($documentosavaluo_add->IsMobileOrModal) { ?>
	<div id="r_imagen" class="form-group">
		<label id="elh_documentosavaluo_imagen" class="<?php echo $documentosavaluo_add->LeftColumnClass ?>"><?php echo $documentosavaluo->imagen->FldCaption() ?></label>
		<div class="<?php echo $documentosavaluo_add->RightColumnClass ?>"><div<?php echo $documentosavaluo->imagen->CellAttributes() ?>>
...
<?php if ($documentosavaluo_add->IsMobileOrModal) { ?>
	<div id="r_avaluo" class="form-group">
		<label id="elh_documentosavaluo_avaluo" for="x_avaluo" class="<?php echo $documentosavaluo_add->LeftColumnClass ?>"><?php echo $documentosavaluo->avaluo->FldCaption() ?></label>
		<div class="<?php echo $documentosavaluo_add->RightColumnClass ?>"><div<?php echo $documentosavaluo->avaluo->CellAttributes() ?>>
...
<?php if ($documentosavaluo_add->IsMobileOrModal) { ?>
	<div id="r_id_tipodocumento" class="form-group">
		<label id="elh_documentosavaluo_id_tipodocumento" for="x_id_tipodocumento" class="<?php echo $documentosavaluo_add->LeftColumnClass ?>"><?php echo $documentosavaluo->id_tipodocumento->FldCaption() ?></label>
		<div class="<?php echo $documentosavaluo_add->RightColumnClass ?>"><div<?php echo $documentosavaluo->id_tipodocumento->CellAttributes() ?>>
<span id="el_documentosavaluo_id_tipodocumento">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_id_tipodocumento"><?php echo (strval($documentosavaluo->id_tipodocumento->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $documentosavaluo->id_tipodocumento->ViewValue); ?></span>
</span>
...
<?php } ?>
<?php if (!$documentosavaluo_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $documentosavaluo_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $documentosavaluo_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fdocumentosavaluoadd.Init();
</script>
<?php
$documentosavaluo_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$documentosavaluo_add->Page_Terminate();
?>
