...
$viewavaluosupervisor_informe_blobview = NULL; // Initialize page object first

class cviewavaluosupervisor_informe_blobview extends cviewavaluosupervisor {
	...
	// Page object name
	var $PageObjName = 'viewavaluosupervisor_informe_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'viewavaluosupervisor');
	...
	function Page_Main() {
		...
		// SQL constructor in viewavaluosupervisor class, viewavaluosupervisorinfo.php
...
// Create page object
if (!isset($viewavaluosupervisor_informe_blobview)) $viewavaluosupervisor_informe_blobview = new cviewavaluosupervisor_informe_blobview();

// Page init
$viewavaluosupervisor_informe_blobview->Page_Init();

// Page main
$viewavaluosupervisor_informe_blobview->Page_Main();
?>
<?php
$viewavaluosupervisor_informe_blobview->Page_Terminate();
?>
