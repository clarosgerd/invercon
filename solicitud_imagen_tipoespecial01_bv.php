...
$solicitud_imagen_tipoespecial01_blobview = NULL; // Initialize page object first

class csolicitud_imagen_tipoespecial01_blobview extends csolicitud {
	...
	// Page object name
	var $PageObjName = 'solicitud_imagen_tipoespecial01_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'solicitud');
	...
	function Page_Main() {
		...
		// SQL constructor in solicitud class, solicitudinfo.php
...
// Create page object
if (!isset($solicitud_imagen_tipoespecial01_blobview)) $solicitud_imagen_tipoespecial01_blobview = new csolicitud_imagen_tipoespecial01_blobview();

// Page init
$solicitud_imagen_tipoespecial01_blobview->Page_Init();

// Page main
$solicitud_imagen_tipoespecial01_blobview->Page_Main();
?>
<?php
$solicitud_imagen_tipoespecial01_blobview->Page_Terminate();
?>
