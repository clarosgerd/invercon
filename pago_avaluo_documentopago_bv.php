...
$pago_avaluo_documentopago_blobview = NULL; // Initialize page object first

class cpago_avaluo_documentopago_blobview extends cpago_avaluo {
	...
	// Page object name
	var $PageObjName = 'pago_avaluo_documentopago_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'pago_avaluo');
...
// Create page object
if (!isset($pago_avaluo_documentopago_blobview)) $pago_avaluo_documentopago_blobview = new cpago_avaluo_documentopago_blobview();

// Page init
$pago_avaluo_documentopago_blobview->Page_Init();

// Page main
$pago_avaluo_documentopago_blobview->Page_Main();
?>
<?php
$pago_avaluo_documentopago_blobview->Page_Terminate();
?>
