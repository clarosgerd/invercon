...
$viewpagoavaluos_documentopago1_blobview = NULL; // Initialize page object first

class cviewpagoavaluos_documentopago1_blobview extends cviewpagoavaluos {
	...
	// Page object name
	var $PageObjName = 'viewpagoavaluos_documentopago1_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'viewpagoavaluos');
	...
	function Page_Main() {
		...
		$fld = $this->fields["documentopago1"];
		...
		// SQL constructor in viewpagoavaluos class, viewpagoavaluosinfo.php
		...
		if ($this->Recordset = $conn->Execute($sSql)) {
			if (!$this->Recordset->EOF) {
				if (ob_get_length())
					ob_end_clean();
				$objBinary->Value = $this->Recordset->fields('documentopago1');
...
// Create page object
if (!isset($viewpagoavaluos_documentopago1_blobview)) $viewpagoavaluos_documentopago1_blobview = new cviewpagoavaluos_documentopago1_blobview();

// Page init
$viewpagoavaluos_documentopago1_blobview->Page_Init();

// Page main
$viewpagoavaluos_documentopago1_blobview->Page_Main();
?>
<?php
$viewpagoavaluos_documentopago1_blobview->Page_Terminate();
?>
