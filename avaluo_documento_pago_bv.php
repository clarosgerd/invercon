...
$avaluo_documento_pago_blobview = NULL; // Initialize page object first

class cavaluo_documento_pago_blobview extends cavaluo {
	...
	// Page object name
	var $PageObjName = 'avaluo_documento_pago_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'avaluo');
	...
	function Page_Main() {
		...
		// SQL constructor in avaluo class, avaluoinfo.php
...
// Create page object
if (!isset($avaluo_documento_pago_blobview)) $avaluo_documento_pago_blobview = new cavaluo_documento_pago_blobview();

// Page init
$avaluo_documento_pago_blobview->Page_Init();

// Page main
$avaluo_documento_pago_blobview->Page_Main();
?>
<?php
$avaluo_documento_pago_blobview->Page_Terminate();
?>
