...
$viewpagoavaluos_documentopago_blobview = NULL; // Initialize page object first

class cviewpagoavaluos_documentopago_blobview extends cviewpagoavaluos {
	...
	// Page object name
	var $PageObjName = 'viewpagoavaluos_documentopago_blobview';
	...
	function Page_Main() {
		...
		if ($this->Recordset = $conn->Execute($sSql)) {
			if (!$this->Recordset->EOF) {
				if (ob_get_length())
					ob_end_clean();
				$objBinary->Value = $this->Recordset->fields('documentopago');
...
// Create page object
if (!isset($viewpagoavaluos_documentopago_blobview)) $viewpagoavaluos_documentopago_blobview = new cviewpagoavaluos_documentopago_blobview();

// Page init
$viewpagoavaluos_documentopago_blobview->Page_Init();

// Page main
$viewpagoavaluos_documentopago_blobview->Page_Main();
?>
<?php
$viewpagoavaluos_documentopago_blobview->Page_Terminate();
?>
