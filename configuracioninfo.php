...
class cconfiguracion extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('configuracion', 'configuracion', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// tipo
		$this->tipo = new cField('configuracion', 'configuracion', 'x_tipo', 'tipo', '`tipo`', '`tipo`', 200, -1, FALSE, '`tipo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tipo->Sortable = TRUE; // Allow sort
		$this->fields['tipo'] = &$this->tipo;

		// detalle
		$this->detalle = new cField('configuracion', 'configuracion', 'x_detalle', 'detalle', '`detalle`', '`detalle`', 201, -1, FALSE, '`detalle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->detalle->Sortable = TRUE; // Allow sort
		$this->fields['detalle'] = &$this->detalle;

		// keywords
		$this->keywords = new cField('configuracion', 'configuracion', 'x_keywords', 'keywords', '`keywords`', '`keywords`', 200, -1, FALSE, '`keywords`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "configuracionedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "configuracionadd.php")
