...
$viewdocumentoinspector_view = NULL; // Initialize page object first

class cviewdocumentoinspector_view extends cviewdocumentoinspector {
	...
	// Page object name
	var $PageObjName = 'viewdocumentoinspector_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "viewdocumentoinspectorlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "viewdocumentoinspectorlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "viewdocumentoinspectorlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($viewdocumentoinspector_view)) $viewdocumentoinspector_view = new cviewdocumentoinspector_view();

// Page init
$viewdocumentoinspector_view->Page_Init();

// Page main
$viewdocumentoinspector_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$viewdocumentoinspector_view->Page_Render();
?>
...
var CurrentForm = fviewdocumentoinspectorview = new ew_Form("fviewdocumentoinspectorview", "view");

// Form_CustomValidate event
fviewdocumentoinspectorview.Form_CustomValidate = 
...
fviewdocumentoinspectorview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fviewdocumentoinspectorview.Lists["x_avaluo"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_tipoinmueble","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"avaluo"};
fviewdocumentoinspectorview.Lists["x_avaluo"].Data = "<?php echo $viewdocumentoinspector_view->avaluo->LookupFilterQuery(FALSE, "view") ?>";
fviewdocumentoinspectorview.Lists["x_id_tipodocumento"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipodocumento"};
fviewdocumentoinspectorview.Lists["x_id_tipodocumento"].Data = "<?php echo $viewdocumentoinspector_view->id_tipodocumento->LookupFilterQuery(FALSE, "view") ?>";
...
<div class="ewToolbar">
<?php $viewdocumentoinspector_view->ExportOptions->Render("body") ?>
<?php
	foreach ($viewdocumentoinspector_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $viewdocumentoinspector_view->ShowPageHeader(); ?>
<?php
$viewdocumentoinspector_view->ShowMessage();
?>
<form name="fviewdocumentoinspectorview" id="fviewdocumentoinspectorview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($viewdocumentoinspector_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $viewdocumentoinspector_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="viewdocumentoinspector">
<input type="hidden" name="modal" value="<?php echo intval($viewdocumentoinspector_view->IsModal) ?>">
...
<?php if ($viewdocumentoinspector->id->Visible) { // id ?>
	<tr id="r_id">
		...
		<td data-name="id"<?php echo $viewdocumentoinspector->id->CellAttributes() ?>>
<span id="el_viewdocumentoinspector_id">
<span<?php echo $viewdocumentoinspector->id->ViewAttributes() ?>>
<?php echo $viewdocumentoinspector->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($viewdocumentoinspector->descripcion->Visible) { // descripcion ?>
	<tr id="r_descripcion">
		<td class="col-sm-3"><span id="elh_viewdocumentoinspector_descripcion"><?php echo $viewdocumentoinspector->descripcion->FldCaption() ?></span></td>
...
<?php echo $viewdocumentoinspector->descripcion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo ew_GetFileViewTag($viewdocumentoinspector->imagen, $viewdocumentoinspector->imagen->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php echo $viewdocumentoinspector->avaluo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $viewdocumentoinspector->id_tipodocumento->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fviewdocumentoinspectorview.Init();
</script>
<?php
$viewdocumentoinspector_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$viewdocumentoinspector_view->Page_Terminate();
?>
