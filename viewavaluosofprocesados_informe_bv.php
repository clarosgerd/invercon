...
$viewavaluosofprocesados_informe_blobview = NULL; // Initialize page object first

class cviewavaluosofprocesados_informe_blobview extends cviewavaluosofprocesados {
	...
	// Page object name
	var $PageObjName = 'viewavaluosofprocesados_informe_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'viewavaluosofprocesados');
	...
	function Page_Main() {
		...
		// SQL constructor in viewavaluosofprocesados class, viewavaluosofprocesadosinfo.php
...
// Create page object
if (!isset($viewavaluosofprocesados_informe_blobview)) $viewavaluosofprocesados_informe_blobview = new cviewavaluosofprocesados_informe_blobview();

// Page init
$viewavaluosofprocesados_informe_blobview->Page_Init();

// Page main
$viewavaluosofprocesados_informe_blobview->Page_Main();
?>
<?php
$viewavaluosofprocesados_informe_blobview->Page_Terminate();
?>
