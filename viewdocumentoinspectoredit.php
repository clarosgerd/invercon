...
$viewdocumentoinspector_edit = NULL; // Initialize page object first

class cviewdocumentoinspector_edit extends cviewdocumentoinspector {
	...
	// Page object name
	var $PageObjName = 'viewdocumentoinspector_edit';
...
// Create page object
if (!isset($viewdocumentoinspector_edit)) $viewdocumentoinspector_edit = new cviewdocumentoinspector_edit();

// Page init
$viewdocumentoinspector_edit->Page_Init();

// Page main
$viewdocumentoinspector_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$viewdocumentoinspector_edit->Page_Render();
?>
...
var CurrentForm = fviewdocumentoinspectoredit = new ew_Form("fviewdocumentoinspectoredit", "edit");

// Validate form
fviewdocumentoinspectoredit.Validate = function() {
...
fviewdocumentoinspectoredit.Form_CustomValidate = 
...
fviewdocumentoinspectoredit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fviewdocumentoinspectoredit.Lists["x_avaluo"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_tipoinmueble","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"avaluo"};
fviewdocumentoinspectoredit.Lists["x_avaluo"].Data = "<?php echo $viewdocumentoinspector_edit->avaluo->LookupFilterQuery(FALSE, "edit") ?>";
fviewdocumentoinspectoredit.Lists["x_id_tipodocumento"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipodocumento"};
fviewdocumentoinspectoredit.Lists["x_id_tipodocumento"].Data = "<?php echo $viewdocumentoinspector_edit->id_tipodocumento->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $viewdocumentoinspector_edit->ShowPageHeader(); ?>
<?php
$viewdocumentoinspector_edit->ShowMessage();
?>
<form name="fviewdocumentoinspectoredit" id="fviewdocumentoinspectoredit" class="<?php echo $viewdocumentoinspector_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($viewdocumentoinspector_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $viewdocumentoinspector_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="viewdocumentoinspector">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($viewdocumentoinspector_edit->IsModal) ?>">
...
<?php } ?>
<?php if (!$viewdocumentoinspector_edit->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($viewdocumentoinspector_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_viewdocumentoinspectoredit" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($viewdocumentoinspector->id->Visible) { // id ?>
<?php if ($viewdocumentoinspector_edit->IsMobileOrModal) { ?>
	<div id="r_id" class="form-group">
		<label id="elh_viewdocumentoinspector_id" class="<?php echo $viewdocumentoinspector_edit->LeftColumnClass ?>"><?php echo $viewdocumentoinspector->id->FldCaption() ?></label>
		<div class="<?php echo $viewdocumentoinspector_edit->RightColumnClass ?>"><div<?php echo $viewdocumentoinspector->id->CellAttributes() ?>>
<span id="el_viewdocumentoinspector_id">
<span<?php echo $viewdocumentoinspector->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $viewdocumentoinspector->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="viewdocumentoinspector" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($viewdocumentoinspector->id->CurrentValue) ?>">
<?php echo $viewdocumentoinspector->id->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_id">
		<td class="col-sm-3"><span id="elh_viewdocumentoinspector_id"><?php echo $viewdocumentoinspector->id->FldCaption() ?></span></td>
		<td<?php echo $viewdocumentoinspector->id->CellAttributes() ?>>
<span id="el_viewdocumentoinspector_id">
<span<?php echo $viewdocumentoinspector->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $viewdocumentoinspector->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="viewdocumentoinspector" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($viewdocumentoinspector->id->CurrentValue) ?>">
<?php echo $viewdocumentoinspector->id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if ($viewdocumentoinspector_edit->IsMobileOrModal) { ?>
	<div id="r_descripcion" class="form-group">
		<label id="elh_viewdocumentoinspector_descripcion" for="x_descripcion" class="<?php echo $viewdocumentoinspector_edit->LeftColumnClass ?>"><?php echo $viewdocumentoinspector->descripcion->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $viewdocumentoinspector_edit->RightColumnClass ?>"><div<?php echo $viewdocumentoinspector->descripcion->CellAttributes() ?>>
...
<?php if ($viewdocumentoinspector_edit->IsMobileOrModal) { ?>
	<div id="r_imagen" class="form-group">
		<label id="elh_viewdocumentoinspector_imagen" class="<?php echo $viewdocumentoinspector_edit->LeftColumnClass ?>"><?php echo $viewdocumentoinspector->imagen->FldCaption() ?></label>
		<div class="<?php echo $viewdocumentoinspector_edit->RightColumnClass ?>"><div<?php echo $viewdocumentoinspector->imagen->CellAttributes() ?>>
...
<?php if ($viewdocumentoinspector_edit->IsMobileOrModal) { ?>
	<div id="r_avaluo" class="form-group">
		<label id="elh_viewdocumentoinspector_avaluo" for="x_avaluo" class="<?php echo $viewdocumentoinspector_edit->LeftColumnClass ?>"><?php echo $viewdocumentoinspector->avaluo->FldCaption() ?></label>
		<div class="<?php echo $viewdocumentoinspector_edit->RightColumnClass ?>"><div<?php echo $viewdocumentoinspector->avaluo->CellAttributes() ?>>
...
<?php if ($viewdocumentoinspector_edit->IsMobileOrModal) { ?>
	<div id="r_id_tipodocumento" class="form-group">
		<label id="elh_viewdocumentoinspector_id_tipodocumento" for="x_id_tipodocumento" class="<?php echo $viewdocumentoinspector_edit->LeftColumnClass ?>"><?php echo $viewdocumentoinspector->id_tipodocumento->FldCaption() ?></label>
		<div class="<?php echo $viewdocumentoinspector_edit->RightColumnClass ?>"><div<?php echo $viewdocumentoinspector->id_tipodocumento->CellAttributes() ?>>
...
<?php } ?>
<?php if (!$viewdocumentoinspector_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $viewdocumentoinspector_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $viewdocumentoinspector_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fviewdocumentoinspectoredit.Init();
</script>
<?php
$viewdocumentoinspector_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$viewdocumentoinspector_edit->Page_Terminate();
?>
