...
class casesor extends cTable {
	...
	function __construct() {
		...
		// nombre
		$this->nombre = new cField('asesor', 'asesor', 'x_nombre', 'nombre', '`nombre`', '`nombre`', 200, -1, FALSE, '`nombre`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nombre->Sortable = TRUE; // Allow sort
		$this->fields['nombre'] = &$this->nombre;

		// apellido
		$this->apellido = new cField('asesor', 'asesor', 'x_apellido', 'apellido', '`apellido`', '`apellido`', 200, -1, FALSE, '`apellido`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->apellido->Sortable = TRUE; // Allow sort
		$this->fields['apellido'] = &$this->apellido;

		// login
		$this->_login = new cField('asesor', 'asesor', 'x__login', 'login', '`login`', '`login`', 200, -1, FALSE, '`login`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// password
		$this->password = new cField('asesor', 'asesor', 'x_password', 'password', '`password`', '`password`', 200, -1, FALSE, '`password`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'PASSWORD');
		$this->password->Sortable = TRUE; // Allow sort
		$this->fields['password'] = &$this->password;

		// ci
		$this->ci = new cField('asesor', 'asesor', 'x_ci', 'ci', '`ci`', '`ci`', 200, -1, FALSE, '`ci`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ci->Sortable = TRUE; // Allow sort
		$this->fields['ci'] = &$this->ci;

		// id_rol
		$this->id_rol = new cField('asesor', 'asesor', 'x_id_rol', 'id_rol', '`id_rol`', '`id_rol`', 3, -1, FALSE, '`id_rol`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->id_rol->Sortable = FALSE; // Allow sort
		$this->id_rol->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_rol'] = &$this->id_rol;

		// id_sucursal
		$this->id_sucursal = new cField('asesor', 'asesor', 'x_id_sucursal', 'id_sucursal', '`id_sucursal`', '`id_sucursal`', 3, -1, FALSE, '`id_sucursal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// email
		$this->_email = new cField('asesor', 'asesor', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->_email->FldDefaultErrMsg = $Language->Phrase("IncorrectEmail");
		$this->fields['email'] = &$this->_email;

		// telefono_fijo01
		$this->telefono_fijo01 = new cField('asesor', 'asesor', 'x_telefono_fijo01', 'telefono_fijo01', '`telefono_fijo01`', '`telefono_fijo01`', 200, -1, FALSE, '`telefono_fijo01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->telefono_fijo01->Sortable = TRUE; // Allow sort
		$this->fields['telefono_fijo01'] = &$this->telefono_fijo01;

		// telefono_fijo02
		$this->telefono_fijo02 = new cField('asesor', 'asesor', 'x_telefono_fijo02', 'telefono_fijo02', '`telefono_fijo02`', '`telefono_fijo02`', 200, -1, FALSE, '`telefono_fijo02`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->telefono_fijo02->Sortable = TRUE; // Allow sort
		$this->fields['telefono_fijo02'] = &$this->telefono_fijo02;

		// celular
		$this->celular = new cField('asesor', 'asesor', 'x_celular', 'celular', '`celular`', '`celular`', 200, -1, FALSE, '`celular`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->celular->Sortable = TRUE; // Allow sort
		$this->fields['celular'] = &$this->celular;

		// celular2
		$this->celular2 = new cField('asesor', 'asesor', 'x_celular2', 'celular2', '`celular2`', '`celular2`', 200, -1, FALSE, '`celular2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->celular2->Sortable = TRUE; // Allow sort
		$this->fields['celular2'] = &$this->celular2;

		// direccion
		$this->direccion = new cField('asesor', 'asesor', 'x_direccion', 'direccion', '`direccion`', '`direccion`', 201, -1, FALSE, '`direccion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->direccion->Sortable = TRUE; // Allow sort
		$this->fields['direccion'] = &$this->direccion;

		// cargo
		$this->cargo = new cField('asesor', 'asesor', 'x_cargo', 'cargo', '`cargo`', '`cargo`', 200, -1, FALSE, '`cargo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->cargo->Sortable = TRUE; // Allow sort
		$this->fields['cargo'] = &$this->cargo;

		// id_institucion
		$this->id_institucion = new cField('asesor', 'asesor', 'x_id_institucion', 'id_institucion', '`id_institucion`', '`id_institucion`', 3, -1, FALSE, '`id_institucion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// especialidad
		$this->especialidad = new cField('asesor', 'asesor', 'x_especialidad', 'especialidad', '`especialidad`', '`especialidad`', 200, -1, FALSE, '`especialidad`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->especialidad->Sortable = TRUE; // Allow sort
		$this->fields['especialidad'] = &$this->especialidad;

		// status
		$this->status = new cField('asesor', 'asesor', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`asesor`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "asesoredit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "asesoradd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("asesorview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("asesorview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "asesoradd.php?" . $this->UrlParm($parm);
		else
			$url = "asesoradd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("asesoredit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("asesoradd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("asesordelete.php", $this->UrlParm());
	}
