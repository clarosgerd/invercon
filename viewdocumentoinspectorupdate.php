...
$viewdocumentoinspector_update = NULL; // Initialize page object first

class cviewdocumentoinspector_update extends cviewdocumentoinspector {
	...
	// Page object name
	var $PageObjName = 'viewdocumentoinspector_update';
	...
	function Page_Main() {
		...
		if (count($this->RecKeys) <= 0)
			$this->Page_Terminate("viewdocumentoinspectorlist.php"); // No records selected, return to list
...
// Create page object
if (!isset($viewdocumentoinspector_update)) $viewdocumentoinspector_update = new cviewdocumentoinspector_update();

// Page init
$viewdocumentoinspector_update->Page_Init();

// Page main
$viewdocumentoinspector_update->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$viewdocumentoinspector_update->Page_Render();
?>
...
var CurrentForm = fviewdocumentoinspectorupdate = new ew_Form("fviewdocumentoinspectorupdate", "update");

// Validate form
fviewdocumentoinspectorupdate.Validate = function() {
...
fviewdocumentoinspectorupdate.Form_CustomValidate = 
...
fviewdocumentoinspectorupdate.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fviewdocumentoinspectorupdate.Lists["x_avaluo"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_tipoinmueble","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"avaluo"};
fviewdocumentoinspectorupdate.Lists["x_avaluo"].Data = "<?php echo $viewdocumentoinspector_update->avaluo->LookupFilterQuery(FALSE, "update") ?>";
fviewdocumentoinspectorupdate.Lists["x_id_tipodocumento"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipodocumento"};
fviewdocumentoinspectorupdate.Lists["x_id_tipodocumento"].Data = "<?php echo $viewdocumentoinspector_update->id_tipodocumento->LookupFilterQuery(FALSE, "update") ?>";
...
<?php $viewdocumentoinspector_update->ShowPageHeader(); ?>
<?php
$viewdocumentoinspector_update->ShowMessage();
?>
<form name="fviewdocumentoinspectorupdate" id="fviewdocumentoinspectorupdate" class="<?php echo $viewdocumentoinspector_update->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($viewdocumentoinspector_update->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $viewdocumentoinspector_update->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="viewdocumentoinspector">
<input type="hidden" name="a_update" id="a_update" value="U">
<input type="hidden" name="modal" value="<?php echo intval($viewdocumentoinspector_update->IsModal) ?>">
<?php foreach ($viewdocumentoinspector_update->RecKeys as $key) { ?>
<?php $keyvalue = is_array($key) ? implode($EW_COMPOSITE_KEY_SEPARATOR, $key) : $key; ?>
<input type="hidden" name="key_m[]" value="<?php echo ew_HtmlEncode($keyvalue) ?>">
<?php } ?>
<?php if (!$viewdocumentoinspector_update->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($viewdocumentoinspector_update->IsMobileOrModal) { ?>
<div id="tbl_viewdocumentoinspectorupdate" class="ewUpdateDiv"><!-- page -->
	<div class="checkbox">
		<label><input type="checkbox" name="u" id="u" onclick="ew_SelectAll(this);"> <?php echo $Language->Phrase("UpdateSelectAll") ?></label>
	</div>
<?php } else { ?>
<table id="tbl_viewdocumentoinspectorupdate" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- desktop table -->
	<thead>
	<tr>
...
<?php if ($viewdocumentoinspector_update->IsMobileOrModal) { ?>
	<div id="r_descripcion" class="form-group">
		<label for="x_descripcion" class="<?php echo $viewdocumentoinspector_update->LeftColumnClass ?>"><div class="checkbox"><label>
<input type="checkbox" name="u_descripcion" id="u_descripcion" class="ewMultiSelect" value="1"<?php echo ($viewdocumentoinspector->descripcion->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewdocumentoinspector->descripcion->FldCaption() ?></label></div></label>
		<div class="<?php echo $viewdocumentoinspector_update->RightColumnClass ?>"><div<?php echo $viewdocumentoinspector->descripcion->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_descripcion">
		<td class="col-sm-3"<?php echo $viewdocumentoinspector->descripcion->CellAttributes() ?>><span id="elh_viewdocumentoinspector_descripcion"><div class="checkbox"><label for="u_descripcion">
<input type="checkbox" name="u_descripcion" id="u_descripcion" class="ewMultiSelect" value="1"<?php echo ($viewdocumentoinspector->descripcion->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewdocumentoinspector->descripcion->FldCaption() ?></label></div></span></td>
...
<?php if ($viewdocumentoinspector_update->IsMobileOrModal) { ?>
	<div id="r_imagen" class="form-group">
		<label class="<?php echo $viewdocumentoinspector_update->LeftColumnClass ?>"><div class="checkbox"><label>
<input type="checkbox" name="u_imagen" id="u_imagen" class="ewMultiSelect" value="1"<?php echo ($viewdocumentoinspector->imagen->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewdocumentoinspector->imagen->FldCaption() ?></label></div></label>
		<div class="<?php echo $viewdocumentoinspector_update->RightColumnClass ?>"><div<?php echo $viewdocumentoinspector->imagen->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_imagen">
		<td class="col-sm-3"<?php echo $viewdocumentoinspector->imagen->CellAttributes() ?>><span id="elh_viewdocumentoinspector_imagen"><div class="checkbox"><label for="u_imagen">
<input type="checkbox" name="u_imagen" id="u_imagen" class="ewMultiSelect" value="1"<?php echo ($viewdocumentoinspector->imagen->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewdocumentoinspector->imagen->FldCaption() ?></label></div></span></td>
...
<?php if ($viewdocumentoinspector_update->IsMobileOrModal) { ?>
	<div id="r_avaluo" class="form-group">
		<label for="x_avaluo" class="<?php echo $viewdocumentoinspector_update->LeftColumnClass ?>"><div class="checkbox"><label>
<input type="checkbox" name="u_avaluo" id="u_avaluo" class="ewMultiSelect" value="1"<?php echo ($viewdocumentoinspector->avaluo->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewdocumentoinspector->avaluo->FldCaption() ?></label></div></label>
		<div class="<?php echo $viewdocumentoinspector_update->RightColumnClass ?>"><div<?php echo $viewdocumentoinspector->avaluo->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_avaluo">
		<td class="col-sm-3"<?php echo $viewdocumentoinspector->avaluo->CellAttributes() ?>><span id="elh_viewdocumentoinspector_avaluo"><div class="checkbox"><label for="u_avaluo">
<input type="checkbox" name="u_avaluo" id="u_avaluo" class="ewMultiSelect" value="1"<?php echo ($viewdocumentoinspector->avaluo->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewdocumentoinspector->avaluo->FldCaption() ?></label></div></span></td>
...
<?php if ($viewdocumentoinspector_update->IsMobileOrModal) { ?>
	<div id="r_id_tipodocumento" class="form-group">
		<label for="x_id_tipodocumento" class="<?php echo $viewdocumentoinspector_update->LeftColumnClass ?>"><div class="checkbox"><label>
<input type="checkbox" name="u_id_tipodocumento" id="u_id_tipodocumento" class="ewMultiSelect" value="1"<?php echo ($viewdocumentoinspector->id_tipodocumento->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewdocumentoinspector->id_tipodocumento->FldCaption() ?></label></div></label>
		<div class="<?php echo $viewdocumentoinspector_update->RightColumnClass ?>"><div<?php echo $viewdocumentoinspector->id_tipodocumento->CellAttributes() ?>>
<span id="el_viewdocumentoinspector_id_tipodocumento">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_id_tipodocumento"><?php echo (strval($viewdocumentoinspector->id_tipodocumento->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $viewdocumentoinspector->id_tipodocumento->ViewValue); ?></span>
</span>
...
<?php } else { ?>
	<tr id="r_id_tipodocumento">
		<td class="col-sm-3"<?php echo $viewdocumentoinspector->id_tipodocumento->CellAttributes() ?>><span id="elh_viewdocumentoinspector_id_tipodocumento"><div class="checkbox"><label for="u_id_tipodocumento">
<input type="checkbox" name="u_id_tipodocumento" id="u_id_tipodocumento" class="ewMultiSelect" value="1"<?php echo ($viewdocumentoinspector->id_tipodocumento->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewdocumentoinspector->id_tipodocumento->FldCaption() ?></label></div></span></td>
...
<?php } ?>
<?php if (!$viewdocumentoinspector_update->IsModal) { ?>
	<div class="form-group"><!-- buttons .form-group -->
		<div class="<?php echo $viewdocumentoinspector_update->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("UpdateBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $viewdocumentoinspector_update->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
		</div><!-- /buttons offset -->
...
<script type="text/javascript">
fviewdocumentoinspectorupdate.Init();
</script>
<?php
$viewdocumentoinspector_update->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$viewdocumentoinspector_update->Page_Terminate();
?>
