...
$viewsolicitudframe_imagen_maquinaria02_blobview = NULL; // Initialize page object first

class cviewsolicitudframe_imagen_maquinaria02_blobview extends cviewsolicitudframe {
	...
	// Page object name
	var $PageObjName = 'viewsolicitudframe_imagen_maquinaria02_blobview';
...
// Create page object
if (!isset($viewsolicitudframe_imagen_maquinaria02_blobview)) $viewsolicitudframe_imagen_maquinaria02_blobview = new cviewsolicitudframe_imagen_maquinaria02_blobview();

// Page init
$viewsolicitudframe_imagen_maquinaria02_blobview->Page_Init();

// Page main
$viewsolicitudframe_imagen_maquinaria02_blobview->Page_Main();
?>
<?php
$viewsolicitudframe_imagen_maquinaria02_blobview->Page_Terminate();
?>
