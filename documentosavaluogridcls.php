...
$documentosavaluo_grid = NULL; // Initialize page object first

class cdocumentosavaluo_grid extends cdocumentosavaluo {
	...
	// Page object name
	var $PageObjName = 'documentosavaluo_grid';

	// Grid form hidden field names
	var $FormName = 'fdocumentosavaluogrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["documentosavaluo"];
