...
$comentariosavaluo = NULL;

//
// Table class for comentariosavaluo
//
class ccomentariosavaluo extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'comentariosavaluo';
		$this->TableName = 'comentariosavaluo';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`comentariosavaluo`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('comentariosavaluo', 'comentariosavaluo', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// created_at
		$this->created_at = new cField('comentariosavaluo', 'comentariosavaluo', 'x_created_at', 'created_at', '`created_at`', ew_CastDateFieldForLike('`created_at`', 0, "DB"), 135, 0, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`comentariosavaluo`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "comentariosavaluolist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "comentariosavaluoedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "comentariosavaluoadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("comentariosavaluoview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("comentariosavaluoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "comentariosavaluoadd.php?" . $this->UrlParm($parm);
		else
			$url = "comentariosavaluoadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("comentariosavaluoedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("comentariosavaluoadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("comentariosavaluodelete.php", $this->UrlParm());
	}
