...
$viewdocumentoinspector_grid = NULL; // Initialize page object first

class cviewdocumentoinspector_grid extends cviewdocumentoinspector {
	...
	// Page object name
	var $PageObjName = 'viewdocumentoinspector_grid';

	// Grid form hidden field names
	var $FormName = 'fviewdocumentoinspectorgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["viewdocumentoinspector"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "viewavaluoinspector") {
			...
			if ($GLOBALS["viewavaluoinspector"]->EventCancelled) $this->EventCancelled = TRUE;
		}
