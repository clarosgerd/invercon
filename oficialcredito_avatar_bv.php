...
$oficialcredito_avatar_blobview = NULL; // Initialize page object first

class coficialcredito_avatar_blobview extends coficialcredito {
	...
	// Page object name
	var $PageObjName = 'oficialcredito_avatar_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'oficialcredito');
	...
	function Page_Main() {
		...
		// SQL constructor in oficialcredito class, oficialcreditoinfo.php
...
// Create page object
if (!isset($oficialcredito_avatar_blobview)) $oficialcredito_avatar_blobview = new coficialcredito_avatar_blobview();

// Page init
$oficialcredito_avatar_blobview->Page_Init();

// Page main
$oficialcredito_avatar_blobview->Page_Main();
?>
<?php
$oficialcredito_avatar_blobview->Page_Terminate();
?>
