...
$viewsolicitudsupervisor_imagen_inmueble03_blobview = NULL; // Initialize page object first

class cviewsolicitudsupervisor_imagen_inmueble03_blobview extends cviewsolicitudsupervisor {
	...
	// Page object name
	var $PageObjName = 'viewsolicitudsupervisor_imagen_inmueble03_blobview';
	...
	function Page_Main() {
		...
		$fld = $this->fields["imagen_inmueble03"];
		...
		if ($this->Recordset = $conn->Execute($sSql)) {
			if (!$this->Recordset->EOF) {
				if (ob_get_length())
					ob_end_clean();
				$objBinary->Value = $this->Recordset->fields('imagen_inmueble03');
...
// Create page object
if (!isset($viewsolicitudsupervisor_imagen_inmueble03_blobview)) $viewsolicitudsupervisor_imagen_inmueble03_blobview = new cviewsolicitudsupervisor_imagen_inmueble03_blobview();

// Page init
$viewsolicitudsupervisor_imagen_inmueble03_blobview->Page_Init();

// Page main
$viewsolicitudsupervisor_imagen_inmueble03_blobview->Page_Main();
?>
<?php
$viewsolicitudsupervisor_imagen_inmueble03_blobview->Page_Terminate();
?>
