...
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next(":not([disabled])").click();" tabindex="-1" class="form-control ewLookupText" id="lu_x<?php echo $pago_grid->RowIndex ?>_cliente_id"><?php echo (strval($pago->cliente_id->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $pago->cliente_id->ViewValue); ?></span>
</span>
...
// Render list options (body, right)
$pago_grid->ListOptions->Render("body", "right", $pago_grid->RowIndex);
?>
<script type="text/javascript">
fpagogrid.UpdateOpts(<?php echo $pago_grid->RowIndex ?>);
</script>
