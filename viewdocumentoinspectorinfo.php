...
$viewdocumentoinspector = NULL;

//
// Table class for viewdocumentoinspector
//
class cviewdocumentoinspector extends cTable {
	var $id;
	var $descripcion;
	var $imagen;
	var $avaluo;
	...
	function __construct() {
		...
		$this->TableVar = 'viewdocumentoinspector';
		$this->TableName = 'viewdocumentoinspector';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`viewdocumentoinspector`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('viewdocumentoinspector', 'viewdocumentoinspector', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// descripcion
		$this->descripcion = new cField('viewdocumentoinspector', 'viewdocumentoinspector', 'x_descripcion', 'descripcion', '`descripcion`', '`descripcion`', 201, -1, FALSE, '`descripcion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->descripcion->Sortable = TRUE; // Allow sort
		$this->fields['descripcion'] = &$this->descripcion;

		// imagen
		$this->imagen = new cField('viewdocumentoinspector', 'viewdocumentoinspector', 'x_imagen', 'imagen', '`imagen`', '`imagen`', 205, -1, TRUE, '`imagen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen->Sortable = TRUE; // Allow sort
		$this->fields['imagen'] = &$this->imagen;

		// avaluo
		$this->avaluo = new cField('viewdocumentoinspector', 'viewdocumentoinspector', 'x_avaluo', 'avaluo', '`avaluo`', '`avaluo`', 3, -1, FALSE, '`avaluo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// path_drive
		$this->path_drive = new cField('viewdocumentoinspector', 'viewdocumentoinspector', 'x_path_drive', 'path_drive', '`path_drive`', '`path_drive`', 200, -1, FALSE, '`path_drive`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->path_drive->Sortable = FALSE; // Allow sort
		$this->fields['path_drive'] = &$this->path_drive;

		// id_tipodocumento
		$this->id_tipodocumento = new cField('viewdocumentoinspector', 'viewdocumentoinspector', 'x_id_tipodocumento', 'id_tipodocumento', '`id_tipodocumento`', '`id_tipodocumento`', 3, -1, FALSE, '`id_tipodocumento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// created_at
		$this->created_at = new cField('viewdocumentoinspector', 'viewdocumentoinspector', 'x_created_at', 'created_at', '`created_at`', ew_CastDateFieldForLike('`created_at`', 0, "DB"), 135, 0, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "viewavaluoinspector") {
	...
	// Master filter
	function SqlMasterFilter_viewavaluoinspector() {
		return "`id`=@id@";
	}

	// Detail filter
	function SqlDetailFilter_viewavaluoinspector() {
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`viewdocumentoinspector`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "viewdocumentoinspectorlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "viewdocumentoinspectoredit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "viewdocumentoinspectoradd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("viewdocumentoinspectorview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("viewdocumentoinspectorview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "viewdocumentoinspectoradd.php?" . $this->UrlParm($parm);
		else
			$url = "viewdocumentoinspectoradd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("viewdocumentoinspectoredit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("viewdocumentoinspectoradd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("viewdocumentoinspectordelete.php", $this->UrlParm());
	}

	// Add master url
	function AddMasterUrl($url) {
		if ($this->getCurrentMasterTable() == "viewavaluoinspector" && strpos($url, EW_TABLE_SHOW_MASTER . "=") === FALSE) {
