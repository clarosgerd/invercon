...
<?php if (!$provincia_add->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($provincia_add->IsMobileOrModal) { ?>
<div class="ewAddDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_provinciaadd" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
...
<?php if ($provincia_add->IsMobileOrModal) { ?>
	<div id="r_id_departamento" class="form-group">
		<label id="elh_provincia_id_departamento" for="x_id_departamento" class="<?php echo $provincia_add->LeftColumnClass ?>"><?php echo $provincia->id_departamento->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
