...
$solicitud_imagen_inmueble06_blobview = NULL; // Initialize page object first

class csolicitud_imagen_inmueble06_blobview extends csolicitud {
	...
	// Page object name
	var $PageObjName = 'solicitud_imagen_inmueble06_blobview';
...
// Create page object
if (!isset($solicitud_imagen_inmueble06_blobview)) $solicitud_imagen_inmueble06_blobview = new csolicitud_imagen_inmueble06_blobview();

// Page init
$solicitud_imagen_inmueble06_blobview->Page_Init();

// Page main
$solicitud_imagen_inmueble06_blobview->Page_Main();
?>
<?php
$solicitud_imagen_inmueble06_blobview->Page_Terminate();
?>
