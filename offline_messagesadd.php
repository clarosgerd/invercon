...
$offline_messages_add = NULL; // Initialize page object first

class coffline_messages_add extends coffline_messages {
	...
	// Page object name
	var $PageObjName = 'offline_messages_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "offline_messagesview.php")
	...
	function NewRow() {
		...
		$row['user_agent'] = $this->user_agent->CurrentValue;
		return $row;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// timestamp
		$this->timestamp->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->timestamp->CurrentValue, 0), ew_CurrentDate(), FALSE);
...
// Create page object
if (!isset($offline_messages_add)) $offline_messages_add = new coffline_messages_add();

// Page init
$offline_messages_add->Page_Init();

// Page main
$offline_messages_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$offline_messages_add->Page_Render();
?>
...
var CurrentForm = foffline_messagesadd = new ew_Form("foffline_messagesadd", "add");

// Validate form
foffline_messagesadd.Validate = function() {
...
foffline_messagesadd.Form_CustomValidate = 
...
foffline_messagesadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $offline_messages_add->ShowPageHeader(); ?>
<?php
$offline_messages_add->ShowMessage();
?>
<form name="foffline_messagesadd" id="foffline_messagesadd" class="<?php echo $offline_messages_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($offline_messages_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $offline_messages_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="offline_messages">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($offline_messages_add->IsModal) ?>">
<?php if (!$offline_messages_add->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($offline_messages_add->IsMobileOrModal) { ?>
<div class="ewAddDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_offline_messagesadd" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($offline_messages->id->Visible) { // id ?>
<?php if ($offline_messages_add->IsMobileOrModal) { ?>
	<div id="r_id" class="form-group">
		<label id="elh_offline_messages_id" for="x_id" class="<?php echo $offline_messages_add->LeftColumnClass ?>"><?php echo $offline_messages->id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $offline_messages_add->RightColumnClass ?>"><div<?php echo $offline_messages->id->CellAttributes() ?>>
<span id="el_offline_messages_id">
<input type="text" data-table="offline_messages" data-field="x_id" name="x_id" id="x_id" size="30" placeholder="<?php echo ew_HtmlEncode($offline_messages->id->getPlaceHolder()) ?>" value="<?php echo $offline_messages->id->EditValue ?>"<?php echo $offline_messages->id->EditAttributes() ?>>
</span>
...
<?php if ($offline_messages_add->IsMobileOrModal) { ?>
	<div id="r_timestamp" class="form-group">
		<label id="elh_offline_messages_timestamp" for="x_timestamp" class="<?php echo $offline_messages_add->LeftColumnClass ?>"><?php echo $offline_messages->timestamp->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $offline_messages_add->RightColumnClass ?>"><div<?php echo $offline_messages->timestamp->CellAttributes() ?>>
...
<?php if ($offline_messages_add->IsMobileOrModal) { ?>
	<div id="r_name" class="form-group">
		<label id="elh_offline_messages_name" for="x_name" class="<?php echo $offline_messages_add->LeftColumnClass ?>"><?php echo $offline_messages->name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $offline_messages_add->RightColumnClass ?>"><div<?php echo $offline_messages->name->CellAttributes() ?>>
...
<?php if ($offline_messages_add->IsMobileOrModal) { ?>
	<div id="r__email" class="form-group">
		<label id="elh_offline_messages__email" for="x__email" class="<?php echo $offline_messages_add->LeftColumnClass ?>"><?php echo $offline_messages->_email->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $offline_messages_add->RightColumnClass ?>"><div<?php echo $offline_messages->_email->CellAttributes() ?>>
...
<?php if ($offline_messages_add->IsMobileOrModal) { ?>
	<div id="r_message" class="form-group">
		<label id="elh_offline_messages_message" for="x_message" class="<?php echo $offline_messages_add->LeftColumnClass ?>"><?php echo $offline_messages->message->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $offline_messages_add->RightColumnClass ?>"><div<?php echo $offline_messages->message->CellAttributes() ?>>
...
<?php if ($offline_messages_add->IsMobileOrModal) { ?>
	<div id="r_ip" class="form-group">
		<label id="elh_offline_messages_ip" for="x_ip" class="<?php echo $offline_messages_add->LeftColumnClass ?>"><?php echo $offline_messages->ip->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $offline_messages_add->RightColumnClass ?>"><div<?php echo $offline_messages->ip->CellAttributes() ?>>
...
<?php if ($offline_messages_add->IsMobileOrModal) { ?>
	<div id="r_user_agent" class="form-group">
		<label id="elh_offline_messages_user_agent" for="x_user_agent" class="<?php echo $offline_messages_add->LeftColumnClass ?>"><?php echo $offline_messages->user_agent->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $offline_messages_add->RightColumnClass ?>"><div<?php echo $offline_messages->user_agent->CellAttributes() ?>>
...
<?php } ?>
<?php if (!$offline_messages_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $offline_messages_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $offline_messages_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
foffline_messagesadd.Init();
</script>
<?php
$offline_messages_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$offline_messages_add->Page_Terminate();
?>
