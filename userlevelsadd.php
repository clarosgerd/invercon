...
class cuserlevels_add extends cuserlevels {
	...
	function RenderRow() {
		...
		$this->userlevelname->ViewCustomAttributes = "";
			...
			$this->userlevelname->PlaceHolder = ew_RemoveHtml($this->userlevelname->FldTitle());
...
<?php } else { ?>
	<tr id="r_userlevelid">
		<td class="col-sm-3"><span id="elh_userlevels_userlevelid"><?php echo $userlevels->userlevelid->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
...
<?php } else { ?>
	<tr id="r_userlevelname">
		<td class="col-sm-3"><span id="elh_userlevels_userlevelname"><?php echo $userlevels->userlevelname->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
