...
$viewavaluoinspector = NULL;

//
// Table class for viewavaluoinspector
//
class cviewavaluoinspector extends cTable {
	var $id;
	var $tipoinmueble;
	var $codigoavaluo;
	var $id_solicitud;
	...
	function __construct() {
		...
		$this->TableVar = 'viewavaluoinspector';
		$this->TableName = 'viewavaluoinspector';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`viewavaluoinspector`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('viewavaluoinspector', 'viewavaluoinspector', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = FALSE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// tipoinmueble
		$this->tipoinmueble = new cField('viewavaluoinspector', 'viewavaluoinspector', 'x_tipoinmueble', 'tipoinmueble', '`tipoinmueble`', '`tipoinmueble`', 200, -1, FALSE, '`tipoinmueble`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// codigoavaluo
		$this->codigoavaluo = new cField('viewavaluoinspector', 'viewavaluoinspector', 'x_codigoavaluo', 'codigoavaluo', '`codigoavaluo`', '`codigoavaluo`', 200, -1, FALSE, '`codigoavaluo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->codigoavaluo->Sortable = TRUE; // Allow sort
		$this->fields['codigoavaluo'] = &$this->codigoavaluo;

		// id_solicitud
		$this->id_solicitud = new cField('viewavaluoinspector', 'viewavaluoinspector', 'x_id_solicitud', 'id_solicitud', '`id_solicitud`', '`id_solicitud`', 3, -1, FALSE, '`id_solicitud`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// id_oficialcredito
		$this->id_oficialcredito = new cField('viewavaluoinspector', 'viewavaluoinspector', 'x_id_oficialcredito', 'id_oficialcredito', '`id_oficialcredito`', '`id_oficialcredito`', 200, -1, FALSE, '`EV__id_oficialcredito`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'SELECT');
		...
		// id_inspector
		$this->id_inspector = new cField('viewavaluoinspector', 'viewavaluoinspector', 'x_id_inspector', 'id_inspector', '`id_inspector`', '`id_inspector`', 200, -1, FALSE, '`EV__id_inspector`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'SELECT');
		...
		// id_cliente
		$this->id_cliente = new cField('viewavaluoinspector', 'viewavaluoinspector', 'x_id_cliente', 'id_cliente', '`id_cliente`', '`id_cliente`', 3, -1, FALSE, '`id_cliente`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// is_active
		$this->is_active = new cField('viewavaluoinspector', 'viewavaluoinspector', 'x_is_active', 'is_active', '`is_active`', '`is_active`', 16, -1, FALSE, '`is_active`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// estado
		$this->estado = new cField('viewavaluoinspector', 'viewavaluoinspector', 'x_estado', 'estado', '`estado`', '`estado`', 16, -1, FALSE, '`estado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// estadointerno
		$this->estadointerno = new cField('viewavaluoinspector', 'viewavaluoinspector', 'x_estadointerno', 'estadointerno', '`estadointerno`', '`estadointerno`', 3, -1, FALSE, '`estadointerno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// estadopago
		$this->estadopago = new cField('viewavaluoinspector', 'viewavaluoinspector', 'x_estadopago', 'estadopago', '`estadopago`', '`estadopago`', 3, -1, FALSE, '`estadopago`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// fecha_avaluo
		$this->fecha_avaluo = new cField('viewavaluoinspector', 'viewavaluoinspector', 'x_fecha_avaluo', 'fecha_avaluo', '`fecha_avaluo`', ew_CastDateFieldForLike('`fecha_avaluo`', 10, "DB"), 135, 10, FALSE, '`fecha_avaluo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// montoincial
		$this->montoincial = new cField('viewavaluoinspector', 'viewavaluoinspector', 'x_montoincial', 'montoincial', '`montoincial`', '`montoincial`', 5, -1, FALSE, '`montoincial`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// id_metodopago
		$this->id_metodopago = new cField('viewavaluoinspector', 'viewavaluoinspector', 'x_id_metodopago', 'id_metodopago', '`id_metodopago`', '`id_metodopago`', 3, -1, FALSE, '`id_metodopago`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// created_at
		$this->created_at = new cField('viewavaluoinspector', 'viewavaluoinspector', 'x_created_at', 'created_at', '`created_at`', ew_CastDateFieldForLike('`created_at`', 0, "DB"), 135, 0, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DateModified
		$this->DateModified = new cField('viewavaluoinspector', 'viewavaluoinspector', 'x_DateModified', 'DateModified', '`DateModified`', ew_CastDateFieldForLike('`DateModified`', 0, "DB"), 135, 0, FALSE, '`DateModified`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DateDeleted
		$this->DateDeleted = new cField('viewavaluoinspector', 'viewavaluoinspector', 'x_DateDeleted', 'DateDeleted', '`DateDeleted`', ew_CastDateFieldForLike('`DateDeleted`', 0, "DB"), 135, 0, FALSE, '`DateDeleted`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CreatedBy
		$this->CreatedBy = new cField('viewavaluoinspector', 'viewavaluoinspector', 'x_CreatedBy', 'CreatedBy', '`CreatedBy`', '`CreatedBy`', 200, -1, FALSE, '`CreatedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreatedBy->Sortable = FALSE; // Allow sort
		$this->fields['CreatedBy'] = &$this->CreatedBy;

		// ModifiedBy
		$this->ModifiedBy = new cField('viewavaluoinspector', 'viewavaluoinspector', 'x_ModifiedBy', 'ModifiedBy', '`ModifiedBy`', '`ModifiedBy`', 200, -1, FALSE, '`ModifiedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ModifiedBy->Sortable = FALSE; // Allow sort
		$this->fields['ModifiedBy'] = &$this->ModifiedBy;

		// DeletedBy
		$this->DeletedBy = new cField('viewavaluoinspector', 'viewavaluoinspector', 'x_DeletedBy', 'DeletedBy', '`DeletedBy`', '`DeletedBy`', 200, -1, FALSE, '`DeletedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "viewsolicitudinspector") {
	...
	// Master filter
	function SqlMasterFilter_viewsolicitudinspector() {
		return "`id`=@id@";
	}

	// Detail filter
	function SqlDetailFilter_viewsolicitudinspector() {
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "viewdocumentoinspector") {
			$sDetailUrl = $GLOBALS["viewdocumentoinspector"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "viewavaluoinspectorlist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`viewavaluoinspector`";
	}
	...
	function getSqlSelectList() { // Select for List page
		$select = "";
		$select = "SELECT * FROM (" .
			"SELECT *, (SELECT CONCAT(COALESCE(`nombre`, ''),'" . ew_ValueSeparator(1, $this->id_oficialcredito) . "',COALESCE(`apellido`,'')) FROM `oficialcredito` `EW_TMP_LOOKUPTABLE` WHERE `EW_TMP_LOOKUPTABLE`.`login` = `viewavaluoinspector`.`id_oficialcredito` LIMIT 1) AS `EV__id_oficialcredito`, (SELECT CONCAT(COALESCE(`apellido`, ''),'" . ew_ValueSeparator(1, $this->id_inspector) . "',COALESCE(`nombre`,'')) FROM `inspector` `EW_TMP_LOOKUPTABLE` WHERE `EW_TMP_LOOKUPTABLE`.`login` = `viewavaluoinspector`.`id_inspector` LIMIT 1) AS `EV__id_inspector` FROM `viewavaluoinspector`" .
			") `EW_TMP_TABLE`";
	...
	function Update(&$rs, $where = "", $rsold = NULL, $curfilter = TRUE) {
		...
		// Cascade Update detail table 'viewdocumentoinspector'
		...
		if ($bCascadeUpdate) {
			if (!isset($GLOBALS["viewdocumentoinspector"])) $GLOBALS["viewdocumentoinspector"] = new cviewdocumentoinspector();
			$rswrk = $GLOBALS["viewdocumentoinspector"]->LoadRs("`avaluo` = " . ew_QuotedValue($rsold['id'], EW_DATATYPE_NUMBER, 'DB')); 
			while ($rswrk && !$rswrk->EOF) {
				...
				$bUpdate = $GLOBALS["viewdocumentoinspector"]->Row_Updating($rsdtlold, $rsdtlnew);
				if ($bUpdate)
					$bUpdate = $GLOBALS["viewdocumentoinspector"]->Update($rscascade, $rskey, $rswrk->fields);
				if (!$bUpdate) return FALSE;

				// Call Row_Updated event
				$GLOBALS["viewdocumentoinspector"]->Row_Updated($rsdtlold, $rsdtlnew);
				$rswrk->MoveNext();
			}
		}
	...
	function Delete(&$rs, $where = "", $curfilter = TRUE) {
		...
		// Cascade delete detail table 'viewdocumentoinspector'
		if (!isset($GLOBALS["viewdocumentoinspector"])) $GLOBALS["viewdocumentoinspector"] = new cviewdocumentoinspector();
		$rscascade = $GLOBALS["viewdocumentoinspector"]->LoadRs("`avaluo` = " . ew_QuotedValue($rs['id'], EW_DATATYPE_NUMBER, "DB")); 
		$dtlrows = ($rscascade) ? $rscascade->GetRows() : array();

		// Call Row Deleting event
		foreach ($dtlrows as $dtlrow) {
			$bDelete = $GLOBALS["viewdocumentoinspector"]->Row_Deleting($dtlrow);
			if (!$bDelete) break;
		}
		if ($bDelete) {
			foreach ($dtlrows as $dtlrow) {
				$bDelete = $GLOBALS["viewdocumentoinspector"]->Delete($dtlrow); // Delete
				if ($bDelete === FALSE)
					break;
			}
		}
		...
		if ($bDelete) {
			foreach ($dtlrows as $dtlrow) {
				$GLOBALS["viewdocumentoinspector"]->Row_Deleted($dtlrow);
			}
		}
		if ($bDelete)
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "viewavaluoinspectorlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "viewavaluoinspectoredit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "viewavaluoinspectoradd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("viewavaluoinspectorview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("viewavaluoinspectorview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "viewavaluoinspectoradd.php?" . $this->UrlParm($parm);
		else
			$url = "viewavaluoinspectoradd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("viewavaluoinspectoredit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("viewavaluoinspectoredit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("viewavaluoinspectoradd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("viewavaluoinspectoradd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("viewavaluoinspectordelete.php", $this->UrlParm());
	}

	// Add master url
	function AddMasterUrl($url) {
		if ($this->getCurrentMasterTable() == "viewsolicitudinspector" && strpos($url, EW_TABLE_SHOW_MASTER . "=") === FALSE) {
	...
	if ($rsnew['estadointerno']==3)
				{
					...
					$Email->Subject = "El avaluo fue terminado por inspector";
					$Email->Content = "El avaluo fue terminado por inspector";
