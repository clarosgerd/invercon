...
$viewdocumentosupervisor = NULL;

//
// Table class for viewdocumentosupervisor
//
class cviewdocumentosupervisor extends cTable {
	var $id;
	var $descripcion;
	var $imagen;
	var $avaluo;
	...
	function __construct() {
		...
		$this->TableVar = 'viewdocumentosupervisor';
		$this->TableName = 'viewdocumentosupervisor';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`viewdocumentosupervisor`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('viewdocumentosupervisor', 'viewdocumentosupervisor', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// descripcion
		$this->descripcion = new cField('viewdocumentosupervisor', 'viewdocumentosupervisor', 'x_descripcion', 'descripcion', '`descripcion`', '`descripcion`', 201, -1, FALSE, '`descripcion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->descripcion->Sortable = TRUE; // Allow sort
		$this->fields['descripcion'] = &$this->descripcion;

		// imagen
		$this->imagen = new cField('viewdocumentosupervisor', 'viewdocumentosupervisor', 'x_imagen', 'imagen', '`imagen`', '`imagen`', 205, -1, TRUE, '`imagen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen->Sortable = TRUE; // Allow sort
		$this->fields['imagen'] = &$this->imagen;

		// avaluo
		$this->avaluo = new cField('viewdocumentosupervisor', 'viewdocumentosupervisor', 'x_avaluo', 'avaluo', '`avaluo`', '`avaluo`', 3, -1, FALSE, '`avaluo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// path_drive
		$this->path_drive = new cField('viewdocumentosupervisor', 'viewdocumentosupervisor', 'x_path_drive', 'path_drive', '`path_drive`', '`path_drive`', 200, -1, FALSE, '`path_drive`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->path_drive->Sortable = FALSE; // Allow sort
		$this->fields['path_drive'] = &$this->path_drive;

		// id_tipodocumento
		$this->id_tipodocumento = new cField('viewdocumentosupervisor', 'viewdocumentosupervisor', 'x_id_tipodocumento', 'id_tipodocumento', '`id_tipodocumento`', '`id_tipodocumento`', 3, -1, FALSE, '`id_tipodocumento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// created_at
		$this->created_at = new cField('viewdocumentosupervisor', 'viewdocumentosupervisor', 'x_created_at', 'created_at', '`created_at`', ew_CastDateFieldForLike('`created_at`', 0, "DB"), 135, 0, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "viewavaluosupervisor") {
			if ($this->avaluo->getSessionValue() <> "")
				$sMasterFilter .= "`id`=" . ew_QuotedValue($this->avaluo->getSessionValue(), EW_DATATYPE_NUMBER, "DB");
			else
				return "";
		}
	...
	function GetDetailFilter() {
		...
		if ($this->getCurrentMasterTable() == "viewavaluosupervisor") {
			if ($this->avaluo->getSessionValue() <> "")
				$sDetailFilter .= "`avaluo`=" . ew_QuotedValue($this->avaluo->getSessionValue(), EW_DATATYPE_NUMBER, "DB");
			else
				return "";
		}
	...
	// Master filter
	function SqlMasterFilter_viewavaluosupervisor() {
		return "`id`=@id@";
	}

	// Detail filter
	function SqlDetailFilter_viewavaluosupervisor() {
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`viewdocumentosupervisor`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "viewdocumentosupervisorlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "viewdocumentosupervisoredit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "viewdocumentosupervisoradd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("viewdocumentosupervisorview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("viewdocumentosupervisorview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "viewdocumentosupervisoradd.php?" . $this->UrlParm($parm);
		else
			$url = "viewdocumentosupervisoradd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("viewdocumentosupervisoredit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("viewdocumentosupervisoradd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("viewdocumentosupervisordelete.php", $this->UrlParm());
	}

	// Add master url
	function AddMasterUrl($url) {
		if ($this->getCurrentMasterTable() == "viewavaluosupervisor" && strpos($url, EW_TABLE_SHOW_MASTER . "=") === FALSE) {
