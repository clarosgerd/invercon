...
$viewavaluosupervisorhistorial_update = NULL; // Initialize page object first

class cviewavaluosupervisorhistorial_update extends cviewavaluosupervisorhistorial {
	...
	// Page object name
	var $PageObjName = 'viewavaluosupervisorhistorial_update';
	...
	function Page_Main() {
		...
		if (count($this->RecKeys) <= 0)
			$this->Page_Terminate("viewavaluosupervisorhistoriallist.php"); // No records selected, return to list
	...
	function UpdateRows() {
		...
		if ($UpdateRows) {
			...
			$sTable = 'viewavaluosupervisorhistorial';
...
// Create page object
if (!isset($viewavaluosupervisorhistorial_update)) $viewavaluosupervisorhistorial_update = new cviewavaluosupervisorhistorial_update();

// Page init
$viewavaluosupervisorhistorial_update->Page_Init();

// Page main
$viewavaluosupervisorhistorial_update->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$viewavaluosupervisorhistorial_update->Page_Render();
?>
...
var CurrentForm = fviewavaluosupervisorhistorialupdate = new ew_Form("fviewavaluosupervisorhistorialupdate", "update");

// Validate form
fviewavaluosupervisorhistorialupdate.Validate = function() {
...
fviewavaluosupervisorhistorialupdate.Form_CustomValidate = 
...
fviewavaluosupervisorhistorialupdate.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fviewavaluosupervisorhistorialupdate.Lists["x_estadointerno"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estadointerno"};
fviewavaluosupervisorhistorialupdate.Lists["x_estadointerno"].Data = "<?php echo $viewavaluosupervisorhistorial_update->estadointerno->LookupFilterQuery(FALSE, "update") ?>";
...
<?php $viewavaluosupervisorhistorial_update->ShowPageHeader(); ?>
<?php
$viewavaluosupervisorhistorial_update->ShowMessage();
?>
<form name="fviewavaluosupervisorhistorialupdate" id="fviewavaluosupervisorhistorialupdate" class="<?php echo $viewavaluosupervisorhistorial_update->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($viewavaluosupervisorhistorial_update->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $viewavaluosupervisorhistorial_update->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="viewavaluosupervisorhistorial">
<input type="hidden" name="a_update" id="a_update" value="U">
<input type="hidden" name="modal" value="<?php echo intval($viewavaluosupervisorhistorial_update->IsModal) ?>">
<?php foreach ($viewavaluosupervisorhistorial_update->RecKeys as $key) { ?>
<?php $keyvalue = is_array($key) ? implode($EW_COMPOSITE_KEY_SEPARATOR, $key) : $key; ?>
<input type="hidden" name="key_m[]" value="<?php echo ew_HtmlEncode($keyvalue) ?>">
<?php } ?>
<?php if (!$viewavaluosupervisorhistorial_update->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($viewavaluosupervisorhistorial_update->IsMobileOrModal) { ?>
<div id="tbl_viewavaluosupervisorhistorialupdate" class="ewUpdateDiv"><!-- page -->
	<div class="checkbox">
		<label><input type="checkbox" name="u" id="u" onclick="ew_SelectAll(this);"> <?php echo $Language->Phrase("UpdateSelectAll") ?></label>
	</div>
<?php } else { ?>
<table id="tbl_viewavaluosupervisorhistorialupdate" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- desktop table -->
	<thead>
	<tr>
...
<?php if ($viewavaluosupervisorhistorial_update->IsMobileOrModal) { ?>
	<div id="r_estadointerno" class="form-group">
		<label for="x_estadointerno" class="<?php echo $viewavaluosupervisorhistorial_update->LeftColumnClass ?>"><div class="checkbox"><label>
<input type="checkbox" name="u_estadointerno" id="u_estadointerno" class="ewMultiSelect" value="1"<?php echo ($viewavaluosupervisorhistorial->estadointerno->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewavaluosupervisorhistorial->estadointerno->FldCaption() ?></label></div></label>
		<div class="<?php echo $viewavaluosupervisorhistorial_update->RightColumnClass ?>"><div<?php echo $viewavaluosupervisorhistorial->estadointerno->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_estadointerno">
		<td class="col-sm-3"<?php echo $viewavaluosupervisorhistorial->estadointerno->CellAttributes() ?>><span id="elh_viewavaluosupervisorhistorial_estadointerno"><div class="checkbox"><label for="u_estadointerno">
<input type="checkbox" name="u_estadointerno" id="u_estadointerno" class="ewMultiSelect" value="1"<?php echo ($viewavaluosupervisorhistorial->estadointerno->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewavaluosupervisorhistorial->estadointerno->FldCaption() ?></label></div></span></td>
...
<?php if ($viewavaluosupervisorhistorial_update->IsMobileOrModal) { ?>
	<div id="r_montoincial" class="form-group">
		<label for="x_montoincial" class="<?php echo $viewavaluosupervisorhistorial_update->LeftColumnClass ?>"><div class="checkbox"><label>
<input type="checkbox" name="u_montoincial" id="u_montoincial" class="ewMultiSelect" value="1"<?php echo ($viewavaluosupervisorhistorial->montoincial->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewavaluosupervisorhistorial->montoincial->FldCaption() ?></label></div></label>
		<div class="<?php echo $viewavaluosupervisorhistorial_update->RightColumnClass ?>"><div<?php echo $viewavaluosupervisorhistorial->montoincial->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_montoincial">
		<td class="col-sm-3"<?php echo $viewavaluosupervisorhistorial->montoincial->CellAttributes() ?>><span id="elh_viewavaluosupervisorhistorial_montoincial"><div class="checkbox"><label for="u_montoincial">
<input type="checkbox" name="u_montoincial" id="u_montoincial" class="ewMultiSelect" value="1"<?php echo ($viewavaluosupervisorhistorial->montoincial->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewavaluosupervisorhistorial->montoincial->FldCaption() ?></label></div></span></td>
...
<?php if ($viewavaluosupervisorhistorial_update->IsMobileOrModal) { ?>
	<div id="r_informe" class="form-group">
		<label class="<?php echo $viewavaluosupervisorhistorial_update->LeftColumnClass ?>"><div class="checkbox"><label>
<input type="checkbox" name="u_informe" id="u_informe" class="ewMultiSelect" value="1"<?php echo ($viewavaluosupervisorhistorial->informe->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewavaluosupervisorhistorial->informe->FldCaption() ?></label></div></label>
		<div class="<?php echo $viewavaluosupervisorhistorial_update->RightColumnClass ?>"><div<?php echo $viewavaluosupervisorhistorial->informe->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_informe">
		<td class="col-sm-3"<?php echo $viewavaluosupervisorhistorial->informe->CellAttributes() ?>><span id="elh_viewavaluosupervisorhistorial_informe"><div class="checkbox"><label for="u_informe">
<input type="checkbox" name="u_informe" id="u_informe" class="ewMultiSelect" value="1"<?php echo ($viewavaluosupervisorhistorial->informe->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewavaluosupervisorhistorial->informe->FldCaption() ?></label></div></span></td>
...
<?php if ($viewavaluosupervisorhistorial_update->IsMobileOrModal) { ?>
	<div id="r_monto_pago" class="form-group">
		<label for="x_monto_pago" class="<?php echo $viewavaluosupervisorhistorial_update->LeftColumnClass ?>"><div class="checkbox"><label>
<input type="checkbox" name="u_monto_pago" id="u_monto_pago" class="ewMultiSelect" value="1"<?php echo ($viewavaluosupervisorhistorial->monto_pago->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewavaluosupervisorhistorial->monto_pago->FldCaption() ?></label></div></label>
		<div class="<?php echo $viewavaluosupervisorhistorial_update->RightColumnClass ?>"><div<?php echo $viewavaluosupervisorhistorial->monto_pago->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_monto_pago">
		<td class="col-sm-3"<?php echo $viewavaluosupervisorhistorial->monto_pago->CellAttributes() ?>><span id="elh_viewavaluosupervisorhistorial_monto_pago"><div class="checkbox"><label for="u_monto_pago">
<input type="checkbox" name="u_monto_pago" id="u_monto_pago" class="ewMultiSelect" value="1"<?php echo ($viewavaluosupervisorhistorial->monto_pago->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewavaluosupervisorhistorial->monto_pago->FldCaption() ?></label></div></span></td>
...
<?php if ($viewavaluosupervisorhistorial_update->IsMobileOrModal) { ?>
	<div id="r_comentario" class="form-group">
		<label for="x_comentario" class="<?php echo $viewavaluosupervisorhistorial_update->LeftColumnClass ?>"><div class="checkbox"><label>
<input type="checkbox" name="u_comentario" id="u_comentario" class="ewMultiSelect" value="1"<?php echo ($viewavaluosupervisorhistorial->comentario->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewavaluosupervisorhistorial->comentario->FldCaption() ?></label></div></label>
		<div class="<?php echo $viewavaluosupervisorhistorial_update->RightColumnClass ?>"><div<?php echo $viewavaluosupervisorhistorial->comentario->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_comentario">
		<td class="col-sm-3"<?php echo $viewavaluosupervisorhistorial->comentario->CellAttributes() ?>><span id="elh_viewavaluosupervisorhistorial_comentario"><div class="checkbox"><label for="u_comentario">
<input type="checkbox" name="u_comentario" id="u_comentario" class="ewMultiSelect" value="1"<?php echo ($viewavaluosupervisorhistorial->comentario->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewavaluosupervisorhistorial->comentario->FldCaption() ?></label></div></span></td>
...
<?php } ?>
<?php if (!$viewavaluosupervisorhistorial_update->IsModal) { ?>
	<div class="form-group"><!-- buttons .form-group -->
		<div class="<?php echo $viewavaluosupervisorhistorial_update->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("UpdateBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $viewavaluosupervisorhistorial_update->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
		</div><!-- /buttons offset -->
...
<script type="text/javascript">
fviewavaluosupervisorhistorialupdate.Init();
</script>
<?php
$viewavaluosupervisorhistorial_update->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$viewavaluosupervisorhistorial_update->Page_Terminate();
?>
