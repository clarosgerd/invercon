...
$viewdocumentosavaluosc_grid = NULL; // Initialize page object first

class cviewdocumentosavaluosc_grid extends cviewdocumentosavaluosc {
	...
	// Page object name
	var $PageObjName = 'viewdocumentosavaluosc_grid';

	// Grid form hidden field names
	var $FormName = 'fviewdocumentosavaluoscgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["viewdocumentosavaluosc"];
