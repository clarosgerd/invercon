...
$viewsolicitudframe_imagen_tipoespecial01_blobview = NULL; // Initialize page object first

class cviewsolicitudframe_imagen_tipoespecial01_blobview extends cviewsolicitudframe {
	...
	// Page object name
	var $PageObjName = 'viewsolicitudframe_imagen_tipoespecial01_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'viewsolicitudframe');
	...
	function Page_Main() {
		...
		// SQL constructor in viewsolicitudframe class, viewsolicitudframeinfo.php
...
// Create page object
if (!isset($viewsolicitudframe_imagen_tipoespecial01_blobview)) $viewsolicitudframe_imagen_tipoespecial01_blobview = new cviewsolicitudframe_imagen_tipoespecial01_blobview();

// Page init
$viewsolicitudframe_imagen_tipoespecial01_blobview->Page_Init();

// Page main
$viewsolicitudframe_imagen_tipoespecial01_blobview->Page_Main();
?>
<?php
$viewsolicitudframe_imagen_tipoespecial01_blobview->Page_Terminate();
?>
