...
class cestadointerno extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'estadointerno';
		$this->TableName = 'estadointerno';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`estadointerno`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('estadointerno', 'estadointerno', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`estadointerno`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "estadointernoedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "estadointernoadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("estadointernoview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("estadointernoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "estadointernoadd.php?" . $this->UrlParm($parm);
		else
			$url = "estadointernoadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("estadointernoedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("estadointernoadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("estadointernodelete.php", $this->UrlParm());
	}
