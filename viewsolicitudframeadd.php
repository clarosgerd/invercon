...
$viewsolicitudframe_add = NULL; // Initialize page object first

class cviewsolicitudframe_add extends cviewsolicitudframe {
	...
	// Page object name
	var $PageObjName = 'viewsolicitudframe_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "viewsolicitudframeview.php")
...
// Create page object
if (!isset($viewsolicitudframe_add)) $viewsolicitudframe_add = new cviewsolicitudframe_add();

// Page init
$viewsolicitudframe_add->Page_Init();

// Page main
$viewsolicitudframe_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$viewsolicitudframe_add->Page_Render();
?>
...
var CurrentForm = fviewsolicitudframeadd = new ew_Form("fviewsolicitudframeadd", "add");

// Validate form
fviewsolicitudframeadd.Validate = function() {
...
fviewsolicitudframeadd.Form_CustomValidate = 
...
fviewsolicitudframeadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fviewsolicitudframeadd.Lists["x_tipoinmueble[]"] = {"LinkField":"x_nombre","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipoinmueble"};
fviewsolicitudframeadd.Lists["x_tipoinmueble[]"].Data = "<?php echo $viewsolicitudframe_add->tipoinmueble->LookupFilterQuery(FALSE, "add") ?>";
fviewsolicitudframeadd.Lists["x_id_ciudad_inmueble"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"departamento"};
fviewsolicitudframeadd.Lists["x_id_ciudad_inmueble"].Data = "<?php echo $viewsolicitudframe_add->id_ciudad_inmueble->LookupFilterQuery(FALSE, "add") ?>";
fviewsolicitudframeadd.Lists["x_tipovehiculo[]"] = {"LinkField":"x_nombre","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipoinmueble"};
fviewsolicitudframeadd.Lists["x_tipovehiculo[]"].Data = "<?php echo $viewsolicitudframe_add->tipovehiculo->LookupFilterQuery(FALSE, "add") ?>";
fviewsolicitudframeadd.Lists["x_id_ciudad_vehiculo"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"departamento"};
fviewsolicitudframeadd.Lists["x_id_ciudad_vehiculo"].Data = "<?php echo $viewsolicitudframe_add->id_ciudad_vehiculo->LookupFilterQuery(FALSE, "add") ?>";
fviewsolicitudframeadd.Lists["x_id_provincia_vehiculo"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"provincia"};
fviewsolicitudframeadd.Lists["x_id_provincia_vehiculo"].Data = "<?php echo $viewsolicitudframe_add->id_provincia_vehiculo->LookupFilterQuery(FALSE, "add") ?>";
fviewsolicitudframeadd.Lists["x_tipomaquinaria[]"] = {"LinkField":"x_nombre","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipoinmueble"};
fviewsolicitudframeadd.Lists["x_tipomaquinaria[]"].Data = "<?php echo $viewsolicitudframe_add->tipomaquinaria->LookupFilterQuery(FALSE, "add") ?>";
fviewsolicitudframeadd.Lists["x_id_ciudad_maquinaria"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"departamento"};
fviewsolicitudframeadd.Lists["x_id_ciudad_maquinaria"].Data = "<?php echo $viewsolicitudframe_add->id_ciudad_maquinaria->LookupFilterQuery(FALSE, "add") ?>";
fviewsolicitudframeadd.Lists["x_id_provincia_maquinaria"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"provincia"};
fviewsolicitudframeadd.Lists["x_id_provincia_maquinaria"].Data = "<?php echo $viewsolicitudframe_add->id_provincia_maquinaria->LookupFilterQuery(FALSE, "add") ?>";
fviewsolicitudframeadd.Lists["x_tipomercaderia[]"] = {"LinkField":"x_id_tipoinmueble","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipoinmueble"};
fviewsolicitudframeadd.Lists["x_tipomercaderia[]"].Data = "<?php echo $viewsolicitudframe_add->tipomercaderia->LookupFilterQuery(FALSE, "add") ?>";
fviewsolicitudframeadd.Lists["x_tipoespecial"] = {"LinkField":"x_id_tipoinmueble","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipoinmueble"};
fviewsolicitudframeadd.Lists["x_tipoespecial"].Data = "<?php echo $viewsolicitudframe_add->tipoespecial->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $viewsolicitudframe_add->ShowPageHeader(); ?>
<?php
$viewsolicitudframe_add->ShowMessage();
?>
<form name="fviewsolicitudframeadd" id="fviewsolicitudframeadd" class="<?php echo $viewsolicitudframe_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($viewsolicitudframe_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $viewsolicitudframe_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="viewsolicitudframe">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($viewsolicitudframe_add->IsModal) ?>">
<?php if (!$viewsolicitudframe_add->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($viewsolicitudframe_add->IsMobileOrModal) { ?>
<div class="ewAddDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_viewsolicitudframeadd" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($viewsolicitudframe->name->Visible) { // name ?>
<?php if ($viewsolicitudframe_add->IsMobileOrModal) { ?>
	<div id="r_name" class="form-group">
		<label id="elh_viewsolicitudframe_name" for="x_name" class="<?php echo $viewsolicitudframe_add->LeftColumnClass ?>"><?php echo $viewsolicitudframe->name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $viewsolicitudframe_add->RightColumnClass ?>"><div<?php echo $viewsolicitudframe->name->CellAttributes() ?>>
<span id="el_viewsolicitudframe_name">
<input type="text" data-table="viewsolicitudframe" data-field="x_name" data-page="1" name="x_name" id="x_name" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($viewsolicitudframe->name->getPlaceHolder()) ?>" value="<?php echo $viewsolicitudframe->name->EditValue ?>"<?php echo $viewsolicitudframe->name->EditAttributes() ?>>
</span>
...
<?php if ($viewsolicitudframe_add->IsMobileOrModal) { ?>
	<div id="r_lastname" class="form-group">
		<label id="elh_viewsolicitudframe_lastname" for="x_lastname" class="<?php echo $viewsolicitudframe_add->LeftColumnClass ?>"><?php echo $viewsolicitudframe->lastname->FldCaption() ?></label>
		<div class="<?php echo $viewsolicitudframe_add->RightColumnClass ?>"><div<?php echo $viewsolicitudframe->lastname->CellAttributes() ?>>
<span id="el_viewsolicitudframe_lastname">
<input type="text" data-table="viewsolicitudframe" data-field="x_lastname" data-page="1" name="x_lastname" id="x_lastname" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($viewsolicitudframe->lastname->getPlaceHolder()) ?>" value="<?php echo $viewsolicitudframe->lastname->EditValue ?>"<?php echo $viewsolicitudframe->lastname->EditAttributes() ?>>
</span>
...
<?php if ($viewsolicitudframe_add->IsMobileOrModal) { ?>
	<div id="r__email" class="form-group">
		<label id="elh_viewsolicitudframe__email" for="x__email" class="<?php echo $viewsolicitudframe_add->LeftColumnClass ?>"><?php echo $viewsolicitudframe->_email->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $viewsolicitudframe_add->RightColumnClass ?>"><div<?php echo $viewsolicitudframe->_email->CellAttributes() ?>>
<span id="el_viewsolicitudframe__email">
<input type="text" data-table="viewsolicitudframe" data-field="x__email" data-page="1" name="x__email" id="x__email" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($viewsolicitudframe->_email->getPlaceHolder()) ?>" value="<?php echo $viewsolicitudframe->_email->EditValue ?>"<?php echo $viewsolicitudframe->_email->EditAttributes() ?>>
</span>
...
<?php if ($viewsolicitudframe_add->IsMobileOrModal) { ?>
	<div id="r_address" class="form-group">
		<label id="elh_viewsolicitudframe_address" for="x_address" class="<?php echo $viewsolicitudframe_add->LeftColumnClass ?>"><?php echo $viewsolicitudframe->address->FldCaption() ?></label>
		<div class="<?php echo $viewsolicitudframe_add->RightColumnClass ?>"><div<?php echo $viewsolicitudframe->address->CellAttributes() ?>>
<span id="el_viewsolicitudframe_address">
<input type="text" data-table="viewsolicitudframe" data-field="x_address" data-page="1" name="x_address" id="x_address" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($viewsolicitudframe->address->getPlaceHolder()) ?>" value="<?php echo $viewsolicitudframe->address->EditValue ?>"<?php echo $viewsolicitudframe->address->EditAttributes() ?>>
</span>
...
<?php if ($viewsolicitudframe_add->IsMobileOrModal) { ?>
	<div id="r_nombre_contacto" class="form-group">
		<label id="elh_viewsolicitudframe_nombre_contacto" for="x_nombre_contacto" class="<?php echo $viewsolicitudframe_add->LeftColumnClass ?>"><?php echo $viewsolicitudframe->nombre_contacto->FldCaption() ?></label>
		<div class="<?php echo $viewsolicitudframe_add->RightColumnClass ?>"><div<?php echo $viewsolicitudframe->nombre_contacto->CellAttributes() ?>>
<span id="el_viewsolicitudframe_nombre_contacto">
<input type="text" data-table="viewsolicitudframe" data-field="x_nombre_contacto" data-page="1" name="x_nombre_contacto" id="x_nombre_contacto" size="30" maxlength="200" placeholder="<?php echo ew_HtmlEncode($viewsolicitudframe->nombre_contacto->getPlaceHolder()) ?>" value="<?php echo $viewsolicitudframe->nombre_contacto->EditValue ?>"<?php echo $viewsolicitudframe->nombre_contacto->EditAttributes() ?>>
</span>
...
<input type="hidden" data-table="viewsolicitudframe" data-field="x_email_contacto" data-page="1" name="x_email_contacto" id="x_email_contacto" value="<?php echo ew_HtmlEncode($viewsolicitudframe->email_contacto->CurrentValue) ?>">
</span>
<?php if ($viewsolicitudframe->phone->Visible) { // phone ?>
<?php if ($viewsolicitudframe_add->IsMobileOrModal) { ?>
	<div id="r_phone" class="form-group">
		<label id="elh_viewsolicitudframe_phone" for="x_phone" class="<?php echo $viewsolicitudframe_add->LeftColumnClass ?>"><?php echo $viewsolicitudframe->phone->FldCaption() ?></label>
		<div class="<?php echo $viewsolicitudframe_add->RightColumnClass ?>"><div<?php echo $viewsolicitudframe->phone->CellAttributes() ?>>
<span id="el_viewsolicitudframe_phone">
<input type="text" data-table="viewsolicitudframe" data-field="x_phone" data-page="1" name="x_phone" id="x_phone" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($viewsolicitudframe->phone->getPlaceHolder()) ?>" value="<?php echo $viewsolicitudframe->phone->EditValue ?>"<?php echo $viewsolicitudframe->phone->EditAttributes() ?>>
</span>
...
<?php if ($viewsolicitudframe_add->IsMobileOrModal) { ?>
	<div id="r_cell" class="form-group">
		<label id="elh_viewsolicitudframe_cell" for="x_cell" class="<?php echo $viewsolicitudframe_add->LeftColumnClass ?>"><?php echo $viewsolicitudframe->cell->FldCaption() ?></label>
		<div class="<?php echo $viewsolicitudframe_add->RightColumnClass ?>"><div<?php echo $viewsolicitudframe->cell->CellAttributes() ?>>
<span id="el_viewsolicitudframe_cell">
<input type="text" data-table="viewsolicitudframe" data-field="x_cell" data-page="1" name="x_cell" id="x_cell" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($viewsolicitudframe->cell->getPlaceHolder()) ?>" value="<?php echo $viewsolicitudframe->cell->EditValue ?>"<?php echo $viewsolicitudframe->cell->EditAttributes() ?>>
</span>
...
<input type="hidden" data-table="viewsolicitudframe" data-field="x_id_sucursal" data-page="1" name="x_id_sucursal" id="x_id_sucursal" value="<?php echo ew_HtmlEncode($viewsolicitudframe->id_sucursal->CurrentValue) ?>">
</span>
<?php if ($viewsolicitudframe->tipoinmueble->Visible) { // tipoinmueble ?>
<?php if ($viewsolicitudframe_add->IsMobileOrModal) { ?>
	<div id="r_tipoinmueble" class="form-group">
		<label id="elh_viewsolicitudframe_tipoinmueble" for="x_tipoinmueble" class="<?php echo $viewsolicitudframe_add->LeftColumnClass ?>"><?php echo $viewsolicitudframe->tipoinmueble->FldCaption() ?></label>
		<div class="<?php echo $viewsolicitudframe_add->RightColumnClass ?>"><div<?php echo $viewsolicitudframe->tipoinmueble->CellAttributes() ?>>
<span id="el_viewsolicitudframe_tipoinmueble">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_tipoinmueble"><?php echo (strval($viewsolicitudframe->tipoinmueble->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $viewsolicitudframe->tipoinmueble->ViewValue); ?></span>
</span>
<button type="button" title="<?php echo ew_HtmlEncode(str_replace("%s", ew_RemoveHtml($viewsolicitudframe->tipoinmueble->FldCaption()), $Language->Phrase("LookupLink", TRUE))) ?>" onclick="ew_ModalLookupShow({lnk:this,el:'x_tipoinmueble[]',m:1,n:10});" class="ewLookupBtn btn btn-default btn-sm"<?php echo (($viewsolicitudframe->tipoinmueble->ReadOnly || $viewsolicitudframe->tipoinmueble->Disabled) ? " disabled" : "")?>><span class="glyphicon glyphicon-search ewIcon"></span></button>
<input type="hidden" data-table="viewsolicitudframe" data-field="x_tipoinmueble" data-page="1" data-multiple="1" data-lookup="1" data-value-separator="<?php echo $viewsolicitudframe->tipoinmueble->DisplayValueSeparatorAttribute() ?>" name="x_tipoinmueble[]" id="x_tipoinmueble[]" value="<?php echo $viewsolicitudframe->tipoinmueble->CurrentValue ?>"<?php echo $viewsolicitudframe->tipoinmueble->EditAttributes() ?>>
</span>
<?php echo $viewsolicitudframe->tipoinmueble->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_tipoinmueble">
		<td class="col-sm-3"><span id="elh_viewsolicitudframe_tipoinmueble"><?php echo $viewsolicitudframe->tipoinmueble->FldCaption() ?></span></td>
		<td<?php echo $viewsolicitudframe->tipoinmueble->CellAttributes() ?>>
<span id="el_viewsolicitudframe_tipoinmueble">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_tipoinmueble"><?php echo (strval($viewsolicitudframe->tipoinmueble->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $viewsolicitudframe->tipoinmueble->ViewValue); ?></span>
</span>
...
<?php echo $viewsolicitudframe->tipoinmueble->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
<?php if ($viewsolicitudframe->id_ciudad_inmueble->Visible) { // id_ciudad_inmueble ?>
<?php if ($viewsolicitudframe_add->IsMobileOrModal) { ?>
	<div id="r_id_ciudad_inmueble" class="form-group">
		<label id="elh_viewsolicitudframe_id_ciudad_inmueble" for="x_id_ciudad_inmueble" class="<?php echo $viewsolicitudframe_add->LeftColumnClass ?>"><?php echo $viewsolicitudframe->id_ciudad_inmueble->FldCaption() ?></label>
		<div class="<?php echo $viewsolicitudframe_add->RightColumnClass ?>"><div<?php echo $viewsolicitudframe->id_ciudad_inmueble->CellAttributes() ?>>
<span id="el_viewsolicitudframe_id_ciudad_inmueble">
<select data-table="viewsolicitudframe" data-field="x_id_ciudad_inmueble" data-page="1" data-value-separator="<?php echo $viewsolicitudframe->id_ciudad_inmueble->DisplayValueSeparatorAttribute() ?>" id="x_id_ciudad_inmueble" name="x_id_ciudad_inmueble"<?php echo $viewsolicitudframe->id_ciudad_inmueble->EditAttributes() ?>>
<?php echo $viewsolicitudframe->id_ciudad_inmueble->SelectOptionListHtml("x_id_ciudad_inmueble") ?>
</select>
</span>
<?php echo $viewsolicitudframe->id_ciudad_inmueble->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_id_ciudad_inmueble">
		<td class="col-sm-3"><span id="elh_viewsolicitudframe_id_ciudad_inmueble"><?php echo $viewsolicitudframe->id_ciudad_inmueble->FldCaption() ?></span></td>
		<td<?php echo $viewsolicitudframe->id_ciudad_inmueble->CellAttributes() ?>>
<span id="el_viewsolicitudframe_id_ciudad_inmueble">
<select data-table="viewsolicitudframe" data-field="x_id_ciudad_inmueble" data-page="1" data-value-separator="<?php echo $viewsolicitudframe->id_ciudad_inmueble->DisplayValueSeparatorAttribute() ?>" id="x_id_ciudad_inmueble" name="x_id_ciudad_inmueble"<?php echo $viewsolicitudframe->id_ciudad_inmueble->EditAttributes() ?>>
<?php echo $viewsolicitudframe->id_ciudad_inmueble->SelectOptionListHtml("x_id_ciudad_inmueble") ?>
</select>
</span>
<?php echo $viewsolicitudframe->id_ciudad_inmueble->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
<?php if ($viewsolicitudframe->tipovehiculo->Visible) { // tipovehiculo ?>
<?php if ($viewsolicitudframe_add->IsMobileOrModal) { ?>
	<div id="r_tipovehiculo" class="form-group">
		<label id="elh_viewsolicitudframe_tipovehiculo" for="x_tipovehiculo" class="<?php echo $viewsolicitudframe_add->LeftColumnClass ?>"><?php echo $viewsolicitudframe->tipovehiculo->FldCaption() ?></label>
		<div class="<?php echo $viewsolicitudframe_add->RightColumnClass ?>"><div<?php echo $viewsolicitudframe->tipovehiculo->CellAttributes() ?>>
<span id="el_viewsolicitudframe_tipovehiculo">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_tipovehiculo"><?php echo (strval($viewsolicitudframe->tipovehiculo->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $viewsolicitudframe->tipovehiculo->ViewValue); ?></span>
</span>
<button type="button" title="<?php echo ew_HtmlEncode(str_replace("%s", ew_RemoveHtml($viewsolicitudframe->tipovehiculo->FldCaption()), $Language->Phrase("LookupLink", TRUE))) ?>" onclick="ew_ModalLookupShow({lnk:this,el:'x_tipovehiculo[]',m:1,n:10});" class="ewLookupBtn btn btn-default btn-sm"<?php echo (($viewsolicitudframe->tipovehiculo->ReadOnly || $viewsolicitudframe->tipovehiculo->Disabled) ? " disabled" : "")?>><span class="glyphicon glyphicon-search ewIcon"></span></button>
<input type="hidden" data-table="viewsolicitudframe" data-field="x_tipovehiculo" data-page="1" data-multiple="1" data-lookup="1" data-value-separator="<?php echo $viewsolicitudframe->tipovehiculo->DisplayValueSeparatorAttribute() ?>" name="x_tipovehiculo[]" id="x_tipovehiculo[]" value="<?php echo $viewsolicitudframe->tipovehiculo->CurrentValue ?>"<?php echo $viewsolicitudframe->tipovehiculo->EditAttributes() ?>>
</span>
<?php echo $viewsolicitudframe->tipovehiculo->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_tipovehiculo">
		<td class="col-sm-3"><span id="elh_viewsolicitudframe_tipovehiculo"><?php echo $viewsolicitudframe->tipovehiculo->FldCaption() ?></span></td>
		<td<?php echo $viewsolicitudframe->tipovehiculo->CellAttributes() ?>>
<span id="el_viewsolicitudframe_tipovehiculo">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_tipovehiculo"><?php echo (strval($viewsolicitudframe->tipovehiculo->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $viewsolicitudframe->tipovehiculo->ViewValue); ?></span>
</span>
...
<?php echo $viewsolicitudframe->tipovehiculo->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
<?php if ($viewsolicitudframe->id_ciudad_vehiculo->Visible) { // id_ciudad_vehiculo ?>
<?php if ($viewsolicitudframe_add->IsMobileOrModal) { ?>
	<div id="r_id_ciudad_vehiculo" class="form-group">
		<label id="elh_viewsolicitudframe_id_ciudad_vehiculo" for="x_id_ciudad_vehiculo" class="<?php echo $viewsolicitudframe_add->LeftColumnClass ?>"><?php echo $viewsolicitudframe->id_ciudad_vehiculo->FldCaption() ?></label>
		<div class="<?php echo $viewsolicitudframe_add->RightColumnClass ?>"><div<?php echo $viewsolicitudframe->id_ciudad_vehiculo->CellAttributes() ?>>
<span id="el_viewsolicitudframe_id_ciudad_vehiculo">
<select data-table="viewsolicitudframe" data-field="x_id_ciudad_vehiculo" data-page="1" data-value-separator="<?php echo $viewsolicitudframe->id_ciudad_vehiculo->DisplayValueSeparatorAttribute() ?>" id="x_id_ciudad_vehiculo" name="x_id_ciudad_vehiculo"<?php echo $viewsolicitudframe->id_ciudad_vehiculo->EditAttributes() ?>>
<?php echo $viewsolicitudframe->id_ciudad_vehiculo->SelectOptionListHtml("x_id_ciudad_vehiculo") ?>
</select>
</span>
<?php echo $viewsolicitudframe->id_ciudad_vehiculo->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_id_ciudad_vehiculo">
		<td class="col-sm-3"><span id="elh_viewsolicitudframe_id_ciudad_vehiculo"><?php echo $viewsolicitudframe->id_ciudad_vehiculo->FldCaption() ?></span></td>
		<td<?php echo $viewsolicitudframe->id_ciudad_vehiculo->CellAttributes() ?>>
<span id="el_viewsolicitudframe_id_ciudad_vehiculo">
<select data-table="viewsolicitudframe" data-field="x_id_ciudad_vehiculo" data-page="1" data-value-separator="<?php echo $viewsolicitudframe->id_ciudad_vehiculo->DisplayValueSeparatorAttribute() ?>" id="x_id_ciudad_vehiculo" name="x_id_ciudad_vehiculo"<?php echo $viewsolicitudframe->id_ciudad_vehiculo->EditAttributes() ?>>
<?php echo $viewsolicitudframe->id_ciudad_vehiculo->SelectOptionListHtml("x_id_ciudad_vehiculo") ?>
</select>
</span>
<?php echo $viewsolicitudframe->id_ciudad_vehiculo->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
<?php if ($viewsolicitudframe->id_provincia_vehiculo->Visible) { // id_provincia_vehiculo ?>
<?php if ($viewsolicitudframe_add->IsMobileOrModal) { ?>
	<div id="r_id_provincia_vehiculo" class="form-group">
		<label id="elh_viewsolicitudframe_id_provincia_vehiculo" for="x_id_provincia_vehiculo" class="<?php echo $viewsolicitudframe_add->LeftColumnClass ?>"><?php echo $viewsolicitudframe->id_provincia_vehiculo->FldCaption() ?></label>
		<div class="<?php echo $viewsolicitudframe_add->RightColumnClass ?>"><div<?php echo $viewsolicitudframe->id_provincia_vehiculo->CellAttributes() ?>>
<span id="el_viewsolicitudframe_id_provincia_vehiculo">
<select data-table="viewsolicitudframe" data-field="x_id_provincia_vehiculo" data-page="1" data-value-separator="<?php echo $viewsolicitudframe->id_provincia_vehiculo->DisplayValueSeparatorAttribute() ?>" id="x_id_provincia_vehiculo" name="x_id_provincia_vehiculo"<?php echo $viewsolicitudframe->id_provincia_vehiculo->EditAttributes() ?>>
<?php echo $viewsolicitudframe->id_provincia_vehiculo->SelectOptionListHtml("x_id_provincia_vehiculo") ?>
</select>
</span>
<?php echo $viewsolicitudframe->id_provincia_vehiculo->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_id_provincia_vehiculo">
		<td class="col-sm-3"><span id="elh_viewsolicitudframe_id_provincia_vehiculo"><?php echo $viewsolicitudframe->id_provincia_vehiculo->FldCaption() ?></span></td>
		<td<?php echo $viewsolicitudframe->id_provincia_vehiculo->CellAttributes() ?>>
<span id="el_viewsolicitudframe_id_provincia_vehiculo">
<select data-table="viewsolicitudframe" data-field="x_id_provincia_vehiculo" data-page="1" data-value-separator="<?php echo $viewsolicitudframe->id_provincia_vehiculo->DisplayValueSeparatorAttribute() ?>" id="x_id_provincia_vehiculo" name="x_id_provincia_vehiculo"<?php echo $viewsolicitudframe->id_provincia_vehiculo->EditAttributes() ?>>
<?php echo $viewsolicitudframe->id_provincia_vehiculo->SelectOptionListHtml("x_id_provincia_vehiculo") ?>
</select>
</span>
<?php echo $viewsolicitudframe->id_provincia_vehiculo->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
<?php if ($viewsolicitudframe->tipomaquinaria->Visible) { // tipomaquinaria ?>
<?php if ($viewsolicitudframe_add->IsMobileOrModal) { ?>
	<div id="r_tipomaquinaria" class="form-group">
		<label id="elh_viewsolicitudframe_tipomaquinaria" for="x_tipomaquinaria" class="<?php echo $viewsolicitudframe_add->LeftColumnClass ?>"><?php echo $viewsolicitudframe->tipomaquinaria->FldCaption() ?></label>
		<div class="<?php echo $viewsolicitudframe_add->RightColumnClass ?>"><div<?php echo $viewsolicitudframe->tipomaquinaria->CellAttributes() ?>>
<span id="el_viewsolicitudframe_tipomaquinaria">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_tipomaquinaria"><?php echo (strval($viewsolicitudframe->tipomaquinaria->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $viewsolicitudframe->tipomaquinaria->ViewValue); ?></span>
</span>
<button type="button" title="<?php echo ew_HtmlEncode(str_replace("%s", ew_RemoveHtml($viewsolicitudframe->tipomaquinaria->FldCaption()), $Language->Phrase("LookupLink", TRUE))) ?>" onclick="ew_ModalLookupShow({lnk:this,el:'x_tipomaquinaria[]',m:1,n:10});" class="ewLookupBtn btn btn-default btn-sm"<?php echo (($viewsolicitudframe->tipomaquinaria->ReadOnly || $viewsolicitudframe->tipomaquinaria->Disabled) ? " disabled" : "")?>><span class="glyphicon glyphicon-search ewIcon"></span></button>
<input type="hidden" data-table="viewsolicitudframe" data-field="x_tipomaquinaria" data-page="1" data-multiple="1" data-lookup="1" data-value-separator="<?php echo $viewsolicitudframe->tipomaquinaria->DisplayValueSeparatorAttribute() ?>" name="x_tipomaquinaria[]" id="x_tipomaquinaria[]" value="<?php echo $viewsolicitudframe->tipomaquinaria->CurrentValue ?>"<?php echo $viewsolicitudframe->tipomaquinaria->EditAttributes() ?>>
</span>
<?php echo $viewsolicitudframe->tipomaquinaria->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_tipomaquinaria">
		<td class="col-sm-3"><span id="elh_viewsolicitudframe_tipomaquinaria"><?php echo $viewsolicitudframe->tipomaquinaria->FldCaption() ?></span></td>
		<td<?php echo $viewsolicitudframe->tipomaquinaria->CellAttributes() ?>>
<span id="el_viewsolicitudframe_tipomaquinaria">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_tipomaquinaria"><?php echo (strval($viewsolicitudframe->tipomaquinaria->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $viewsolicitudframe->tipomaquinaria->ViewValue); ?></span>
</span>
...
<?php echo $viewsolicitudframe->tipomaquinaria->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
<?php if ($viewsolicitudframe->id_ciudad_maquinaria->Visible) { // id_ciudad_maquinaria ?>
<?php if ($viewsolicitudframe_add->IsMobileOrModal) { ?>
	<div id="r_id_ciudad_maquinaria" class="form-group">
		<label id="elh_viewsolicitudframe_id_ciudad_maquinaria" for="x_id_ciudad_maquinaria" class="<?php echo $viewsolicitudframe_add->LeftColumnClass ?>"><?php echo $viewsolicitudframe->id_ciudad_maquinaria->FldCaption() ?></label>
		<div class="<?php echo $viewsolicitudframe_add->RightColumnClass ?>"><div<?php echo $viewsolicitudframe->id_ciudad_maquinaria->CellAttributes() ?>>
<span id="el_viewsolicitudframe_id_ciudad_maquinaria">
<select data-table="viewsolicitudframe" data-field="x_id_ciudad_maquinaria" data-page="1" data-value-separator="<?php echo $viewsolicitudframe->id_ciudad_maquinaria->DisplayValueSeparatorAttribute() ?>" id="x_id_ciudad_maquinaria" name="x_id_ciudad_maquinaria"<?php echo $viewsolicitudframe->id_ciudad_maquinaria->EditAttributes() ?>>
<?php echo $viewsolicitudframe->id_ciudad_maquinaria->SelectOptionListHtml("x_id_ciudad_maquinaria") ?>
</select>
</span>
<?php echo $viewsolicitudframe->id_ciudad_maquinaria->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_id_ciudad_maquinaria">
		<td class="col-sm-3"><span id="elh_viewsolicitudframe_id_ciudad_maquinaria"><?php echo $viewsolicitudframe->id_ciudad_maquinaria->FldCaption() ?></span></td>
		<td<?php echo $viewsolicitudframe->id_ciudad_maquinaria->CellAttributes() ?>>
<span id="el_viewsolicitudframe_id_ciudad_maquinaria">
<select data-table="viewsolicitudframe" data-field="x_id_ciudad_maquinaria" data-page="1" data-value-separator="<?php echo $viewsolicitudframe->id_ciudad_maquinaria->DisplayValueSeparatorAttribute() ?>" id="x_id_ciudad_maquinaria" name="x_id_ciudad_maquinaria"<?php echo $viewsolicitudframe->id_ciudad_maquinaria->EditAttributes() ?>>
<?php echo $viewsolicitudframe->id_ciudad_maquinaria->SelectOptionListHtml("x_id_ciudad_maquinaria") ?>
</select>
</span>
<?php echo $viewsolicitudframe->id_ciudad_maquinaria->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
<?php if ($viewsolicitudframe->id_provincia_maquinaria->Visible) { // id_provincia_maquinaria ?>
<?php if ($viewsolicitudframe_add->IsMobileOrModal) { ?>
	<div id="r_id_provincia_maquinaria" class="form-group">
		<label id="elh_viewsolicitudframe_id_provincia_maquinaria" for="x_id_provincia_maquinaria" class="<?php echo $viewsolicitudframe_add->LeftColumnClass ?>"><?php echo $viewsolicitudframe->id_provincia_maquinaria->FldCaption() ?></label>
		<div class="<?php echo $viewsolicitudframe_add->RightColumnClass ?>"><div<?php echo $viewsolicitudframe->id_provincia_maquinaria->CellAttributes() ?>>
<span id="el_viewsolicitudframe_id_provincia_maquinaria">
<select data-table="viewsolicitudframe" data-field="x_id_provincia_maquinaria" data-page="1" data-value-separator="<?php echo $viewsolicitudframe->id_provincia_maquinaria->DisplayValueSeparatorAttribute() ?>" id="x_id_provincia_maquinaria" name="x_id_provincia_maquinaria"<?php echo $viewsolicitudframe->id_provincia_maquinaria->EditAttributes() ?>>
<?php echo $viewsolicitudframe->id_provincia_maquinaria->SelectOptionListHtml("x_id_provincia_maquinaria") ?>
</select>
</span>
<?php echo $viewsolicitudframe->id_provincia_maquinaria->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_id_provincia_maquinaria">
		<td class="col-sm-3"><span id="elh_viewsolicitudframe_id_provincia_maquinaria"><?php echo $viewsolicitudframe->id_provincia_maquinaria->FldCaption() ?></span></td>
		<td<?php echo $viewsolicitudframe->id_provincia_maquinaria->CellAttributes() ?>>
<span id="el_viewsolicitudframe_id_provincia_maquinaria">
<select data-table="viewsolicitudframe" data-field="x_id_provincia_maquinaria" data-page="1" data-value-separator="<?php echo $viewsolicitudframe->id_provincia_maquinaria->DisplayValueSeparatorAttribute() ?>" id="x_id_provincia_maquinaria" name="x_id_provincia_maquinaria"<?php echo $viewsolicitudframe->id_provincia_maquinaria->EditAttributes() ?>>
<?php echo $viewsolicitudframe->id_provincia_maquinaria->SelectOptionListHtml("x_id_provincia_maquinaria") ?>
</select>
</span>
<?php echo $viewsolicitudframe->id_provincia_maquinaria->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
<?php if ($viewsolicitudframe->tipomercaderia->Visible) { // tipomercaderia ?>
<?php if ($viewsolicitudframe_add->IsMobileOrModal) { ?>
	<div id="r_tipomercaderia" class="form-group">
		<label id="elh_viewsolicitudframe_tipomercaderia" for="x_tipomercaderia" class="<?php echo $viewsolicitudframe_add->LeftColumnClass ?>"><?php echo $viewsolicitudframe->tipomercaderia->FldCaption() ?></label>
		<div class="<?php echo $viewsolicitudframe_add->RightColumnClass ?>"><div<?php echo $viewsolicitudframe->tipomercaderia->CellAttributes() ?>>
<span id="el_viewsolicitudframe_tipomercaderia">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_tipomercaderia"><?php echo (strval($viewsolicitudframe->tipomercaderia->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $viewsolicitudframe->tipomercaderia->ViewValue); ?></span>
</span>
<button type="button" title="<?php echo ew_HtmlEncode(str_replace("%s", ew_RemoveHtml($viewsolicitudframe->tipomercaderia->FldCaption()), $Language->Phrase("LookupLink", TRUE))) ?>" onclick="ew_ModalLookupShow({lnk:this,el:'x_tipomercaderia[]',m:1,n:10});" class="ewLookupBtn btn btn-default btn-sm"<?php echo (($viewsolicitudframe->tipomercaderia->ReadOnly || $viewsolicitudframe->tipomercaderia->Disabled) ? " disabled" : "")?>><span class="glyphicon glyphicon-search ewIcon"></span></button>
<input type="hidden" data-table="viewsolicitudframe" data-field="x_tipomercaderia" data-page="1" data-multiple="1" data-lookup="1" data-value-separator="<?php echo $viewsolicitudframe->tipomercaderia->DisplayValueSeparatorAttribute() ?>" name="x_tipomercaderia[]" id="x_tipomercaderia[]" value="<?php echo $viewsolicitudframe->tipomercaderia->CurrentValue ?>"<?php echo $viewsolicitudframe->tipomercaderia->EditAttributes() ?>>
</span>
<?php echo $viewsolicitudframe->tipomercaderia->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_tipomercaderia">
		<td class="col-sm-3"><span id="elh_viewsolicitudframe_tipomercaderia"><?php echo $viewsolicitudframe->tipomercaderia->FldCaption() ?></span></td>
		<td<?php echo $viewsolicitudframe->tipomercaderia->CellAttributes() ?>>
<span id="el_viewsolicitudframe_tipomercaderia">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_tipomercaderia"><?php echo (strval($viewsolicitudframe->tipomercaderia->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $viewsolicitudframe->tipomercaderia->ViewValue); ?></span>
</span>
...
<?php echo $viewsolicitudframe->tipomercaderia->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
<?php if ($viewsolicitudframe->documento_mercaderia->Visible) { // documento_mercaderia ?>
<?php if ($viewsolicitudframe_add->IsMobileOrModal) { ?>
	<div id="r_documento_mercaderia" class="form-group">
		<label id="elh_viewsolicitudframe_documento_mercaderia" for="x_documento_mercaderia" class="<?php echo $viewsolicitudframe_add->LeftColumnClass ?>"><?php echo $viewsolicitudframe->documento_mercaderia->FldCaption() ?></label>
		<div class="<?php echo $viewsolicitudframe_add->RightColumnClass ?>"><div<?php echo $viewsolicitudframe->documento_mercaderia->CellAttributes() ?>>
<span id="el_viewsolicitudframe_documento_mercaderia">
<input type="text" data-table="viewsolicitudframe" data-field="x_documento_mercaderia" data-page="1" name="x_documento_mercaderia" id="x_documento_mercaderia" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($viewsolicitudframe->documento_mercaderia->getPlaceHolder()) ?>" value="<?php echo $viewsolicitudframe->documento_mercaderia->EditValue ?>"<?php echo $viewsolicitudframe->documento_mercaderia->EditAttributes() ?>>
</span>
<?php echo $viewsolicitudframe->documento_mercaderia->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_documento_mercaderia">
		<td class="col-sm-3"><span id="elh_viewsolicitudframe_documento_mercaderia"><?php echo $viewsolicitudframe->documento_mercaderia->FldCaption() ?></span></td>
		<td<?php echo $viewsolicitudframe->documento_mercaderia->CellAttributes() ?>>
<span id="el_viewsolicitudframe_documento_mercaderia">
<input type="text" data-table="viewsolicitudframe" data-field="x_documento_mercaderia" data-page="1" name="x_documento_mercaderia" id="x_documento_mercaderia" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($viewsolicitudframe->documento_mercaderia->getPlaceHolder()) ?>" value="<?php echo $viewsolicitudframe->documento_mercaderia->EditValue ?>"<?php echo $viewsolicitudframe->documento_mercaderia->EditAttributes() ?>>
</span>
<?php echo $viewsolicitudframe->documento_mercaderia->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
<?php if ($viewsolicitudframe->tipoespecial->Visible) { // tipoespecial ?>
<?php if ($viewsolicitudframe_add->IsMobileOrModal) { ?>
	<div id="r_tipoespecial" class="form-group">
		<label id="elh_viewsolicitudframe_tipoespecial" for="x_tipoespecial" class="<?php echo $viewsolicitudframe_add->LeftColumnClass ?>"><?php echo $viewsolicitudframe->tipoespecial->FldCaption() ?></label>
		<div class="<?php echo $viewsolicitudframe_add->RightColumnClass ?>"><div<?php echo $viewsolicitudframe->tipoespecial->CellAttributes() ?>>
<span id="el_viewsolicitudframe_tipoespecial">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_tipoespecial"><?php echo (strval($viewsolicitudframe->tipoespecial->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $viewsolicitudframe->tipoespecial->ViewValue); ?></span>
</span>
<button type="button" title="<?php echo ew_HtmlEncode(str_replace("%s", ew_RemoveHtml($viewsolicitudframe->tipoespecial->FldCaption()), $Language->Phrase("LookupLink", TRUE))) ?>" onclick="ew_ModalLookupShow({lnk:this,el:'x_tipoespecial',m:0,n:10});" class="ewLookupBtn btn btn-default btn-sm"<?php echo (($viewsolicitudframe->tipoespecial->ReadOnly || $viewsolicitudframe->tipoespecial->Disabled) ? " disabled" : "")?>><span class="glyphicon glyphicon-search ewIcon"></span></button>
<input type="hidden" data-table="viewsolicitudframe" data-field="x_tipoespecial" data-page="1" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $viewsolicitudframe->tipoespecial->DisplayValueSeparatorAttribute() ?>" name="x_tipoespecial" id="x_tipoespecial" value="<?php echo $viewsolicitudframe->tipoespecial->CurrentValue ?>"<?php echo $viewsolicitudframe->tipoespecial->EditAttributes() ?>>
</span>
<?php echo $viewsolicitudframe->tipoespecial->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_tipoespecial">
		<td class="col-sm-3"><span id="elh_viewsolicitudframe_tipoespecial"><?php echo $viewsolicitudframe->tipoespecial->FldCaption() ?></span></td>
		<td<?php echo $viewsolicitudframe->tipoespecial->CellAttributes() ?>>
<span id="el_viewsolicitudframe_tipoespecial">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_tipoespecial"><?php echo (strval($viewsolicitudframe->tipoespecial->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $viewsolicitudframe->tipoespecial->ViewValue); ?></span>
</span>
...
<?php echo $viewsolicitudframe->tipoespecial->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
<?php if ($viewsolicitudframe_add->IsMobileOrModal) { ?>
...
<?php } ?>
<?php if (!$viewsolicitudframe_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $viewsolicitudframe_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $viewsolicitudframe_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fviewsolicitudframeadd.Init();
</script>
<?php
$viewsolicitudframe_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$viewsolicitudframe_add->Page_Terminate();
?>
