...
$viewsolicitudinspector = NULL;

//
// Table class for viewsolicitudinspector
//
class cviewsolicitudinspector extends cTable {
	var $id;
	var $name;
	var $lastname;
	var $_email;
	...
	function __construct() {
		...
		$this->TableVar = 'viewsolicitudinspector';
		$this->TableName = 'viewsolicitudinspector';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`viewsolicitudinspector`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// name
		$this->name = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->name->Sortable = TRUE; // Allow sort
		$this->fields['name'] = &$this->name;

		// lastname
		$this->lastname = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_lastname', 'lastname', '`lastname`', '`lastname`', 200, -1, FALSE, '`lastname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->lastname->Sortable = TRUE; // Allow sort
		$this->fields['lastname'] = &$this->lastname;

		// email
		$this->_email = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->_email->FldDefaultErrMsg = $Language->Phrase("IncorrectEmail");
		$this->fields['email'] = &$this->_email;

		// address
		$this->address = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_address', 'address', '`address`', '`address`', 200, -1, FALSE, '`address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->address->Sortable = TRUE; // Allow sort
		$this->fields['address'] = &$this->address;

		// nombre_contacto
		$this->nombre_contacto = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_nombre_contacto', 'nombre_contacto', '`nombre_contacto`', '`nombre_contacto`', 200, -1, FALSE, '`nombre_contacto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nombre_contacto->Sortable = TRUE; // Allow sort
		$this->fields['nombre_contacto'] = &$this->nombre_contacto;

		// email_contacto
		$this->email_contacto = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_email_contacto', 'email_contacto', '`email_contacto`', '`email_contacto`', 200, -1, FALSE, '`email_contacto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'HIDDEN');
		$this->email_contacto->Sortable = TRUE; // Allow sort
		$this->fields['email_contacto'] = &$this->email_contacto;

		// latitud
		$this->latitud = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_latitud', 'latitud', '`latitud`', '`latitud`', 5, -1, FALSE, '`latitud`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// longitud
		$this->longitud = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_longitud', 'longitud', '`longitud`', '`longitud`', 5, -1, FALSE, '`longitud`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// phone
		$this->phone = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_phone', 'phone', '`phone`', '`phone`', 200, -1, FALSE, '`phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->phone->Sortable = TRUE; // Allow sort
		$this->fields['phone'] = &$this->phone;

		// cell
		$this->cell = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_cell', 'cell', '`cell`', '`cell`', 200, -1, FALSE, '`cell`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->cell->Sortable = TRUE; // Allow sort
		$this->fields['cell'] = &$this->cell;

		// id_sucursal
		$this->id_sucursal = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_id_sucursal', 'id_sucursal', '`id_sucursal`', '`id_sucursal`', 3, -1, FALSE, '`id_sucursal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'HIDDEN');
		...
		// tipoinmueble
		$this->tipoinmueble = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_tipoinmueble', 'tipoinmueble', '`tipoinmueble`', '`tipoinmueble`', 200, -1, FALSE, '`tipoinmueble`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// id_ciudad_inmueble
		$this->id_ciudad_inmueble = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_id_ciudad_inmueble', 'id_ciudad_inmueble', '`id_ciudad_inmueble`', '`id_ciudad_inmueble`', 3, -1, FALSE, '`id_ciudad_inmueble`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->id_provincia_inmueble = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_id_provincia_inmueble', 'id_provincia_inmueble', '`id_provincia_inmueble`', '`id_provincia_inmueble`', 3, -1, FALSE, '`id_provincia_inmueble`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// imagen_inmueble01
		$this->imagen_inmueble01 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_inmueble01', 'imagen_inmueble01', '`imagen_inmueble01`', '`imagen_inmueble01`', 205, -1, TRUE, '`imagen_inmueble01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_inmueble01->Sortable = FALSE; // Allow sort
		$this->fields['imagen_inmueble01'] = &$this->imagen_inmueble01;

		// imagen_inmueble02
		$this->imagen_inmueble02 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_inmueble02', 'imagen_inmueble02', '`imagen_inmueble02`', '`imagen_inmueble02`', 205, -1, TRUE, '`imagen_inmueble02`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_inmueble02->Sortable = TRUE; // Allow sort
		$this->fields['imagen_inmueble02'] = &$this->imagen_inmueble02;

		// imagen_inmueble03
		$this->imagen_inmueble03 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_inmueble03', 'imagen_inmueble03', '`imagen_inmueble03`', '`imagen_inmueble03`', 205, -1, TRUE, '`imagen_inmueble03`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_inmueble03->Sortable = TRUE; // Allow sort
		$this->fields['imagen_inmueble03'] = &$this->imagen_inmueble03;

		// imagen_inmueble04
		$this->imagen_inmueble04 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_inmueble04', 'imagen_inmueble04', '`imagen_inmueble04`', '`imagen_inmueble04`', 205, -1, TRUE, '`imagen_inmueble04`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_inmueble04->Sortable = TRUE; // Allow sort
		$this->fields['imagen_inmueble04'] = &$this->imagen_inmueble04;

		// imagen_inmueble05
		$this->imagen_inmueble05 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_inmueble05', 'imagen_inmueble05', '`imagen_inmueble05`', '`imagen_inmueble05`', 205, -1, TRUE, '`imagen_inmueble05`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_inmueble05->Sortable = TRUE; // Allow sort
		$this->fields['imagen_inmueble05'] = &$this->imagen_inmueble05;

		// imagen_inmueble06
		$this->imagen_inmueble06 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_inmueble06', 'imagen_inmueble06', '`imagen_inmueble06`', '`imagen_inmueble06`', 205, -1, TRUE, '`imagen_inmueble06`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_inmueble06->Sortable = FALSE; // Allow sort
		$this->fields['imagen_inmueble06'] = &$this->imagen_inmueble06;

		// imagen_inmueble07
		$this->imagen_inmueble07 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_inmueble07', 'imagen_inmueble07', '`imagen_inmueble07`', '`imagen_inmueble07`', 205, -1, TRUE, '`imagen_inmueble07`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_inmueble07->Sortable = FALSE; // Allow sort
		$this->fields['imagen_inmueble07'] = &$this->imagen_inmueble07;

		// imagen_inmueble08
		$this->imagen_inmueble08 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_inmueble08', 'imagen_inmueble08', '`imagen_inmueble08`', '`imagen_inmueble08`', 205, -1, TRUE, '`imagen_inmueble08`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_inmueble08->Sortable = FALSE; // Allow sort
		$this->fields['imagen_inmueble08'] = &$this->imagen_inmueble08;

		// tipovehiculo
		$this->tipovehiculo = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_tipovehiculo', 'tipovehiculo', '`tipovehiculo`', '`tipovehiculo`', 200, -1, FALSE, '`tipovehiculo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// id_ciudad_vehiculo
		$this->id_ciudad_vehiculo = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_id_ciudad_vehiculo', 'id_ciudad_vehiculo', '`id_ciudad_vehiculo`', '`id_ciudad_vehiculo`', 3, -1, FALSE, '`id_ciudad_vehiculo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->id_provincia_vehiculo = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_id_provincia_vehiculo', 'id_provincia_vehiculo', '`id_provincia_vehiculo`', '`id_provincia_vehiculo`', 3, -1, FALSE, '`id_provincia_vehiculo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// imagen_vehiculo01
		$this->imagen_vehiculo01 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_vehiculo01', 'imagen_vehiculo01', '`imagen_vehiculo01`', '`imagen_vehiculo01`', 205, -1, TRUE, '`imagen_vehiculo01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_vehiculo01->Sortable = FALSE; // Allow sort
		$this->fields['imagen_vehiculo01'] = &$this->imagen_vehiculo01;

		// imagen_vehiculo02
		$this->imagen_vehiculo02 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_vehiculo02', 'imagen_vehiculo02', '`imagen_vehiculo02`', '`imagen_vehiculo02`', 205, -1, TRUE, '`imagen_vehiculo02`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_vehiculo02->Sortable = FALSE; // Allow sort
		$this->fields['imagen_vehiculo02'] = &$this->imagen_vehiculo02;

		// imagen_vehiculo03
		$this->imagen_vehiculo03 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_vehiculo03', 'imagen_vehiculo03', '`imagen_vehiculo03`', '`imagen_vehiculo03`', 205, -1, TRUE, '`imagen_vehiculo03`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_vehiculo03->Sortable = FALSE; // Allow sort
		$this->fields['imagen_vehiculo03'] = &$this->imagen_vehiculo03;

		// imagen_vehiculo04
		$this->imagen_vehiculo04 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_vehiculo04', 'imagen_vehiculo04', '`imagen_vehiculo04`', '`imagen_vehiculo04`', 205, -1, TRUE, '`imagen_vehiculo04`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_vehiculo04->Sortable = FALSE; // Allow sort
		$this->fields['imagen_vehiculo04'] = &$this->imagen_vehiculo04;

		// imagen_vehiculo05
		$this->imagen_vehiculo05 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_vehiculo05', 'imagen_vehiculo05', '`imagen_vehiculo05`', '`imagen_vehiculo05`', 205, -1, TRUE, '`imagen_vehiculo05`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_vehiculo05->Sortable = TRUE; // Allow sort
		$this->fields['imagen_vehiculo05'] = &$this->imagen_vehiculo05;

		// imagen_vehiculo06
		$this->imagen_vehiculo06 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_vehiculo06', 'imagen_vehiculo06', '`imagen_vehiculo06`', '`imagen_vehiculo06`', 205, -1, TRUE, '`imagen_vehiculo06`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_vehiculo06->Sortable = TRUE; // Allow sort
		$this->fields['imagen_vehiculo06'] = &$this->imagen_vehiculo06;

		// imagen_vehiculo07
		$this->imagen_vehiculo07 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_vehiculo07', 'imagen_vehiculo07', '`imagen_vehiculo07`', '`imagen_vehiculo07`', 205, -1, TRUE, '`imagen_vehiculo07`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_vehiculo07->Sortable = TRUE; // Allow sort
		$this->fields['imagen_vehiculo07'] = &$this->imagen_vehiculo07;

		// imagen_vehiculo08
		$this->imagen_vehiculo08 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_vehiculo08', 'imagen_vehiculo08', '`imagen_vehiculo08`', '`imagen_vehiculo08`', 205, -1, TRUE, '`imagen_vehiculo08`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_vehiculo08->Sortable = FALSE; // Allow sort
		$this->fields['imagen_vehiculo08'] = &$this->imagen_vehiculo08;

		// tipomaquinaria
		$this->tipomaquinaria = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_tipomaquinaria', 'tipomaquinaria', '`tipomaquinaria`', '`tipomaquinaria`', 200, -1, FALSE, '`tipomaquinaria`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->id_ciudad_maquinaria = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_id_ciudad_maquinaria', 'id_ciudad_maquinaria', '`id_ciudad_maquinaria`', '`id_ciudad_maquinaria`', 3, -1, FALSE, '`id_ciudad_maquinaria`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->id_provincia_maquinaria = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_id_provincia_maquinaria', 'id_provincia_maquinaria', '`id_provincia_maquinaria`', '`id_provincia_maquinaria`', 3, -1, FALSE, '`id_provincia_maquinaria`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// imagen_maquinaria01
		$this->imagen_maquinaria01 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_maquinaria01', 'imagen_maquinaria01', '`imagen_maquinaria01`', '`imagen_maquinaria01`', 205, -1, TRUE, '`imagen_maquinaria01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_maquinaria01->Sortable = FALSE; // Allow sort
		$this->fields['imagen_maquinaria01'] = &$this->imagen_maquinaria01;

		// imagen_maquinaria02
		$this->imagen_maquinaria02 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_maquinaria02', 'imagen_maquinaria02', '`imagen_maquinaria02`', '`imagen_maquinaria02`', 205, -1, TRUE, '`imagen_maquinaria02`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_maquinaria02->Sortable = FALSE; // Allow sort
		$this->fields['imagen_maquinaria02'] = &$this->imagen_maquinaria02;

		// imagen_maquinaria03
		$this->imagen_maquinaria03 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_maquinaria03', 'imagen_maquinaria03', '`imagen_maquinaria03`', '`imagen_maquinaria03`', 205, -1, TRUE, '`imagen_maquinaria03`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_maquinaria03->Sortable = FALSE; // Allow sort
		$this->fields['imagen_maquinaria03'] = &$this->imagen_maquinaria03;

		// imagen_maquinaria04
		$this->imagen_maquinaria04 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_maquinaria04', 'imagen_maquinaria04', '`imagen_maquinaria04`', '`imagen_maquinaria04`', 205, -1, TRUE, '`imagen_maquinaria04`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_maquinaria04->Sortable = FALSE; // Allow sort
		$this->fields['imagen_maquinaria04'] = &$this->imagen_maquinaria04;

		// imagen_maquinaria05
		$this->imagen_maquinaria05 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_maquinaria05', 'imagen_maquinaria05', '`imagen_maquinaria05`', '`imagen_maquinaria05`', 205, -1, TRUE, '`imagen_maquinaria05`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_maquinaria05->Sortable = TRUE; // Allow sort
		$this->fields['imagen_maquinaria05'] = &$this->imagen_maquinaria05;

		// imagen_maquinaria06
		$this->imagen_maquinaria06 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_maquinaria06', 'imagen_maquinaria06', '`imagen_maquinaria06`', '`imagen_maquinaria06`', 205, -1, TRUE, '`imagen_maquinaria06`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_maquinaria06->Sortable = TRUE; // Allow sort
		$this->fields['imagen_maquinaria06'] = &$this->imagen_maquinaria06;

		// imagen_maquinaria07
		$this->imagen_maquinaria07 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_maquinaria07', 'imagen_maquinaria07', '`imagen_maquinaria07`', '`imagen_maquinaria07`', 205, -1, TRUE, '`imagen_maquinaria07`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_maquinaria07->Sortable = TRUE; // Allow sort
		$this->fields['imagen_maquinaria07'] = &$this->imagen_maquinaria07;

		// imagen_maquinaria08
		$this->imagen_maquinaria08 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_maquinaria08', 'imagen_maquinaria08', '`imagen_maquinaria08`', '`imagen_maquinaria08`', 205, -1, TRUE, '`imagen_maquinaria08`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_maquinaria08->Sortable = FALSE; // Allow sort
		$this->fields['imagen_maquinaria08'] = &$this->imagen_maquinaria08;

		// tipomercaderia
		$this->tipomercaderia = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_tipomercaderia', 'tipomercaderia', '`tipomercaderia`', '`tipomercaderia`', 200, -1, FALSE, '`tipomercaderia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// imagen_mercaderia01
		$this->imagen_mercaderia01 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_mercaderia01', 'imagen_mercaderia01', '`imagen_mercaderia01`', '`imagen_mercaderia01`', 205, -1, TRUE, '`imagen_mercaderia01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		...
		$this->documento_mercaderia = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_documento_mercaderia', 'documento_mercaderia', '`documento_mercaderia`', '`documento_mercaderia`', 200, -1, FALSE, '`documento_mercaderia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->documento_mercaderia->Sortable = TRUE; // Allow sort
		$this->fields['documento_mercaderia'] = &$this->documento_mercaderia;

		// tipoespecial
		$this->tipoespecial = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_tipoespecial', 'tipoespecial', '`tipoespecial`', '`tipoespecial`', 200, -1, FALSE, '`tipoespecial`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->imagen_tipoespecial01 = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_imagen_tipoespecial01', 'imagen_tipoespecial01', '`imagen_tipoespecial01`', '`imagen_tipoespecial01`', 205, -1, TRUE, '`imagen_tipoespecial01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_tipoespecial01->Sortable = FALSE; // Allow sort
		$this->fields['imagen_tipoespecial01'] = &$this->imagen_tipoespecial01;

		// is_active
		$this->is_active = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_is_active', 'is_active', '`is_active`', '`is_active`', 16, -1, FALSE, '`is_active`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// documentos
		$this->documentos = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_documentos', 'documentos', '`documentos`', '`documentos`', 200, -1, FALSE, '`documentos`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->documentos->Sortable = TRUE; // Allow sort
		$this->fields['documentos'] = &$this->documentos;

		// created_at
		$this->created_at = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_created_at', 'created_at', '`created_at`', ew_CastDateFieldForLike('`created_at`', 0, "DB"), 135, 0, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DateModified
		$this->DateModified = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_DateModified', 'DateModified', '`DateModified`', ew_CastDateFieldForLike('`DateModified`', 0, "DB"), 135, 0, FALSE, '`DateModified`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DateDeleted
		$this->DateDeleted = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_DateDeleted', 'DateDeleted', '`DateDeleted`', ew_CastDateFieldForLike('`DateDeleted`', 0, "DB"), 135, 0, FALSE, '`DateDeleted`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CreatedBy
		$this->CreatedBy = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_CreatedBy', 'CreatedBy', '`CreatedBy`', '`CreatedBy`', 200, -1, FALSE, '`CreatedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreatedBy->Sortable = FALSE; // Allow sort
		$this->fields['CreatedBy'] = &$this->CreatedBy;

		// ModifiedBy
		$this->ModifiedBy = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_ModifiedBy', 'ModifiedBy', '`ModifiedBy`', '`ModifiedBy`', 200, -1, FALSE, '`ModifiedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ModifiedBy->Sortable = FALSE; // Allow sort
		$this->fields['ModifiedBy'] = &$this->ModifiedBy;

		// DeletedBy
		$this->DeletedBy = new cField('viewsolicitudinspector', 'viewsolicitudinspector', 'x_DeletedBy', 'DeletedBy', '`DeletedBy`', '`DeletedBy`', 200, -1, FALSE, '`DeletedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "viewavaluoinspector") {
			$sDetailUrl = $GLOBALS["viewavaluoinspector"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "viewsolicitudinspectorlist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`viewsolicitudinspector`";
	}
	...
	function Update(&$rs, $where = "", $rsold = NULL, $curfilter = TRUE) {
		...
		// Cascade Update detail table 'viewavaluoinspector'
		...
		if ($bCascadeUpdate) {
			...
			$rswrk = $GLOBALS["viewavaluoinspector"]->LoadRs("`id_solicitud` = " . ew_QuotedValue($rsold['id'], EW_DATATYPE_NUMBER, 'DB')); 
			while ($rswrk && !$rswrk->EOF) {
				...
				$bUpdate = $GLOBALS["viewavaluoinspector"]->Row_Updating($rsdtlold, $rsdtlnew);
				if ($bUpdate)
					$bUpdate = $GLOBALS["viewavaluoinspector"]->Update($rscascade, $rskey, $rswrk->fields);
				if (!$bUpdate) return FALSE;

				// Call Row_Updated event
				$GLOBALS["viewavaluoinspector"]->Row_Updated($rsdtlold, $rsdtlnew);
				$rswrk->MoveNext();
			}
		}
	...
	function Delete(&$rs, $where = "", $curfilter = TRUE) {
		...
		// Cascade delete detail table 'viewavaluoinspector'
		if (!isset($GLOBALS["viewavaluoinspector"])) $GLOBALS["viewavaluoinspector"] = new cviewavaluoinspector();
		$rscascade = $GLOBALS["viewavaluoinspector"]->LoadRs("`id_solicitud` = " . ew_QuotedValue($rs['id'], EW_DATATYPE_NUMBER, "DB")); 
		$dtlrows = ($rscascade) ? $rscascade->GetRows() : array();

		// Call Row Deleting event
		foreach ($dtlrows as $dtlrow) {
			$bDelete = $GLOBALS["viewavaluoinspector"]->Row_Deleting($dtlrow);
			if (!$bDelete) break;
		}
		if ($bDelete) {
			foreach ($dtlrows as $dtlrow) {
				$bDelete = $GLOBALS["viewavaluoinspector"]->Delete($dtlrow); // Delete
				if ($bDelete === FALSE)
					break;
			}
		}
		...
		if ($bDelete) {
			foreach ($dtlrows as $dtlrow) {
				$GLOBALS["viewavaluoinspector"]->Row_Deleted($dtlrow);
			}
		}
		if ($bDelete)
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "viewsolicitudinspectorlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "viewsolicitudinspectoredit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "viewsolicitudinspectoradd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("viewsolicitudinspectorview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("viewsolicitudinspectorview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "viewsolicitudinspectoradd.php?" . $this->UrlParm($parm);
		else
			$url = "viewsolicitudinspectoradd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("viewsolicitudinspectoredit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("viewsolicitudinspectoredit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("viewsolicitudinspectoradd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("viewsolicitudinspectoradd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("viewsolicitudinspectordelete.php", $this->UrlParm());
	}
	...
	// Common render codes
		...
		if (!ew_Empty($this->imagen_inmueble01->Upload->DbValue)) {
			$this->imagen_inmueble01->ViewValue = "viewsolicitudinspector_imagen_inmueble01_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_inmueble06->Upload->DbValue)) {
			$this->imagen_inmueble06->ViewValue = "viewsolicitudinspector_imagen_inmueble06_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_inmueble07->Upload->DbValue)) {
			$this->imagen_inmueble07->ViewValue = "viewsolicitudinspector_imagen_inmueble07_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_inmueble08->Upload->DbValue)) {
			$this->imagen_inmueble08->ViewValue = "viewsolicitudinspector_imagen_inmueble08_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_vehiculo01->Upload->DbValue)) {
			$this->imagen_vehiculo01->ViewValue = "viewsolicitudinspector_imagen_vehiculo01_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_vehiculo02->Upload->DbValue)) {
			$this->imagen_vehiculo02->ViewValue = "viewsolicitudinspector_imagen_vehiculo02_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_vehiculo03->Upload->DbValue)) {
			$this->imagen_vehiculo03->ViewValue = "viewsolicitudinspector_imagen_vehiculo03_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_vehiculo04->Upload->DbValue)) {
			$this->imagen_vehiculo04->ViewValue = "viewsolicitudinspector_imagen_vehiculo04_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_vehiculo08->Upload->DbValue)) {
			$this->imagen_vehiculo08->ViewValue = "viewsolicitudinspector_imagen_vehiculo08_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_maquinaria01->Upload->DbValue)) {
			$this->imagen_maquinaria01->ViewValue = "viewsolicitudinspector_imagen_maquinaria01_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_maquinaria02->Upload->DbValue)) {
			$this->imagen_maquinaria02->ViewValue = "viewsolicitudinspector_imagen_maquinaria02_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_maquinaria03->Upload->DbValue)) {
			$this->imagen_maquinaria03->ViewValue = "viewsolicitudinspector_imagen_maquinaria03_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_maquinaria04->Upload->DbValue)) {
			$this->imagen_maquinaria04->ViewValue = "viewsolicitudinspector_imagen_maquinaria04_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_maquinaria08->Upload->DbValue)) {
			$this->imagen_maquinaria08->ViewValue = "viewsolicitudinspector_imagen_maquinaria08_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_mercaderia01->Upload->DbValue)) {
			$this->imagen_mercaderia01->ViewValue = "viewsolicitudinspector_imagen_mercaderia01_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_tipoespecial01->Upload->DbValue)) {
			$this->imagen_tipoespecial01->ViewValue = "viewsolicitudinspector_imagen_tipoespecial01_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_inmueble01->Upload->DbValue)) {
			$this->imagen_inmueble01->HrefValue = "viewsolicitudinspector_imagen_inmueble01_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_inmueble01->HrefValue2 = "viewsolicitudinspector_imagen_inmueble01_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_inmueble06->Upload->DbValue)) {
			$this->imagen_inmueble06->HrefValue = "viewsolicitudinspector_imagen_inmueble06_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_inmueble06->HrefValue2 = "viewsolicitudinspector_imagen_inmueble06_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_inmueble07->Upload->DbValue)) {
			$this->imagen_inmueble07->HrefValue = "viewsolicitudinspector_imagen_inmueble07_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_inmueble07->HrefValue2 = "viewsolicitudinspector_imagen_inmueble07_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_inmueble08->Upload->DbValue)) {
			$this->imagen_inmueble08->HrefValue = "viewsolicitudinspector_imagen_inmueble08_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_inmueble08->HrefValue2 = "viewsolicitudinspector_imagen_inmueble08_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_vehiculo01->Upload->DbValue)) {
			$this->imagen_vehiculo01->HrefValue = "viewsolicitudinspector_imagen_vehiculo01_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_vehiculo01->HrefValue2 = "viewsolicitudinspector_imagen_vehiculo01_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_vehiculo02->Upload->DbValue)) {
			$this->imagen_vehiculo02->HrefValue = "viewsolicitudinspector_imagen_vehiculo02_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_vehiculo02->HrefValue2 = "viewsolicitudinspector_imagen_vehiculo02_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_vehiculo03->Upload->DbValue)) {
			$this->imagen_vehiculo03->HrefValue = "viewsolicitudinspector_imagen_vehiculo03_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_vehiculo03->HrefValue2 = "viewsolicitudinspector_imagen_vehiculo03_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_vehiculo04->Upload->DbValue)) {
			$this->imagen_vehiculo04->HrefValue = "viewsolicitudinspector_imagen_vehiculo04_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_vehiculo04->HrefValue2 = "viewsolicitudinspector_imagen_vehiculo04_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_vehiculo08->Upload->DbValue)) {
			$this->imagen_vehiculo08->HrefValue = "viewsolicitudinspector_imagen_vehiculo08_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_vehiculo08->HrefValue2 = "viewsolicitudinspector_imagen_vehiculo08_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_maquinaria01->Upload->DbValue)) {
			$this->imagen_maquinaria01->HrefValue = "viewsolicitudinspector_imagen_maquinaria01_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_maquinaria01->HrefValue2 = "viewsolicitudinspector_imagen_maquinaria01_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_maquinaria02->Upload->DbValue)) {
			$this->imagen_maquinaria02->HrefValue = "viewsolicitudinspector_imagen_maquinaria02_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_maquinaria02->HrefValue2 = "viewsolicitudinspector_imagen_maquinaria02_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_maquinaria03->Upload->DbValue)) {
			$this->imagen_maquinaria03->HrefValue = "viewsolicitudinspector_imagen_maquinaria03_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_maquinaria03->HrefValue2 = "viewsolicitudinspector_imagen_maquinaria03_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_maquinaria04->Upload->DbValue)) {
			$this->imagen_maquinaria04->HrefValue = "viewsolicitudinspector_imagen_maquinaria04_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_maquinaria04->HrefValue2 = "viewsolicitudinspector_imagen_maquinaria04_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_maquinaria08->Upload->DbValue)) {
			$this->imagen_maquinaria08->HrefValue = "viewsolicitudinspector_imagen_maquinaria08_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_maquinaria08->HrefValue2 = "viewsolicitudinspector_imagen_maquinaria08_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_mercaderia01->Upload->DbValue)) {
			$this->imagen_mercaderia01->HrefValue = "viewsolicitudinspector_imagen_mercaderia01_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_mercaderia01->HrefValue2 = "viewsolicitudinspector_imagen_mercaderia01_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_tipoespecial01->Upload->DbValue)) {
			$this->imagen_tipoespecial01->HrefValue = "viewsolicitudinspector_imagen_tipoespecial01_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_tipoespecial01->HrefValue2 = "viewsolicitudinspector_imagen_tipoespecial01_bv.php?id=" . $this->id->CurrentValue;
	...
	function RenderEditRow() {
		...
		if (!ew_Empty($this->imagen_inmueble01->Upload->DbValue)) {
			$this->imagen_inmueble01->EditValue = "viewsolicitudinspector_imagen_inmueble01_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_inmueble01->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_inmueble01->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_inmueble06->Upload->DbValue)) {
			$this->imagen_inmueble06->EditValue = "viewsolicitudinspector_imagen_inmueble06_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_inmueble06->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_inmueble06->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_inmueble07->Upload->DbValue)) {
			$this->imagen_inmueble07->EditValue = "viewsolicitudinspector_imagen_inmueble07_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_inmueble07->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_inmueble07->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_inmueble08->Upload->DbValue)) {
			$this->imagen_inmueble08->EditValue = "viewsolicitudinspector_imagen_inmueble08_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_inmueble08->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_inmueble08->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_vehiculo01->Upload->DbValue)) {
			$this->imagen_vehiculo01->EditValue = "viewsolicitudinspector_imagen_vehiculo01_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_vehiculo01->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_vehiculo01->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_vehiculo02->Upload->DbValue)) {
			$this->imagen_vehiculo02->EditValue = "viewsolicitudinspector_imagen_vehiculo02_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_vehiculo02->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_vehiculo02->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_vehiculo03->Upload->DbValue)) {
			$this->imagen_vehiculo03->EditValue = "viewsolicitudinspector_imagen_vehiculo03_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_vehiculo03->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_vehiculo03->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_vehiculo04->Upload->DbValue)) {
			$this->imagen_vehiculo04->EditValue = "viewsolicitudinspector_imagen_vehiculo04_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_vehiculo04->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_vehiculo04->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_vehiculo08->Upload->DbValue)) {
			$this->imagen_vehiculo08->EditValue = "viewsolicitudinspector_imagen_vehiculo08_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_vehiculo08->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_vehiculo08->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_maquinaria01->Upload->DbValue)) {
			$this->imagen_maquinaria01->EditValue = "viewsolicitudinspector_imagen_maquinaria01_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_maquinaria01->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_maquinaria01->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_maquinaria02->Upload->DbValue)) {
			$this->imagen_maquinaria02->EditValue = "viewsolicitudinspector_imagen_maquinaria02_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_maquinaria02->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_maquinaria02->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_maquinaria03->Upload->DbValue)) {
			$this->imagen_maquinaria03->EditValue = "viewsolicitudinspector_imagen_maquinaria03_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_maquinaria03->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_maquinaria03->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_maquinaria04->Upload->DbValue)) {
			$this->imagen_maquinaria04->EditValue = "viewsolicitudinspector_imagen_maquinaria04_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_maquinaria04->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_maquinaria04->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_maquinaria08->Upload->DbValue)) {
			$this->imagen_maquinaria08->EditValue = "viewsolicitudinspector_imagen_maquinaria08_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_maquinaria08->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_maquinaria08->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_mercaderia01->Upload->DbValue)) {
			$this->imagen_mercaderia01->EditValue = "viewsolicitudinspector_imagen_mercaderia01_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_mercaderia01->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_mercaderia01->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_tipoespecial01->Upload->DbValue)) {
			$this->imagen_tipoespecial01->EditValue = "viewsolicitudinspector_imagen_tipoespecial01_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_tipoespecial01->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_tipoespecial01->Upload->DbValue, 0, 11)));
		} else {
