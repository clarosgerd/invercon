...
$inspector_add = NULL; // Initialize page object first

class cinspector_add extends cinspector {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "inspectorview.php")
...
// Create page object
if (!isset($inspector_add)) $inspector_add = new cinspector_add();

// Page init
$inspector_add->Page_Init();

// Page main
$inspector_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$inspector_add->Page_Render();
?>
...
var CurrentForm = finspectoradd = new ew_Form("finspectoradd", "add");

// Validate form
finspectoradd.Validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $inspector->id_rol->FldCaption(), $inspector->id_rol->ReqErrMsg)) ?>");
...
finspectoradd.Form_CustomValidate = 
...
finspectoradd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
finspectoradd.Lists["x_id_rol"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"userlevels"};
finspectoradd.Lists["x_id_rol"].Data = "<?php echo $inspector_add->id_rol->LookupFilterQuery(FALSE, "add") ?>";
finspectoradd.Lists["x_id_sucursal"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"sucursal"};
finspectoradd.Lists["x_id_sucursal"].Data = "<?php echo $inspector_add->id_sucursal->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $inspector_add->ShowPageHeader(); ?>
<?php
$inspector_add->ShowMessage();
?>
<form name="finspectoradd" id="finspectoradd" class="<?php echo $inspector_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($inspector_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $inspector_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="inspector">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($inspector_add->IsModal) ?>">
...
<?php } else { ?>
<table id="tbl_inspectoradd" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($inspector->nombre->Visible) { // nombre ?>
<?php if ($inspector_add->IsMobileOrModal) { ?>
	<div id="r_nombre" class="form-group">
		<label id="elh_inspector_nombre" for="x_nombre" class="<?php echo $inspector_add->LeftColumnClass ?>"><?php echo $inspector->nombre->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inspector_add->RightColumnClass ?>"><div<?php echo $inspector->nombre->CellAttributes() ?>>
...
<?php if ($inspector_add->IsMobileOrModal) { ?>
	<div id="r_apellido" class="form-group">
		<label id="elh_inspector_apellido" for="x_apellido" class="<?php echo $inspector_add->LeftColumnClass ?>"><?php echo $inspector->apellido->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inspector_add->RightColumnClass ?>"><div<?php echo $inspector->apellido->CellAttributes() ?>>
...
<?php if ($inspector_add->IsMobileOrModal) { ?>
	<div id="r__login" class="form-group">
		<label id="elh_inspector__login" for="x__login" class="<?php echo $inspector_add->LeftColumnClass ?>"><?php echo $inspector->_login->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inspector_add->RightColumnClass ?>"><div<?php echo $inspector->_login->CellAttributes() ?>>
<span id="el_inspector__login">
<input type="text" data-table="inspector" data-field="x__login" name="x__login" id="x__login" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($inspector->_login->getPlaceHolder()) ?>" value="<?php echo $inspector->_login->EditValue ?>"<?php echo $inspector->_login->EditAttributes() ?>>
</span>
...
<?php if ($inspector_add->IsMobileOrModal) { ?>
	<div id="r_password" class="form-group">
		<label id="elh_inspector_password" for="x_password" class="<?php echo $inspector_add->LeftColumnClass ?>"><?php echo $inspector->password->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inspector_add->RightColumnClass ?>"><div<?php echo $inspector->password->CellAttributes() ?>>
<span id="el_inspector_password">
<div class="input-group" id="ig_password">
<input type="password" data-password-generated="pgt_password" data-table="inspector" data-field="x_password" name="x_password" id="x_password" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($inspector->password->getPlaceHolder()) ?>"<?php echo $inspector->password->EditAttributes() ?>>
...
<?php if ($inspector_add->IsMobileOrModal) { ?>
	<div id="r_ci" class="form-group">
		<label id="elh_inspector_ci" for="x_ci" class="<?php echo $inspector_add->LeftColumnClass ?>"><?php echo $inspector->ci->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inspector_add->RightColumnClass ?>"><div<?php echo $inspector->ci->CellAttributes() ?>>
...
<?php if ($inspector_add->IsMobileOrModal) { ?>
	<div id="r_id_rol" class="form-group">
		<label id="elh_inspector_id_rol" for="x_id_rol" class="<?php echo $inspector_add->LeftColumnClass ?>"><?php echo $inspector->id_rol->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php } else { ?>
	<tr id="r_id_rol">
		<td class="col-sm-3"><span id="elh_inspector_id_rol"><?php echo $inspector->id_rol->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
...
<?php if ($inspector_add->IsMobileOrModal) { ?>
	<div id="r_id_sucursal" class="form-group">
		<label id="elh_inspector_id_sucursal" for="x_id_sucursal" class="<?php echo $inspector_add->LeftColumnClass ?>"><?php echo $inspector->id_sucursal->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($inspector_add->IsMobileOrModal) { ?>
	<div id="r__email" class="form-group">
		<label id="elh_inspector__email" for="x__email" class="<?php echo $inspector_add->LeftColumnClass ?>"><?php echo $inspector->_email->FldCaption() ?></label>
		<div class="<?php echo $inspector_add->RightColumnClass ?>"><div<?php echo $inspector->_email->CellAttributes() ?>>
...
<?php if ($inspector_add->IsMobileOrModal) { ?>
	<div id="r_telefono_fijo01" class="form-group">
		<label id="elh_inspector_telefono_fijo01" for="x_telefono_fijo01" class="<?php echo $inspector_add->LeftColumnClass ?>"><?php echo $inspector->telefono_fijo01->FldCaption() ?></label>
		<div class="<?php echo $inspector_add->RightColumnClass ?>"><div<?php echo $inspector->telefono_fijo01->CellAttributes() ?>>
...
<?php if ($inspector_add->IsMobileOrModal) { ?>
	<div id="r_telefono_fijo02" class="form-group">
		<label id="elh_inspector_telefono_fijo02" for="x_telefono_fijo02" class="<?php echo $inspector_add->LeftColumnClass ?>"><?php echo $inspector->telefono_fijo02->FldCaption() ?></label>
		<div class="<?php echo $inspector_add->RightColumnClass ?>"><div<?php echo $inspector->telefono_fijo02->CellAttributes() ?>>
...
<?php if ($inspector_add->IsMobileOrModal) { ?>
	<div id="r_celular" class="form-group">
		<label id="elh_inspector_celular" for="x_celular" class="<?php echo $inspector_add->LeftColumnClass ?>"><?php echo $inspector->celular->FldCaption() ?></label>
		<div class="<?php echo $inspector_add->RightColumnClass ?>"><div<?php echo $inspector->celular->CellAttributes() ?>>
...
<?php if ($inspector_add->IsMobileOrModal) { ?>
	<div id="r_celular2" class="form-group">
		<label id="elh_inspector_celular2" for="x_celular2" class="<?php echo $inspector_add->LeftColumnClass ?>"><?php echo $inspector->celular2->FldCaption() ?></label>
		<div class="<?php echo $inspector_add->RightColumnClass ?>"><div<?php echo $inspector->celular2->CellAttributes() ?>>
...
<?php if ($inspector_add->IsMobileOrModal) { ?>
	<div id="r_direccion" class="form-group">
		<label id="elh_inspector_direccion" for="x_direccion" class="<?php echo $inspector_add->LeftColumnClass ?>"><?php echo $inspector->direccion->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inspector_add->RightColumnClass ?>"><div<?php echo $inspector->direccion->CellAttributes() ?>>
...
<?php if ($inspector_add->IsMobileOrModal) { ?>
	<div id="r_cargo" class="form-group">
		<label id="elh_inspector_cargo" for="x_cargo" class="<?php echo $inspector_add->LeftColumnClass ?>"><?php echo $inspector->cargo->FldCaption() ?></label>
		<div class="<?php echo $inspector_add->RightColumnClass ?>"><div<?php echo $inspector->cargo->CellAttributes() ?>>
...
<?php if ($inspector_add->IsMobileOrModal) { ?>
	<div id="r_id_institucion" class="form-group">
		<label id="elh_inspector_id_institucion" for="x_id_institucion" class="<?php echo $inspector_add->LeftColumnClass ?>"><?php echo $inspector->id_institucion->FldCaption() ?></label>
		<div class="<?php echo $inspector_add->RightColumnClass ?>"><div<?php echo $inspector->id_institucion->CellAttributes() ?>>
...
<?php if ($inspector_add->IsMobileOrModal) { ?>
	<div id="r_especialidad" class="form-group">
		<label id="elh_inspector_especialidad" for="x_especialidad" class="<?php echo $inspector_add->LeftColumnClass ?>"><?php echo $inspector->especialidad->FldCaption() ?></label>
		<div class="<?php echo $inspector_add->RightColumnClass ?>"><div<?php echo $inspector->especialidad->CellAttributes() ?>>
...
<?php if ($inspector_add->IsMobileOrModal) { ?>
	<div id="r_status" class="form-group">
		<label id="elh_inspector_status" for="x_status" class="<?php echo $inspector_add->LeftColumnClass ?>"><?php echo $inspector->status->FldCaption() ?></label>
		<div class="<?php echo $inspector_add->RightColumnClass ?>"><div<?php echo $inspector->status->CellAttributes() ?>>
...
<?php if ($inspector_add->IsMobileOrModal) { ?>
	<div id="r_color" class="form-group">
		<label id="elh_inspector_color" for="x_color" class="<?php echo $inspector_add->LeftColumnClass ?>"><?php echo $inspector->color->FldCaption() ?></label>
		<div class="<?php echo $inspector_add->RightColumnClass ?>"><div<?php echo $inspector->color->CellAttributes() ?>>
...
<?php } ?>
<?php if (!$inspector_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $inspector_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $inspector_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
