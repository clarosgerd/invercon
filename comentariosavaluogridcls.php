...
$comentariosavaluo_grid = NULL; // Initialize page object first

class ccomentariosavaluo_grid extends ccomentariosavaluo {
	...
	// Page object name
	var $PageObjName = 'comentariosavaluo_grid';

	// Grid form hidden field names
	var $FormName = 'fcomentariosavaluogrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["comentariosavaluo"];
