...
$oficialcredito_add = NULL; // Initialize page object first

class coficialcredito_add extends coficialcredito {
	...
	// Page object name
	var $PageObjName = 'oficialcredito_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "oficialcreditoview.php")
...
// Create page object
if (!isset($oficialcredito_add)) $oficialcredito_add = new coficialcredito_add();

// Page init
$oficialcredito_add->Page_Init();

// Page main
$oficialcredito_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$oficialcredito_add->Page_Render();
?>
...
var CurrentForm = foficialcreditoadd = new ew_Form("foficialcreditoadd", "add");

// Validate form
foficialcreditoadd.Validate = function() {
...
foficialcreditoadd.Form_CustomValidate = 
...
foficialcreditoadd.Lists["x_status"].Options = <?php echo json_encode($oficialcredito_add->status->Options()) ?>;
...
<?php $oficialcredito_add->ShowPageHeader(); ?>
<?php
$oficialcredito_add->ShowMessage();
?>
<form name="foficialcreditoadd" id="foficialcreditoadd" class="<?php echo $oficialcredito_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($oficialcredito_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $oficialcredito_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="oficialcredito">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($oficialcredito_add->IsModal) ?>">
<?php if (!$oficialcredito_add->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($oficialcredito_add->IsMobileOrModal) { ?>
<div class="ewAddDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_oficialcreditoadd" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($oficialcredito->nombre->Visible) { // nombre ?>
<?php if ($oficialcredito_add->IsMobileOrModal) { ?>
	<div id="r_nombre" class="form-group">
		<label id="elh_oficialcredito_nombre" for="x_nombre" class="<?php echo $oficialcredito_add->LeftColumnClass ?>"><?php echo $oficialcredito->nombre->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $oficialcredito_add->RightColumnClass ?>"><div<?php echo $oficialcredito->nombre->CellAttributes() ?>>
...
<?php if ($oficialcredito_add->IsMobileOrModal) { ?>
	<div id="r_apellido" class="form-group">
		<label id="elh_oficialcredito_apellido" for="x_apellido" class="<?php echo $oficialcredito_add->LeftColumnClass ?>"><?php echo $oficialcredito->apellido->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $oficialcredito_add->RightColumnClass ?>"><div<?php echo $oficialcredito->apellido->CellAttributes() ?>>
...
<?php if ($oficialcredito_add->IsMobileOrModal) { ?>
	<div id="r__login" class="form-group">
		<label id="elh_oficialcredito__login" for="x__login" class="<?php echo $oficialcredito_add->LeftColumnClass ?>"><?php echo $oficialcredito->_login->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $oficialcredito_add->RightColumnClass ?>"><div<?php echo $oficialcredito->_login->CellAttributes() ?>>
<span id="el_oficialcredito__login">
<input type="text" data-table="oficialcredito" data-field="x__login" name="x__login" id="x__login" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($oficialcredito->_login->getPlaceHolder()) ?>" value="<?php echo $oficialcredito->_login->EditValue ?>"<?php echo $oficialcredito->_login->EditAttributes() ?>>
</span>
...
<?php if ($oficialcredito_add->IsMobileOrModal) { ?>
	<div id="r_password" class="form-group">
		<label id="elh_oficialcredito_password" for="x_password" class="<?php echo $oficialcredito_add->LeftColumnClass ?>"><?php echo $oficialcredito->password->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $oficialcredito_add->RightColumnClass ?>"><div<?php echo $oficialcredito->password->CellAttributes() ?>>
<span id="el_oficialcredito_password">
<div class="input-group" id="ig_password">
<input type="password" data-password-generated="pgt_password" data-table="oficialcredito" data-field="x_password" name="x_password" id="x_password" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($oficialcredito->password->getPlaceHolder()) ?>"<?php echo $oficialcredito->password->EditAttributes() ?>>
...
<?php if ($oficialcredito_add->IsMobileOrModal) { ?>
	<div id="r_ci" class="form-group">
		<label id="elh_oficialcredito_ci" for="x_ci" class="<?php echo $oficialcredito_add->LeftColumnClass ?>"><?php echo $oficialcredito->ci->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $oficialcredito_add->RightColumnClass ?>"><div<?php echo $oficialcredito->ci->CellAttributes() ?>>
...
<?php if ($oficialcredito_add->IsMobileOrModal) { ?>
	<div id="r_id_sucursal" class="form-group">
		<label id="elh_oficialcredito_id_sucursal" for="x_id_sucursal" class="<?php echo $oficialcredito_add->LeftColumnClass ?>"><?php echo $oficialcredito->id_sucursal->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $oficialcredito_add->RightColumnClass ?>"><div<?php echo $oficialcredito->id_sucursal->CellAttributes() ?>>
...
<?php if ($oficialcredito_add->IsMobileOrModal) { ?>
	<div id="r__email" class="form-group">
		<label id="elh_oficialcredito__email" for="x__email" class="<?php echo $oficialcredito_add->LeftColumnClass ?>"><?php echo $oficialcredito->_email->FldCaption() ?></label>
		<div class="<?php echo $oficialcredito_add->RightColumnClass ?>"><div<?php echo $oficialcredito->_email->CellAttributes() ?>>
...
<?php if ($oficialcredito_add->IsMobileOrModal) { ?>
	<div id="r_telefono_fijo01" class="form-group">
		<label id="elh_oficialcredito_telefono_fijo01" for="x_telefono_fijo01" class="<?php echo $oficialcredito_add->LeftColumnClass ?>"><?php echo $oficialcredito->telefono_fijo01->FldCaption() ?></label>
		<div class="<?php echo $oficialcredito_add->RightColumnClass ?>"><div<?php echo $oficialcredito->telefono_fijo01->CellAttributes() ?>>
...
<?php if ($oficialcredito_add->IsMobileOrModal) { ?>
	<div id="r_telefono_fijo02" class="form-group">
		<label id="elh_oficialcredito_telefono_fijo02" for="x_telefono_fijo02" class="<?php echo $oficialcredito_add->LeftColumnClass ?>"><?php echo $oficialcredito->telefono_fijo02->FldCaption() ?></label>
		<div class="<?php echo $oficialcredito_add->RightColumnClass ?>"><div<?php echo $oficialcredito->telefono_fijo02->CellAttributes() ?>>
...
<?php if ($oficialcredito_add->IsMobileOrModal) { ?>
	<div id="r_celular" class="form-group">
		<label id="elh_oficialcredito_celular" for="x_celular" class="<?php echo $oficialcredito_add->LeftColumnClass ?>"><?php echo $oficialcredito->celular->FldCaption() ?></label>
		<div class="<?php echo $oficialcredito_add->RightColumnClass ?>"><div<?php echo $oficialcredito->celular->CellAttributes() ?>>
...
<?php if ($oficialcredito_add->IsMobileOrModal) { ?>
	<div id="r_celular2" class="form-group">
		<label id="elh_oficialcredito_celular2" for="x_celular2" class="<?php echo $oficialcredito_add->LeftColumnClass ?>"><?php echo $oficialcredito->celular2->FldCaption() ?></label>
		<div class="<?php echo $oficialcredito_add->RightColumnClass ?>"><div<?php echo $oficialcredito->celular2->CellAttributes() ?>>
...
<?php if ($oficialcredito_add->IsMobileOrModal) { ?>
	<div id="r_direccion" class="form-group">
		<label id="elh_oficialcredito_direccion" for="x_direccion" class="<?php echo $oficialcredito_add->LeftColumnClass ?>"><?php echo $oficialcredito->direccion->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $oficialcredito_add->RightColumnClass ?>"><div<?php echo $oficialcredito->direccion->CellAttributes() ?>>
...
<?php if ($oficialcredito_add->IsMobileOrModal) { ?>
	<div id="r_cargo" class="form-group">
		<label id="elh_oficialcredito_cargo" for="x_cargo" class="<?php echo $oficialcredito_add->LeftColumnClass ?>"><?php echo $oficialcredito->cargo->FldCaption() ?></label>
		<div class="<?php echo $oficialcredito_add->RightColumnClass ?>"><div<?php echo $oficialcredito->cargo->CellAttributes() ?>>
...
<?php if ($oficialcredito_add->IsMobileOrModal) { ?>
	<div id="r_id_institucion" class="form-group">
		<label id="elh_oficialcredito_id_institucion" for="x_id_institucion" class="<?php echo $oficialcredito_add->LeftColumnClass ?>"><?php echo $oficialcredito->id_institucion->FldCaption() ?></label>
		<div class="<?php echo $oficialcredito_add->RightColumnClass ?>"><div<?php echo $oficialcredito->id_institucion->CellAttributes() ?>>
...
<?php if ($oficialcredito_add->IsMobileOrModal) { ?>
	<div id="r_especialidad" class="form-group">
		<label id="elh_oficialcredito_especialidad" for="x_especialidad" class="<?php echo $oficialcredito_add->LeftColumnClass ?>"><?php echo $oficialcredito->especialidad->FldCaption() ?></label>
		<div class="<?php echo $oficialcredito_add->RightColumnClass ?>"><div<?php echo $oficialcredito->especialidad->CellAttributes() ?>>
...
<?php if ($oficialcredito_add->IsMobileOrModal) { ?>
	<div id="r_status" class="form-group">
		<label id="elh_oficialcredito_status" class="<?php echo $oficialcredito_add->LeftColumnClass ?>"><?php echo $oficialcredito->status->FldCaption() ?></label>
		<div class="<?php echo $oficialcredito_add->RightColumnClass ?>"><div<?php echo $oficialcredito->status->CellAttributes() ?>>
<span id="el_oficialcredito_status">
<div id="tp_x_status" class="ewTemplate"><input type="radio" data-table="oficialcredito" data-field="x_status" data-value-separator="<?php echo $oficialcredito->status->DisplayValueSeparatorAttribute() ?>" name="x_status" id="x_status" value="{value}"<?php echo $oficialcredito->status->EditAttributes() ?>></div>
<div id="dsl_x_status" data-repeatcolumn="5" class="ewItemList" style="display: none;"><div>
<?php echo $oficialcredito->status->RadioButtonListHtml(FALSE, "x_status") ?>
</div></div>
</span>
...
<?php if ($oficialcredito_add->IsMobileOrModal) { ?>
	<div id="r_avatar" class="form-group">
		<label id="elh_oficialcredito_avatar" class="<?php echo $oficialcredito_add->LeftColumnClass ?>"><?php echo $oficialcredito->avatar->FldCaption() ?></label>
		<div class="<?php echo $oficialcredito_add->RightColumnClass ?>"><div<?php echo $oficialcredito->avatar->CellAttributes() ?>>
...
<?php if ($oficialcredito_add->IsMobileOrModal) { ?>
	<div id="r_codigo" class="form-group">
		<label id="elh_oficialcredito_codigo" for="x_codigo" class="<?php echo $oficialcredito_add->LeftColumnClass ?>"><?php echo $oficialcredito->codigo->FldCaption() ?></label>
		<div class="<?php echo $oficialcredito_add->RightColumnClass ?>"><div<?php echo $oficialcredito->codigo->CellAttributes() ?>>
...
<?php } ?>
<?php if (!$oficialcredito_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $oficialcredito_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $oficialcredito_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
foficialcreditoadd.Init();
</script>
<?php
$oficialcredito_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$oficialcredito_add->Page_Terminate();
?>
