...
$viewdocumentooficialcredito_imagen_blobview = NULL; // Initialize page object first

class cviewdocumentooficialcredito_imagen_blobview extends cviewdocumentooficialcredito {
	...
	// Page object name
	var $PageObjName = 'viewdocumentooficialcredito_imagen_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'viewdocumentooficialcredito');
	...
	function Page_Main() {
		...
		// SQL constructor in viewdocumentooficialcredito class, viewdocumentooficialcreditoinfo.php
...
// Create page object
if (!isset($viewdocumentooficialcredito_imagen_blobview)) $viewdocumentooficialcredito_imagen_blobview = new cviewdocumentooficialcredito_imagen_blobview();

// Page init
$viewdocumentooficialcredito_imagen_blobview->Page_Init();

// Page main
$viewdocumentooficialcredito_imagen_blobview->Page_Main();
?>
<?php
$viewdocumentooficialcredito_imagen_blobview->Page_Terminate();
?>
