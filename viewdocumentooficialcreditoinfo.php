...
$viewdocumentooficialcredito = NULL;

//
// Table class for viewdocumentooficialcredito
//
class cviewdocumentooficialcredito extends cTable {
	var $id;
	var $descripcion;
	var $imagen;
	var $avaluo;
	...
	function __construct() {
		...
		$this->TableVar = 'viewdocumentooficialcredito';
		$this->TableName = 'viewdocumentooficialcredito';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`viewdocumentooficialcredito`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('viewdocumentooficialcredito', 'viewdocumentooficialcredito', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// descripcion
		$this->descripcion = new cField('viewdocumentooficialcredito', 'viewdocumentooficialcredito', 'x_descripcion', 'descripcion', '`descripcion`', '`descripcion`', 201, -1, FALSE, '`descripcion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->descripcion->Sortable = TRUE; // Allow sort
		$this->fields['descripcion'] = &$this->descripcion;

		// imagen
		$this->imagen = new cField('viewdocumentooficialcredito', 'viewdocumentooficialcredito', 'x_imagen', 'imagen', '`imagen`', '`imagen`', 205, -1, TRUE, '`imagen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen->Sortable = TRUE; // Allow sort
		$this->fields['imagen'] = &$this->imagen;

		// avaluo
		$this->avaluo = new cField('viewdocumentooficialcredito', 'viewdocumentooficialcredito', 'x_avaluo', 'avaluo', '`avaluo`', '`avaluo`', 3, -1, FALSE, '`avaluo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->avaluo->Sortable = TRUE; // Allow sort
		$this->avaluo->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->avaluo->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->avaluo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['avaluo'] = &$this->avaluo;

		// path_drive
		$this->path_drive = new cField('viewdocumentooficialcredito', 'viewdocumentooficialcredito', 'x_path_drive', 'path_drive', '`path_drive`', '`path_drive`', 200, -1, FALSE, '`path_drive`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->path_drive->Sortable = FALSE; // Allow sort
		$this->fields['path_drive'] = &$this->path_drive;

		// id_tipodocumento
		$this->id_tipodocumento = new cField('viewdocumentooficialcredito', 'viewdocumentooficialcredito', 'x_id_tipodocumento', 'id_tipodocumento', '`id_tipodocumento`', '`id_tipodocumento`', 3, -1, FALSE, '`id_tipodocumento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// created_at
		$this->created_at = new cField('viewdocumentooficialcredito', 'viewdocumentooficialcredito', 'x_created_at', 'created_at', '`created_at`', ew_CastDateFieldForLike('`created_at`', 0, "DB"), 135, 0, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "viewavaluo") {
			if ($this->path_drive->getSessionValue() <> "")
				$sMasterFilter .= "`id`=" . ew_QuotedValue($this->path_drive->getSessionValue(), EW_DATATYPE_NUMBER, "DB");
			else
				return "";
			if ($this->avaluo->getSessionValue() <> "")
				$sMasterFilter .= " AND `id`=" . ew_QuotedValue($this->avaluo->getSessionValue(), EW_DATATYPE_NUMBER, "DB");
			else
				return "";
		}
	...
	function GetDetailFilter() {
		...
		if ($this->getCurrentMasterTable() == "viewavaluo") {
			if ($this->path_drive->getSessionValue() <> "")
				$sDetailFilter .= "`path_drive`=" . ew_QuotedValue($this->path_drive->getSessionValue(), EW_DATATYPE_STRING, "DB");
			else
				return "";
			if ($this->avaluo->getSessionValue() <> "")
				$sDetailFilter .= " AND `avaluo`=" . ew_QuotedValue($this->avaluo->getSessionValue(), EW_DATATYPE_NUMBER, "DB");
			else
				return "";
		}
	...
	// Master filter
	function SqlMasterFilter_viewavaluo() {
		return "`id`=@id@ AND `id`=@id@";
	}

	// Detail filter
	function SqlDetailFilter_viewavaluo() {
		return "`path_drive`='@path_drive@' AND `avaluo`=@avaluo@";
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`viewdocumentooficialcredito`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "viewdocumentooficialcreditolist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "viewdocumentooficialcreditoedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "viewdocumentooficialcreditoadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("viewdocumentooficialcreditoview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("viewdocumentooficialcreditoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "viewdocumentooficialcreditoadd.php?" . $this->UrlParm($parm);
		else
			$url = "viewdocumentooficialcreditoadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("viewdocumentooficialcreditoedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("viewdocumentooficialcreditoadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("viewdocumentooficialcreditodelete.php", $this->UrlParm());
	}

	// Add master url
	function AddMasterUrl($url) {
		if ($this->getCurrentMasterTable() == "viewavaluo" && strpos($url, EW_TABLE_SHOW_MASTER . "=") === FALSE) {
			$url .= (strpos($url, "?") !== FALSE ? "&" : "?") . EW_TABLE_SHOW_MASTER . "=" . $this->getCurrentMasterTable();
			$url .= "&fk_id=" . urlencode($this->path_drive->CurrentValue);
			$url .= "&fk_id=" . urlencode($this->avaluo->CurrentValue);
		}
		return $url;
	}
	...
	function RenderEditRow() {
		...
		if ($this->path_drive->getSessionValue() <> "") {
			$this->path_drive->CurrentValue = $this->path_drive->getSessionValue();
		$this->path_drive->ViewValue = $this->path_drive->CurrentValue;
		$this->path_drive->ViewCustomAttributes = "";
		} else {
