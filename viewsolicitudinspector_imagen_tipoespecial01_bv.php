...
$viewsolicitudinspector_imagen_tipoespecial01_blobview = NULL; // Initialize page object first

class cviewsolicitudinspector_imagen_tipoespecial01_blobview extends cviewsolicitudinspector {
	...
	// Page object name
	var $PageObjName = 'viewsolicitudinspector_imagen_tipoespecial01_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'viewsolicitudinspector');
	...
	function Page_Main() {
		...
		// SQL constructor in viewsolicitudinspector class, viewsolicitudinspectorinfo.php
...
// Create page object
if (!isset($viewsolicitudinspector_imagen_tipoespecial01_blobview)) $viewsolicitudinspector_imagen_tipoespecial01_blobview = new cviewsolicitudinspector_imagen_tipoespecial01_blobview();

// Page init
$viewsolicitudinspector_imagen_tipoespecial01_blobview->Page_Init();

// Page main
$viewsolicitudinspector_imagen_tipoespecial01_blobview->Page_Main();
?>
<?php
$viewsolicitudinspector_imagen_tipoespecial01_blobview->Page_Terminate();
?>
