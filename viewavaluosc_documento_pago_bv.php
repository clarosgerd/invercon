...
$viewavaluosc_documento_pago_blobview = NULL; // Initialize page object first

class cviewavaluosc_documento_pago_blobview extends cviewavaluosc {
	...
	// Page object name
	var $PageObjName = 'viewavaluosc_documento_pago_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'viewavaluosc');
	...
	function Page_Main() {
		...
		$fld = $this->fields["documento_pago"];
		...
		// SQL constructor in viewavaluosc class, viewavaluoscinfo.php
		...
		if ($this->Recordset = $conn->Execute($sSql)) {
			if (!$this->Recordset->EOF) {
				if (ob_get_length())
					ob_end_clean();
				$objBinary->Value = $this->Recordset->fields('documento_pago');
...
// Create page object
if (!isset($viewavaluosc_documento_pago_blobview)) $viewavaluosc_documento_pago_blobview = new cviewavaluosc_documento_pago_blobview();

// Page init
$viewavaluosc_documento_pago_blobview->Page_Init();

// Page main
$viewavaluosc_documento_pago_blobview->Page_Main();
?>
<?php
$viewavaluosc_documento_pago_blobview->Page_Terminate();
?>
