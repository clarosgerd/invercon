...
define("EW_PROJECT_NAME", "invercon", TRUE); // Project name
...
define("EW_RANDOM_KEY", 'phSrMsPc8BlQVvaW', TRUE); // Random key for encryption
...
$EW_RESET_HEIGHT = FALSE; // Reset layout height
...
if (!defined("EW_ADODB_TZ_OFFSET"))
	define("EW_ADODB_TZ_OFFSET", TRUE, TRUE); // Use ADOdb time zone offset
...
define("EW_USER_EMAIL_FILTER", "(`login` = '%e')", TRUE);
...
define("EW_USER_PROFILE_CONCURRENT_SESSION_COUNT", 2, TRUE); // Maximum sessions allowed
...
// Email
define("EW_SMTP_SERVER", "mail.invercon-sgv.com", TRUE); // SMTP server
define("EW_SMTP_SERVER_PORT", 465, TRUE); // SMTP server port
define("EW_SMTP_SECURE_OPTION", "ssl", TRUE);
define("EW_SMTP_SERVER_USERNAME", "notificacionesscz@invercon-sgv.com", TRUE); // SMTP server user name
define("EW_SMTP_SERVER_PASSWORD", "VOCmsG#]kgwu", TRUE); // SMTP server password
define("EW_SENDER_EMAIL", "notificacionesscz@invercon-sgv.com", TRUE); // Sender email address
define("EW_RECIPIENT_EMAIL", "notificacionesscz@invercon-sgv.com", TRUE); // Recipient email address
...
define("EW_USE_ILIKE_FOR_POSTGRESQL", FALSE, TRUE);
