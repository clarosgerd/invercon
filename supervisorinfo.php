...
//
// Table class for supervisor
//
class csupervisor extends cTable {
	var $nombre;
	var $apellido;
	var $_login;
	var $password;
	...
	function __construct() {
		...
		$this->TableVar = 'supervisor';
		$this->TableName = 'supervisor';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`supervisor`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// nombre
		$this->nombre = new cField('supervisor', 'supervisor', 'x_nombre', 'nombre', '`nombre`', '`nombre`', 200, -1, FALSE, '`nombre`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nombre->Sortable = TRUE; // Allow sort
		$this->fields['nombre'] = &$this->nombre;

		// apellido
		$this->apellido = new cField('supervisor', 'supervisor', 'x_apellido', 'apellido', '`apellido`', '`apellido`', 200, -1, FALSE, '`apellido`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->apellido->Sortable = TRUE; // Allow sort
		$this->fields['apellido'] = &$this->apellido;

		// login
		$this->_login = new cField('supervisor', 'supervisor', 'x__login', 'login', '`login`', '`login`', 200, -1, FALSE, '`login`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// password
		$this->password = new cField('supervisor', 'supervisor', 'x_password', 'password', '`password`', '`password`', 200, -1, FALSE, '`password`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'PASSWORD');
		$this->password->Sortable = TRUE; // Allow sort
		$this->fields['password'] = &$this->password;

		// ci
		$this->ci = new cField('supervisor', 'supervisor', 'x_ci', 'ci', '`ci`', '`ci`', 200, -1, FALSE, '`ci`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ci->Sortable = TRUE; // Allow sort
		$this->fields['ci'] = &$this->ci;

		// id_rol
		$this->id_rol = new cField('supervisor', 'supervisor', 'x_id_rol', 'id_rol', '`id_rol`', '`id_rol`', 3, -1, FALSE, '`id_rol`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// id_sucursal
		$this->id_sucursal = new cField('supervisor', 'supervisor', 'x_id_sucursal', 'id_sucursal', '`id_sucursal`', '`id_sucursal`', 3, -1, FALSE, '`id_sucursal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// email
		$this->_email = new cField('supervisor', 'supervisor', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->_email->FldDefaultErrMsg = $Language->Phrase("IncorrectEmail");
		$this->fields['email'] = &$this->_email;

		// telefono_fijo01
		$this->telefono_fijo01 = new cField('supervisor', 'supervisor', 'x_telefono_fijo01', 'telefono_fijo01', '`telefono_fijo01`', '`telefono_fijo01`', 200, -1, FALSE, '`telefono_fijo01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->telefono_fijo01->Sortable = TRUE; // Allow sort
		$this->fields['telefono_fijo01'] = &$this->telefono_fijo01;

		// telefono_fijo02
		$this->telefono_fijo02 = new cField('supervisor', 'supervisor', 'x_telefono_fijo02', 'telefono_fijo02', '`telefono_fijo02`', '`telefono_fijo02`', 200, -1, FALSE, '`telefono_fijo02`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->telefono_fijo02->Sortable = TRUE; // Allow sort
		$this->fields['telefono_fijo02'] = &$this->telefono_fijo02;

		// celular
		$this->celular = new cField('supervisor', 'supervisor', 'x_celular', 'celular', '`celular`', '`celular`', 200, -1, FALSE, '`celular`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->celular->Sortable = TRUE; // Allow sort
		$this->fields['celular'] = &$this->celular;

		// celular2
		$this->celular2 = new cField('supervisor', 'supervisor', 'x_celular2', 'celular2', '`celular2`', '`celular2`', 200, -1, FALSE, '`celular2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->celular2->Sortable = TRUE; // Allow sort
		$this->fields['celular2'] = &$this->celular2;

		// direccion
		$this->direccion = new cField('supervisor', 'supervisor', 'x_direccion', 'direccion', '`direccion`', '`direccion`', 201, -1, FALSE, '`direccion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->direccion->Sortable = TRUE; // Allow sort
		$this->fields['direccion'] = &$this->direccion;

		// cargo
		$this->cargo = new cField('supervisor', 'supervisor', 'x_cargo', 'cargo', '`cargo`', '`cargo`', 200, -1, FALSE, '`cargo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->cargo->Sortable = TRUE; // Allow sort
		$this->fields['cargo'] = &$this->cargo;

		// id_institucion
		$this->id_institucion = new cField('supervisor', 'supervisor', 'x_id_institucion', 'id_institucion', '`id_institucion`', '`id_institucion`', 3, -1, FALSE, '`id_institucion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// especialidad
		$this->especialidad = new cField('supervisor', 'supervisor', 'x_especialidad', 'especialidad', '`especialidad`', '`especialidad`', 200, -1, FALSE, '`especialidad`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->especialidad->Sortable = TRUE; // Allow sort
		$this->fields['especialidad'] = &$this->especialidad;

		// status
		$this->status = new cField('supervisor', 'supervisor', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->status->Sortable = TRUE; // Allow sort
		$this->status->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['status'] = &$this->status;

		// avatar
		$this->avatar = new cField('supervisor', 'supervisor', 'x_avatar', 'avatar', '`avatar`', '`avatar`', 205, -1, TRUE, '`avatar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->avatar->Sortable = FALSE; // Allow sort
		$this->fields['avatar'] = &$this->avatar;

		// color
		$this->color = new cField('supervisor', 'supervisor', 'x_color', 'color', '`color`', '`color`', 200, -1, FALSE, '`color`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->color->Sortable = FALSE; // Allow sort
		$this->fields['color'] = &$this->color;

		// codigo
		$this->codigo = new cField('supervisor', 'supervisor', 'x_codigo', 'codigo', '`codigo`', '`codigo`', 200, -1, FALSE, '`codigo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`supervisor`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "supervisoredit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "supervisoradd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("supervisorview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("supervisorview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "supervisoradd.php?" . $this->UrlParm($parm);
		else
			$url = "supervisoradd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("supervisoredit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("supervisoradd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("supervisordelete.php", $this->UrlParm());
	}
	...
	// Common render codes
		...
		if (!ew_Empty($this->avatar->Upload->DbValue)) {
			$this->avatar->ViewValue = "supervisor_avatar_bv.php?" . "_login=" . $this->_login->CurrentValue;
		...
		if (!empty($this->avatar->Upload->DbValue)) {
			$this->avatar->HrefValue = "supervisor_avatar_bv.php?_login=" . $this->_login->CurrentValue;
		...
		$this->avatar->HrefValue2 = "supervisor_avatar_bv.php?_login=" . $this->_login->CurrentValue;
	...
	function RenderEditRow() {
		...
		if (!ew_Empty($this->avatar->Upload->DbValue)) {
			$this->avatar->EditValue = "supervisor_avatar_bv.php?" . "_login=" . $this->_login->CurrentValue;
			$this->avatar->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->avatar->Upload->DbValue, 0, 11)));
		} else {
