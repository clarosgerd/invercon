...
class csucursal_list extends csucursal {
	...
	function GetFilterList() {
		...
		if (EW_SEARCH_FILTER_OPTION == "Server" && isset($UserProfile))
			$sSavedFilterList = $UserProfile->GetSearchFilters(CurrentUserName(), "fsucursallistsrch");
	...
	function ProcessFilterList() {
		...
		if (@$_POST["ajax"] == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->SetSearchFilters(CurrentUserName(), "fsucursallistsrch", $filters);
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $Language->Phrase("SearchPanel") . "\" data-caption=\"" . $Language->Phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fsucursallistsrch\">" . $Language->Phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
...
fsucursallist.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php
	...
	if ($bSelectLimit) {
		if ($sucursal_list->TotalRecs <= 0)
			$sucursal_list->TotalRecs = $sucursal->ListRecordCount();
	} else {
	...
	if ($sucursal->CurrentAction == "" && $sucursal_list->TotalRecs == 0) {
		if (!$Security->CanList())
			$sucursal_list->setWarningMessage(ew_DeniedMsg());
...
<form name="fsucursallistsrch" id="fsucursallistsrch" class="form-inline ewForm ewExtSearchForm" action="<?php echo ew_CurrentPage() ?>">
...
<div id="xsr_1" class="ewRow">
	...
	<input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" class="form-control" value="<?php echo ew_HtmlEncode($sucursal_list->BasicSearch->getKeyword()) ?>">
...
<div class="box ewBox ewGrid<?php if ($sucursal_list->IsAddOrEdit()) { ?> ewGridAddEdit<?php } ?> sucursal">
...
<?php } ?>
<input type="hidden" name="t" value="sucursal">
<div id="gmp_sucursal" class="<?php if (ew_IsResponsiveLayout()) { ?>table-responsive <?php } ?>ewGridMiddlePanel">
<?php if ($sucursal_list->TotalRecs > 0 || $sucursal->CurrentAction == "gridedit") { ?>
...
<?php if ($sucursal->id->Visible) { // id ?>
	<?php if ($sucursal->SortUrl($sucursal->id) == "") { ?>
		<th data-name="id" class="<?php echo $sucursal->id->HeaderCellClass() ?>"><div id="elh_sucursal_id" class="sucursal_id"><div class="ewTableHeaderCaption"><?php echo $sucursal->id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id" class="<?php echo $sucursal->id->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $sucursal->SortUrl($sucursal->id) ?>',1);"><div id="elh_sucursal_id" class="sucursal_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $sucursal->id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($sucursal->id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($sucursal->id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($sucursal->nombre->Visible) { // nombre ?>
	<?php if ($sucursal->SortUrl($sucursal->nombre) == "") { ?>
		<th data-name="nombre" class="<?php echo $sucursal->nombre->HeaderCellClass() ?>"><div id="elh_sucursal_nombre" class="sucursal_nombre"><div class="ewTableHeaderCaption"><?php echo $sucursal->nombre->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="nombre" class="<?php echo $sucursal->nombre->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $sucursal->SortUrl($sucursal->nombre) ?>',1);"><div id="elh_sucursal_nombre" class="sucursal_nombre">
...
<?php if ($sucursal->nombre_contacto->Visible) { // nombre_contacto ?>
	<?php if ($sucursal->SortUrl($sucursal->nombre_contacto) == "") { ?>
		<th data-name="nombre_contacto" class="<?php echo $sucursal->nombre_contacto->HeaderCellClass() ?>"><div id="elh_sucursal_nombre_contacto" class="sucursal_nombre_contacto"><div class="ewTableHeaderCaption"><?php echo $sucursal->nombre_contacto->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="nombre_contacto" class="<?php echo $sucursal->nombre_contacto->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $sucursal->SortUrl($sucursal->nombre_contacto) ?>',1);"><div id="elh_sucursal_nombre_contacto" class="sucursal_nombre_contacto">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $sucursal->nombre_contacto->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($sucursal->nombre_contacto->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($sucursal->nombre_contacto->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($sucursal->email_contacto->Visible) { // email_contacto ?>
	<?php if ($sucursal->SortUrl($sucursal->email_contacto) == "") { ?>
		<th data-name="email_contacto" class="<?php echo $sucursal->email_contacto->HeaderCellClass() ?>"><div id="elh_sucursal_email_contacto" class="sucursal_email_contacto"><div class="ewTableHeaderCaption"><?php echo $sucursal->email_contacto->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="email_contacto" class="<?php echo $sucursal->email_contacto->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $sucursal->SortUrl($sucursal->email_contacto) ?>',1);"><div id="elh_sucursal_email_contacto" class="sucursal_email_contacto">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $sucursal->email_contacto->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($sucursal->email_contacto->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($sucursal->email_contacto->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
?>
	<?php if ($sucursal->id->Visible) { // id ?>
		<td data-name="id"<?php echo $sucursal->id->CellAttributes() ?>>
<span id="el<?php echo $sucursal_list->RowCnt ?>_sucursal_id" class="sucursal_id">
<span<?php echo $sucursal->id->ViewAttributes() ?>>
<?php echo $sucursal->id->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($sucursal->nombre->Visible) { // nombre ?>
...
<?php echo $sucursal->nombre->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($sucursal->nombre_contacto->Visible) { // nombre_contacto ?>
		<td data-name="nombre_contacto"<?php echo $sucursal->nombre_contacto->CellAttributes() ?>>
<span id="el<?php echo $sucursal_list->RowCnt ?>_sucursal_nombre_contacto" class="sucursal_nombre_contacto">
<span<?php echo $sucursal->nombre_contacto->ViewAttributes() ?>>
<?php echo $sucursal->nombre_contacto->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($sucursal->email_contacto->Visible) { // email_contacto ?>
		<td data-name="email_contacto"<?php echo $sucursal->email_contacto->CellAttributes() ?>>
<span id="el<?php echo $sucursal_list->RowCnt ?>_sucursal_email_contacto" class="sucursal_email_contacto">
<span<?php echo $sucursal->email_contacto->ViewAttributes() ?>>
<?php echo $sucursal->email_contacto->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
...
<?php if (!isset($sucursal_list->Pager)) $sucursal_list->Pager = new cNumericPager($sucursal_list->StartRec, $sucursal_list->DisplayRecs, $sucursal_list->TotalRecs, $sucursal_list->RecRange, $sucursal_list->AutoHidePager) ?>
<?php if ($sucursal_list->Pager->RecordCount > 0 && $sucursal_list->Pager->Visible) { ?>
<div class="ewPager">
<div class="ewNumericPage"><ul class="pagination">
	<?php if ($sucursal_list->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $sucursal_list->PageUrl() ?>start=<?php echo $sucursal_list->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($sucursal_list->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $sucursal_list->PageUrl() ?>start=<?php echo $sucursal_list->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($sucursal_list->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $sucursal_list->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($sucursal_list->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $sucursal_list->PageUrl() ?>start=<?php echo $sucursal_list->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($sucursal_list->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $sucursal_list->PageUrl() ?>start=<?php echo $sucursal_list->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</div>
<?php } ?>
...
<?php } ?>
<?php if ($sucursal_list->TotalRecs > 0 && (!$sucursal_list->AutoHidePageSizeSelector || $sucursal_list->Pager->Visible)) { ?>
<div class="ewPager">
<input type="hidden" name="t" value="sucursal">
<select name="<?php echo EW_TABLE_REC_PER_PAGE ?>" class="form-control input-sm ewTooltip" title="<?php echo $Language->Phrase("RecordsPerPage") ?>" onchange="this.form.submit();">
<option value="10"<?php if ($sucursal_list->DisplayRecs == 10) { ?> selected<?php } ?>>10</option>
<option value="20"<?php if ($sucursal_list->DisplayRecs == 20) { ?> selected<?php } ?>>20</option>
<option value="50"<?php if ($sucursal_list->DisplayRecs == 50) { ?> selected<?php } ?>>50</option>
<option value="ALL"<?php if ($sucursal->getRecordsPerPage() == -1) { ?> selected<?php } ?>><?php echo $Language->Phrase("AllRecords") ?></option>
</select>
</div>
<?php } ?>
</form>
