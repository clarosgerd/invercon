			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->Page_Terminate("viewavaluolist.php"); // Return to list page
...
<?php if (!$viewavaluo_view->IsModal) { ?>
<?php if (!isset($viewavaluo_view->Pager)) $viewavaluo_view->Pager = new cNumericPager($viewavaluo_view->StartRec, $viewavaluo_view->DisplayRecs, $viewavaluo_view->TotalRecs, $viewavaluo_view->RecRange, $viewavaluo_view->AutoHidePager) ?>
<?php if ($viewavaluo_view->Pager->RecordCount > 0 && $viewavaluo_view->Pager->Visible) { ?>
<div class="ewPager">
<div class="ewNumericPage"><ul class="pagination">
	<?php if ($viewavaluo_view->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $viewavaluo_view->PageUrl() ?>start=<?php echo $viewavaluo_view->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($viewavaluo_view->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $viewavaluo_view->PageUrl() ?>start=<?php echo $viewavaluo_view->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($viewavaluo_view->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $viewavaluo_view->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($viewavaluo_view->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $viewavaluo_view->PageUrl() ?>start=<?php echo $viewavaluo_view->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($viewavaluo_view->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $viewavaluo_view->PageUrl() ?>start=<?php echo $viewavaluo_view->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</div>
<?php } ?>
