...
class cbanco extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('banco', 'banco', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// short_name
		$this->short_name = new cField('banco', 'banco', 'x_short_name', 'short_name', '`short_name`', '`short_name`', 200, -1, FALSE, '`short_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->short_name->Sortable = TRUE; // Allow sort
		$this->fields['short_name'] = &$this->short_name;

		// name
		$this->name = new cField('banco', 'banco', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->name->Sortable = TRUE; // Allow sort
		$this->fields['name'] = &$this->name;

		// is_active
		$this->is_active = new cField('banco', 'banco', 'x_is_active', 'is_active', '`is_active`', '`is_active`', 16, -1, FALSE, '`is_active`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "bancoedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "bancoadd.php")
