...
$solicitud_imagen_vehiculo05_blobview = NULL; // Initialize page object first

class csolicitud_imagen_vehiculo05_blobview extends csolicitud {
	...
	// Page object name
	var $PageObjName = 'solicitud_imagen_vehiculo05_blobview';
...
// Create page object
if (!isset($solicitud_imagen_vehiculo05_blobview)) $solicitud_imagen_vehiculo05_blobview = new csolicitud_imagen_vehiculo05_blobview();

// Page init
$solicitud_imagen_vehiculo05_blobview->Page_Init();

// Page main
$solicitud_imagen_vehiculo05_blobview->Page_Main();
?>
<?php
$solicitud_imagen_vehiculo05_blobview->Page_Terminate();
?>
