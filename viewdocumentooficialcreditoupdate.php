...
$viewdocumentooficialcredito_update = NULL; // Initialize page object first

class cviewdocumentooficialcredito_update extends cviewdocumentooficialcredito {
	...
	// Page object name
	var $PageObjName = 'viewdocumentooficialcredito_update';
	...
	function Page_Main() {
		...
		if (count($this->RecKeys) <= 0)
			$this->Page_Terminate("viewdocumentooficialcreditolist.php"); // No records selected, return to list
...
// Create page object
if (!isset($viewdocumentooficialcredito_update)) $viewdocumentooficialcredito_update = new cviewdocumentooficialcredito_update();

// Page init
$viewdocumentooficialcredito_update->Page_Init();

// Page main
$viewdocumentooficialcredito_update->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$viewdocumentooficialcredito_update->Page_Render();
?>
...
var CurrentForm = fviewdocumentooficialcreditoupdate = new ew_Form("fviewdocumentooficialcreditoupdate", "update");

// Validate form
fviewdocumentooficialcreditoupdate.Validate = function() {
...
fviewdocumentooficialcreditoupdate.Form_CustomValidate = 
...
fviewdocumentooficialcreditoupdate.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fviewdocumentooficialcreditoupdate.Lists["x_avaluo"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_tipoinmueble","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"avaluo"};
fviewdocumentooficialcreditoupdate.Lists["x_avaluo"].Data = "<?php echo $viewdocumentooficialcredito_update->avaluo->LookupFilterQuery(FALSE, "update") ?>";
fviewdocumentooficialcreditoupdate.Lists["x_id_tipodocumento"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipodocumento"};
fviewdocumentooficialcreditoupdate.Lists["x_id_tipodocumento"].Data = "<?php echo $viewdocumentooficialcredito_update->id_tipodocumento->LookupFilterQuery(FALSE, "update") ?>";
...
<?php $viewdocumentooficialcredito_update->ShowPageHeader(); ?>
<?php
$viewdocumentooficialcredito_update->ShowMessage();
?>
<form name="fviewdocumentooficialcreditoupdate" id="fviewdocumentooficialcreditoupdate" class="<?php echo $viewdocumentooficialcredito_update->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($viewdocumentooficialcredito_update->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $viewdocumentooficialcredito_update->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="viewdocumentooficialcredito">
<input type="hidden" name="a_update" id="a_update" value="U">
<input type="hidden" name="modal" value="<?php echo intval($viewdocumentooficialcredito_update->IsModal) ?>">
<?php foreach ($viewdocumentooficialcredito_update->RecKeys as $key) { ?>
<?php $keyvalue = is_array($key) ? implode($EW_COMPOSITE_KEY_SEPARATOR, $key) : $key; ?>
<input type="hidden" name="key_m[]" value="<?php echo ew_HtmlEncode($keyvalue) ?>">
<?php } ?>
<?php if (!$viewdocumentooficialcredito_update->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($viewdocumentooficialcredito_update->IsMobileOrModal) { ?>
<div id="tbl_viewdocumentooficialcreditoupdate" class="ewUpdateDiv"><!-- page -->
	<div class="checkbox">
		<label><input type="checkbox" name="u" id="u" onclick="ew_SelectAll(this);"> <?php echo $Language->Phrase("UpdateSelectAll") ?></label>
	</div>
<?php } else { ?>
<table id="tbl_viewdocumentooficialcreditoupdate" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- desktop table -->
	<thead>
	<tr>
...
<?php if ($viewdocumentooficialcredito_update->IsMobileOrModal) { ?>
	<div id="r_descripcion" class="form-group">
		<label for="x_descripcion" class="<?php echo $viewdocumentooficialcredito_update->LeftColumnClass ?>"><div class="checkbox"><label>
<input type="checkbox" name="u_descripcion" id="u_descripcion" class="ewMultiSelect" value="1"<?php echo ($viewdocumentooficialcredito->descripcion->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewdocumentooficialcredito->descripcion->FldCaption() ?></label></div></label>
		<div class="<?php echo $viewdocumentooficialcredito_update->RightColumnClass ?>"><div<?php echo $viewdocumentooficialcredito->descripcion->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_descripcion">
		<td class="col-sm-3"<?php echo $viewdocumentooficialcredito->descripcion->CellAttributes() ?>><span id="elh_viewdocumentooficialcredito_descripcion"><div class="checkbox"><label for="u_descripcion">
<input type="checkbox" name="u_descripcion" id="u_descripcion" class="ewMultiSelect" value="1"<?php echo ($viewdocumentooficialcredito->descripcion->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewdocumentooficialcredito->descripcion->FldCaption() ?></label></div></span></td>
...
<?php if ($viewdocumentooficialcredito_update->IsMobileOrModal) { ?>
	<div id="r_imagen" class="form-group">
		<label class="<?php echo $viewdocumentooficialcredito_update->LeftColumnClass ?>"><div class="checkbox"><label>
<input type="checkbox" name="u_imagen" id="u_imagen" class="ewMultiSelect" value="1"<?php echo ($viewdocumentooficialcredito->imagen->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewdocumentooficialcredito->imagen->FldCaption() ?></label></div></label>
		<div class="<?php echo $viewdocumentooficialcredito_update->RightColumnClass ?>"><div<?php echo $viewdocumentooficialcredito->imagen->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_imagen">
		<td class="col-sm-3"<?php echo $viewdocumentooficialcredito->imagen->CellAttributes() ?>><span id="elh_viewdocumentooficialcredito_imagen"><div class="checkbox"><label for="u_imagen">
<input type="checkbox" name="u_imagen" id="u_imagen" class="ewMultiSelect" value="1"<?php echo ($viewdocumentooficialcredito->imagen->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewdocumentooficialcredito->imagen->FldCaption() ?></label></div></span></td>
...
<?php if ($viewdocumentooficialcredito_update->IsMobileOrModal) { ?>
	<div id="r_avaluo" class="form-group">
		<label for="x_avaluo" class="<?php echo $viewdocumentooficialcredito_update->LeftColumnClass ?>"><div class="checkbox"><label>
<input type="checkbox" name="u_avaluo" id="u_avaluo" class="ewMultiSelect" value="1"<?php echo ($viewdocumentooficialcredito->avaluo->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewdocumentooficialcredito->avaluo->FldCaption() ?></label></div></label>
		<div class="<?php echo $viewdocumentooficialcredito_update->RightColumnClass ?>"><div<?php echo $viewdocumentooficialcredito->avaluo->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_avaluo">
		<td class="col-sm-3"<?php echo $viewdocumentooficialcredito->avaluo->CellAttributes() ?>><span id="elh_viewdocumentooficialcredito_avaluo"><div class="checkbox"><label for="u_avaluo">
<input type="checkbox" name="u_avaluo" id="u_avaluo" class="ewMultiSelect" value="1"<?php echo ($viewdocumentooficialcredito->avaluo->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewdocumentooficialcredito->avaluo->FldCaption() ?></label></div></span></td>
...
<?php if ($viewdocumentooficialcredito_update->IsMobileOrModal) { ?>
	<div id="r_id_tipodocumento" class="form-group">
		<label for="x_id_tipodocumento" class="<?php echo $viewdocumentooficialcredito_update->LeftColumnClass ?>"><div class="checkbox"><label>
<input type="checkbox" name="u_id_tipodocumento" id="u_id_tipodocumento" class="ewMultiSelect" value="1"<?php echo ($viewdocumentooficialcredito->id_tipodocumento->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewdocumentooficialcredito->id_tipodocumento->FldCaption() ?></label></div></label>
		<div class="<?php echo $viewdocumentooficialcredito_update->RightColumnClass ?>"><div<?php echo $viewdocumentooficialcredito->id_tipodocumento->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_id_tipodocumento">
		<td class="col-sm-3"<?php echo $viewdocumentooficialcredito->id_tipodocumento->CellAttributes() ?>><span id="elh_viewdocumentooficialcredito_id_tipodocumento"><div class="checkbox"><label for="u_id_tipodocumento">
<input type="checkbox" name="u_id_tipodocumento" id="u_id_tipodocumento" class="ewMultiSelect" value="1"<?php echo ($viewdocumentooficialcredito->id_tipodocumento->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewdocumentooficialcredito->id_tipodocumento->FldCaption() ?></label></div></span></td>
...
<?php } ?>
<?php if (!$viewdocumentooficialcredito_update->IsModal) { ?>
	<div class="form-group"><!-- buttons .form-group -->
		<div class="<?php echo $viewdocumentooficialcredito_update->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("UpdateBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $viewdocumentooficialcredito_update->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
		</div><!-- /buttons offset -->
...
<script type="text/javascript">
fviewdocumentooficialcreditoupdate.Init();
</script>
<?php
$viewdocumentooficialcredito_update->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$viewdocumentooficialcredito_update->Page_Terminate();
?>
