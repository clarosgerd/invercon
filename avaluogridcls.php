...
$avaluo_grid = NULL; // Initialize page object first

class cavaluo_grid extends cavaluo {
	...
	// Page object name
	var $PageObjName = 'avaluo_grid';

	// Grid form hidden field names
	var $FormName = 'favaluogrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["avaluo"];

		}
		$this->AddUrl = "avaluoadd.php";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "solicitud") {
			...
			if ($GLOBALS["solicitud"]->EventCancelled) $this->EventCancelled = TRUE;
		}
