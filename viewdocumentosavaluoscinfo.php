...
$viewdocumentosavaluosc = NULL;

//
// Table class for viewdocumentosavaluosc
//
class cviewdocumentosavaluosc extends cTable {
	var $id;
	var $descripcion;
	var $imagen;
	var $avaluo;
	...
	function __construct() {
		...
		$this->TableVar = 'viewdocumentosavaluosc';
		$this->TableName = 'viewdocumentosavaluosc';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`viewdocumentosavaluosc`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('viewdocumentosavaluosc', 'viewdocumentosavaluosc', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// descripcion
		$this->descripcion = new cField('viewdocumentosavaluosc', 'viewdocumentosavaluosc', 'x_descripcion', 'descripcion', '`descripcion`', '`descripcion`', 201, -1, FALSE, '`descripcion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->descripcion->Sortable = TRUE; // Allow sort
		$this->fields['descripcion'] = &$this->descripcion;

		// imagen
		$this->imagen = new cField('viewdocumentosavaluosc', 'viewdocumentosavaluosc', 'x_imagen', 'imagen', '`imagen`', '`imagen`', 205, -1, TRUE, '`imagen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen->Sortable = TRUE; // Allow sort
		$this->fields['imagen'] = &$this->imagen;

		// avaluo
		$this->avaluo = new cField('viewdocumentosavaluosc', 'viewdocumentosavaluosc', 'x_avaluo', 'avaluo', '`avaluo`', '`avaluo`', 3, -1, FALSE, '`avaluo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// path_drive
		$this->path_drive = new cField('viewdocumentosavaluosc', 'viewdocumentosavaluosc', 'x_path_drive', 'path_drive', '`path_drive`', '`path_drive`', 200, -1, FALSE, '`path_drive`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->path_drive->Sortable = FALSE; // Allow sort
		$this->fields['path_drive'] = &$this->path_drive;

		// id_tipodocumento
		$this->id_tipodocumento = new cField('viewdocumentosavaluosc', 'viewdocumentosavaluosc', 'x_id_tipodocumento', 'id_tipodocumento', '`id_tipodocumento`', '`id_tipodocumento`', 3, -1, FALSE, '`id_tipodocumento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// created_at
		$this->created_at = new cField('viewdocumentosavaluosc', 'viewdocumentosavaluosc', 'x_created_at', 'created_at', '`created_at`', ew_CastDateFieldForLike('`created_at`', 0, "DB"), 135, 0, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`viewdocumentosavaluosc`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "viewdocumentosavaluosclist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "viewdocumentosavaluoscedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "viewdocumentosavaluoscadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("viewdocumentosavaluoscview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("viewdocumentosavaluoscview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "viewdocumentosavaluoscadd.php?" . $this->UrlParm($parm);
		else
			$url = "viewdocumentosavaluoscadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("viewdocumentosavaluoscedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("viewdocumentosavaluoscadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("viewdocumentosavaluoscdelete.php", $this->UrlParm());
	}
