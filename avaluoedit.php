...
<?php } ?>
<span id="el_avaluo_id_sucursal">
<input type="hidden" data-table="avaluo" data-field="x_id_sucursal" name="x_id_sucursal" id="x_id_sucursal" value="<?php echo ew_HtmlEncode($avaluo->id_sucursal->CurrentValue) ?>">
</span>
