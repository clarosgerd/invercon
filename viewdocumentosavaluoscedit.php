...
$viewdocumentosavaluosc_edit = NULL; // Initialize page object first

class cviewdocumentosavaluosc_edit extends cviewdocumentosavaluosc {
	...
	// Page object name
	var $PageObjName = 'viewdocumentosavaluosc_edit';
...
// Create page object
if (!isset($viewdocumentosavaluosc_edit)) $viewdocumentosavaluosc_edit = new cviewdocumentosavaluosc_edit();

// Page init
$viewdocumentosavaluosc_edit->Page_Init();

// Page main
$viewdocumentosavaluosc_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$viewdocumentosavaluosc_edit->Page_Render();
?>
...
var CurrentForm = fviewdocumentosavaluoscedit = new ew_Form("fviewdocumentosavaluoscedit", "edit");

// Validate form
fviewdocumentosavaluoscedit.Validate = function() {
...
fviewdocumentosavaluoscedit.Form_CustomValidate = 
...
fviewdocumentosavaluoscedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fviewdocumentosavaluoscedit.Lists["x_avaluo"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_tipoinmueble","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"avaluo"};
fviewdocumentosavaluoscedit.Lists["x_avaluo"].Data = "<?php echo $viewdocumentosavaluosc_edit->avaluo->LookupFilterQuery(FALSE, "edit") ?>";
fviewdocumentosavaluoscedit.Lists["x_id_tipodocumento"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipodocumento"};
fviewdocumentosavaluoscedit.Lists["x_id_tipodocumento"].Data = "<?php echo $viewdocumentosavaluosc_edit->id_tipodocumento->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $viewdocumentosavaluosc_edit->ShowPageHeader(); ?>
<?php
$viewdocumentosavaluosc_edit->ShowMessage();
?>
<form name="fviewdocumentosavaluoscedit" id="fviewdocumentosavaluoscedit" class="<?php echo $viewdocumentosavaluosc_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($viewdocumentosavaluosc_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $viewdocumentosavaluosc_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="viewdocumentosavaluosc">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($viewdocumentosavaluosc_edit->IsModal) ?>">
...
<?php } ?>
<?php if (!$viewdocumentosavaluosc_edit->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($viewdocumentosavaluosc_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_viewdocumentosavaluoscedit" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($viewdocumentosavaluosc->id->Visible) { // id ?>
<?php if ($viewdocumentosavaluosc_edit->IsMobileOrModal) { ?>
	<div id="r_id" class="form-group">
		<label id="elh_viewdocumentosavaluosc_id" class="<?php echo $viewdocumentosavaluosc_edit->LeftColumnClass ?>"><?php echo $viewdocumentosavaluosc->id->FldCaption() ?></label>
		<div class="<?php echo $viewdocumentosavaluosc_edit->RightColumnClass ?>"><div<?php echo $viewdocumentosavaluosc->id->CellAttributes() ?>>
<span id="el_viewdocumentosavaluosc_id">
<span<?php echo $viewdocumentosavaluosc->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $viewdocumentosavaluosc->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="viewdocumentosavaluosc" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($viewdocumentosavaluosc->id->CurrentValue) ?>">
<?php echo $viewdocumentosavaluosc->id->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_id">
		<td class="col-sm-3"><span id="elh_viewdocumentosavaluosc_id"><?php echo $viewdocumentosavaluosc->id->FldCaption() ?></span></td>
		<td<?php echo $viewdocumentosavaluosc->id->CellAttributes() ?>>
<span id="el_viewdocumentosavaluosc_id">
<span<?php echo $viewdocumentosavaluosc->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $viewdocumentosavaluosc->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="viewdocumentosavaluosc" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($viewdocumentosavaluosc->id->CurrentValue) ?>">
<?php echo $viewdocumentosavaluosc->id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if ($viewdocumentosavaluosc_edit->IsMobileOrModal) { ?>
	<div id="r_descripcion" class="form-group">
		<label id="elh_viewdocumentosavaluosc_descripcion" for="x_descripcion" class="<?php echo $viewdocumentosavaluosc_edit->LeftColumnClass ?>"><?php echo $viewdocumentosavaluosc->descripcion->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $viewdocumentosavaluosc_edit->RightColumnClass ?>"><div<?php echo $viewdocumentosavaluosc->descripcion->CellAttributes() ?>>
...
<?php if ($viewdocumentosavaluosc_edit->IsMobileOrModal) { ?>
	<div id="r_imagen" class="form-group">
		<label id="elh_viewdocumentosavaluosc_imagen" class="<?php echo $viewdocumentosavaluosc_edit->LeftColumnClass ?>"><?php echo $viewdocumentosavaluosc->imagen->FldCaption() ?></label>
		<div class="<?php echo $viewdocumentosavaluosc_edit->RightColumnClass ?>"><div<?php echo $viewdocumentosavaluosc->imagen->CellAttributes() ?>>
<span id="el_viewdocumentosavaluosc_imagen">
<div id="fd_x_imagen">
<span title="<?php echo $viewdocumentosavaluosc->imagen->FldTitle() ? $viewdocumentosavaluosc->imagen->FldTitle() : $Language->Phrase("ChooseFile") ?>" class="btn btn-default btn-sm fileinput-button ewTooltip<?php if ($viewdocumentosavaluosc->imagen->ReadOnly || $viewdocumentosavaluosc->imagen->Disabled) echo " hide"; ?>" data-trigger="hover">
...
<?php if ($viewdocumentosavaluosc_edit->IsMobileOrModal) { ?>
	<div id="r_avaluo" class="form-group">
		<label id="elh_viewdocumentosavaluosc_avaluo" for="x_avaluo" class="<?php echo $viewdocumentosavaluosc_edit->LeftColumnClass ?>"><?php echo $viewdocumentosavaluosc->avaluo->FldCaption() ?></label>
		<div class="<?php echo $viewdocumentosavaluosc_edit->RightColumnClass ?>"><div<?php echo $viewdocumentosavaluosc->avaluo->CellAttributes() ?>>
...
<?php if ($viewdocumentosavaluosc_edit->IsMobileOrModal) { ?>
	<div id="r_id_tipodocumento" class="form-group">
		<label id="elh_viewdocumentosavaluosc_id_tipodocumento" for="x_id_tipodocumento" class="<?php echo $viewdocumentosavaluosc_edit->LeftColumnClass ?>"><?php echo $viewdocumentosavaluosc->id_tipodocumento->FldCaption() ?></label>
		<div class="<?php echo $viewdocumentosavaluosc_edit->RightColumnClass ?>"><div<?php echo $viewdocumentosavaluosc->id_tipodocumento->CellAttributes() ?>>
<span id="el_viewdocumentosavaluosc_id_tipodocumento">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next(":not([disabled])").click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_id_tipodocumento"><?php echo (strval($viewdocumentosavaluosc->id_tipodocumento->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $viewdocumentosavaluosc->id_tipodocumento->ViewValue); ?></span>
</span>
...
<?php } ?>
<?php if (!$viewdocumentosavaluosc_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $viewdocumentosavaluosc_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $viewdocumentosavaluosc_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fviewdocumentosavaluoscedit.Init();
</script>
<?php
$viewdocumentosavaluosc_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$viewdocumentosavaluosc_edit->Page_Terminate();
?>
