...
$viewavaluosupervisorhistorial_informe_blobview = NULL; // Initialize page object first

class cviewavaluosupervisorhistorial_informe_blobview extends cviewavaluosupervisorhistorial {
	...
	// Page object name
	var $PageObjName = 'viewavaluosupervisorhistorial_informe_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'viewavaluosupervisorhistorial');
	...
	function Page_Main() {
		...
		// SQL constructor in viewavaluosupervisorhistorial class, viewavaluosupervisorhistorialinfo.php
		...
		if ($this->Recordset = $conn->Execute($sSql)) {
			if (!$this->Recordset->EOF) {
				if (ob_get_length())
					ob_end_clean();
				$objBinary->Value = $this->Recordset->fields('informe');
...
// Create page object
if (!isset($viewavaluosupervisorhistorial_informe_blobview)) $viewavaluosupervisorhistorial_informe_blobview = new cviewavaluosupervisorhistorial_informe_blobview();

// Page init
$viewavaluosupervisorhistorial_informe_blobview->Page_Init();

// Page main
$viewavaluosupervisorhistorial_informe_blobview->Page_Main();
?>
<?php
$viewavaluosupervisorhistorial_informe_blobview->Page_Terminate();
?>
