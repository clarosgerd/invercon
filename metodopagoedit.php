...
$metodopago_edit = NULL; // Initialize page object first

class cmetodopago_edit extends cmetodopago {
	...
	// Page object name
	var $PageObjName = 'metodopago_edit';
...
// Create page object
if (!isset($metodopago_edit)) $metodopago_edit = new cmetodopago_edit();

// Page init
$metodopago_edit->Page_Init();

// Page main
$metodopago_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$metodopago_edit->Page_Render();
?>
...
var CurrentForm = fmetodopagoedit = new ew_Form("fmetodopagoedit", "edit");

// Validate form
fmetodopagoedit.Validate = function() {
...
fmetodopagoedit.Form_CustomValidate = 
...
fmetodopagoedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fmetodopagoedit.Lists["x_is_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmetodopagoedit.Lists["x_is_active"].Options = <?php echo json_encode($metodopago_edit->is_active->Options()) ?>;
...
<?php $metodopago_edit->ShowPageHeader(); ?>
<?php
$metodopago_edit->ShowMessage();
?>
<form name="fmetodopagoedit" id="fmetodopagoedit" class="<?php echo $metodopago_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($metodopago_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $metodopago_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="metodopago">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($metodopago_edit->IsModal) ?>">
<?php if (!$metodopago_edit->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($metodopago_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_metodopagoedit" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($metodopago->id->Visible) { // id ?>
<?php if ($metodopago_edit->IsMobileOrModal) { ?>
	<div id="r_id" class="form-group">
		<label id="elh_metodopago_id" class="<?php echo $metodopago_edit->LeftColumnClass ?>"><?php echo $metodopago->id->FldCaption() ?></label>
		<div class="<?php echo $metodopago_edit->RightColumnClass ?>"><div<?php echo $metodopago->id->CellAttributes() ?>>
<span id="el_metodopago_id">
<span<?php echo $metodopago->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $metodopago->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="metodopago" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($metodopago->id->CurrentValue) ?>">
<?php echo $metodopago->id->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_id">
		<td class="col-sm-3"><span id="elh_metodopago_id"><?php echo $metodopago->id->FldCaption() ?></span></td>
		<td<?php echo $metodopago->id->CellAttributes() ?>>
<span id="el_metodopago_id">
<span<?php echo $metodopago->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $metodopago->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="metodopago" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($metodopago->id->CurrentValue) ?>">
<?php echo $metodopago->id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if ($metodopago_edit->IsMobileOrModal) { ?>
	<div id="r_short_name" class="form-group">
		<label id="elh_metodopago_short_name" for="x_short_name" class="<?php echo $metodopago_edit->LeftColumnClass ?>"><?php echo $metodopago->short_name->FldCaption() ?></label>
		<div class="<?php echo $metodopago_edit->RightColumnClass ?>"><div<?php echo $metodopago->short_name->CellAttributes() ?>>
...
<?php if ($metodopago_edit->IsMobileOrModal) { ?>
	<div id="r_name" class="form-group">
		<label id="elh_metodopago_name" for="x_name" class="<?php echo $metodopago_edit->LeftColumnClass ?>"><?php echo $metodopago->name->FldCaption() ?></label>
		<div class="<?php echo $metodopago_edit->RightColumnClass ?>"><div<?php echo $metodopago->name->CellAttributes() ?>>
...
<?php if ($metodopago_edit->IsMobileOrModal) { ?>
	<div id="r_is_active" class="form-group">
		<label id="elh_metodopago_is_active" for="x_is_active" class="<?php echo $metodopago_edit->LeftColumnClass ?>"><?php echo $metodopago->is_active->FldCaption() ?></label>
		<div class="<?php echo $metodopago_edit->RightColumnClass ?>"><div<?php echo $metodopago->is_active->CellAttributes() ?>>
...
<?php } ?>
<?php if (!$metodopago_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $metodopago_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $metodopago_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fmetodopagoedit.Init();
</script>
<?php
$metodopago_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$metodopago_edit->Page_Terminate();
?>
