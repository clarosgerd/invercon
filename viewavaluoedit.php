...
$viewavaluo_edit = NULL; // Initialize page object first

class cviewavaluo_edit extends cviewavaluo {
	...
	// Page object name
	var $PageObjName = 'viewavaluo_edit';
	...
	function ValidateForm() {
		...
		if (in_array("viewdocumentooficialcredito", $DetailTblVar) && $GLOBALS["viewdocumentooficialcredito"]->DetailEdit) {
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("viewdocumentooficialcredito", $DetailTblVar) && $GLOBALS["viewdocumentooficialcredito"]->DetailEdit) {
						...
						$EditRow = $GLOBALS["viewdocumentooficialcredito_grid"]->GridUpdate();
	...
	function SetupDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("viewdocumentooficialcredito", $DetailTblVar)) {
				...
				if ($GLOBALS["viewdocumentooficialcredito_grid"]->DetailEdit) {
					$GLOBALS["viewdocumentooficialcredito_grid"]->CurrentMode = "edit";
					$GLOBALS["viewdocumentooficialcredito_grid"]->CurrentAction = "gridedit";
...
// Create page object
if (!isset($viewavaluo_edit)) $viewavaluo_edit = new cviewavaluo_edit();

// Page init
$viewavaluo_edit->Page_Init();

// Page main
$viewavaluo_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$viewavaluo_edit->Page_Render();
?>
...
var CurrentForm = fviewavaluoedit = new ew_Form("fviewavaluoedit", "edit");

// Validate form
fviewavaluoedit.Validate = function() {
...
fviewavaluoedit.Form_CustomValidate = 
...
fviewavaluoedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fviewavaluoedit.Lists["x_tipoinmueble"] = {"LinkField":"x_nombre","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipoinmueble"};
fviewavaluoedit.Lists["x_tipoinmueble"].Data = "<?php echo $viewavaluo_edit->tipoinmueble->LookupFilterQuery(FALSE, "edit") ?>";
fviewavaluoedit.Lists["x_id_solicitud"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_name","x_lastname","x__email",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"solicitud"};
fviewavaluoedit.Lists["x_id_solicitud"].Data = "<?php echo $viewavaluo_edit->id_solicitud->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $viewavaluo_edit->ShowPageHeader(); ?>
<?php
$viewavaluo_edit->ShowMessage();
?>
<form name="fviewavaluoedit" id="fviewavaluoedit" class="<?php echo $viewavaluo_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($viewavaluo_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $viewavaluo_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="viewavaluo">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($viewavaluo_edit->IsModal) ?>">
...
<?php } ?>
<?php if (!$viewavaluo_edit->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($viewavaluo_edit->IsMobileOrModal) { ?>
<div class="ewEditDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_viewavaluoedit" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($viewavaluo->id->Visible) { // id ?>
<?php if ($viewavaluo_edit->IsMobileOrModal) { ?>
	<div id="r_id" class="form-group">
		<label id="elh_viewavaluo_id" class="<?php echo $viewavaluo_edit->LeftColumnClass ?>"><?php echo $viewavaluo->id->FldCaption() ?></label>
		<div class="<?php echo $viewavaluo_edit->RightColumnClass ?>"><div<?php echo $viewavaluo->id->CellAttributes() ?>>
<span id="el_viewavaluo_id">
<span<?php echo $viewavaluo->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $viewavaluo->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="viewavaluo" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($viewavaluo->id->CurrentValue) ?>">
<?php echo $viewavaluo->id->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_id">
		<td class="col-sm-3"><span id="elh_viewavaluo_id"><?php echo $viewavaluo->id->FldCaption() ?></span></td>
		<td<?php echo $viewavaluo->id->CellAttributes() ?>>
<span id="el_viewavaluo_id">
<span<?php echo $viewavaluo->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $viewavaluo->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="viewavaluo" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($viewavaluo->id->CurrentValue) ?>">
<?php echo $viewavaluo->id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if ($viewavaluo_edit->IsMobileOrModal) { ?>
	<div id="r_tipoinmueble" class="form-group">
		<label id="elh_viewavaluo_tipoinmueble" for="x_tipoinmueble" class="<?php echo $viewavaluo_edit->LeftColumnClass ?>"><?php echo $viewavaluo->tipoinmueble->FldCaption() ?></label>
		<div class="<?php echo $viewavaluo_edit->RightColumnClass ?>"><div<?php echo $viewavaluo->tipoinmueble->CellAttributes() ?>>
...
<?php if ($viewavaluo_edit->IsMobileOrModal) { ?>
	<div id="r_id_solicitud" class="form-group">
		<label id="elh_viewavaluo_id_solicitud" for="x_id_solicitud" class="<?php echo $viewavaluo_edit->LeftColumnClass ?>"><?php echo $viewavaluo->id_solicitud->FldCaption() ?></label>
		<div class="<?php echo $viewavaluo_edit->RightColumnClass ?>"><div<?php echo $viewavaluo->id_solicitud->CellAttributes() ?>>
...
<?php
	if (in_array("viewdocumentooficialcredito", explode(",", $viewavaluo->getCurrentDetailTable())) && $viewdocumentooficialcredito->DetailEdit) {
?>
...
<?php } ?>
<?php if (!$viewavaluo_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $viewavaluo_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $viewavaluo_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fviewavaluoedit.Init();
</script>
<?php
$viewavaluo_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$viewavaluo_edit->Page_Terminate();
?>
