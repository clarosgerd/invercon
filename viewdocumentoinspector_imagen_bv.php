...
$viewdocumentoinspector_imagen_blobview = NULL; // Initialize page object first

class cviewdocumentoinspector_imagen_blobview extends cviewdocumentoinspector {
	...
	// Page object name
	var $PageObjName = 'viewdocumentoinspector_imagen_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'viewdocumentoinspector');
	...
	function Page_Main() {
		...
		// SQL constructor in viewdocumentoinspector class, viewdocumentoinspectorinfo.php
...
// Create page object
if (!isset($viewdocumentoinspector_imagen_blobview)) $viewdocumentoinspector_imagen_blobview = new cviewdocumentoinspector_imagen_blobview();

// Page init
$viewdocumentoinspector_imagen_blobview->Page_Init();

// Page main
$viewdocumentoinspector_imagen_blobview->Page_Main();
?>
<?php
$viewdocumentoinspector_imagen_blobview->Page_Terminate();
?>
