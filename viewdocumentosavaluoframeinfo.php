...
$viewdocumentosavaluoframe = NULL;

//
// Table class for viewdocumentosavaluoframe
//
class cviewdocumentosavaluoframe extends cTable {
	var $id;
	var $descripcion;
	var $imagen;
	var $avaluo;
	...
	function __construct() {
		...
		$this->TableVar = 'viewdocumentosavaluoframe';
		$this->TableName = 'viewdocumentosavaluoframe';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`viewdocumentosavaluoframe`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('viewdocumentosavaluoframe', 'viewdocumentosavaluoframe', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// descripcion
		$this->descripcion = new cField('viewdocumentosavaluoframe', 'viewdocumentosavaluoframe', 'x_descripcion', 'descripcion', '`descripcion`', '`descripcion`', 201, -1, FALSE, '`descripcion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->descripcion->Sortable = TRUE; // Allow sort
		$this->fields['descripcion'] = &$this->descripcion;

		// imagen
		$this->imagen = new cField('viewdocumentosavaluoframe', 'viewdocumentosavaluoframe', 'x_imagen', 'imagen', '`imagen`', '`imagen`', 205, -1, TRUE, '`imagen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen->Sortable = TRUE; // Allow sort
		$this->fields['imagen'] = &$this->imagen;

		// avaluo
		$this->avaluo = new cField('viewdocumentosavaluoframe', 'viewdocumentosavaluoframe', 'x_avaluo', 'avaluo', '`avaluo`', '`avaluo`', 3, -1, FALSE, '`avaluo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// path_drive
		$this->path_drive = new cField('viewdocumentosavaluoframe', 'viewdocumentosavaluoframe', 'x_path_drive', 'path_drive', '`path_drive`', '`path_drive`', 200, -1, FALSE, '`path_drive`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->path_drive->Sortable = FALSE; // Allow sort
		$this->fields['path_drive'] = &$this->path_drive;

		// id_tipodocumento
		$this->id_tipodocumento = new cField('viewdocumentosavaluoframe', 'viewdocumentosavaluoframe', 'x_id_tipodocumento', 'id_tipodocumento', '`id_tipodocumento`', '`id_tipodocumento`', 3, -1, FALSE, '`id_tipodocumento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// created_at
		$this->created_at = new cField('viewdocumentosavaluoframe', 'viewdocumentosavaluoframe', 'x_created_at', 'created_at', '`created_at`', ew_CastDateFieldForLike('`created_at`', 0, "DB"), 135, 0, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`viewdocumentosavaluoframe`";
	}
	...
	function getSqlWhere() { // Where
		...
		$this->TableFilter = "avaluo='".$_GET["avaluo"]."'";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "viewdocumentosavaluoframelist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "viewdocumentosavaluoframeedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "viewdocumentosavaluoframeadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("viewdocumentosavaluoframeview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("viewdocumentosavaluoframeview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "viewdocumentosavaluoframeadd.php?" . $this->UrlParm($parm);
		else
			$url = "viewdocumentosavaluoframeadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("viewdocumentosavaluoframeedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("viewdocumentosavaluoframeadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("viewdocumentosavaluoframedelete.php", $this->UrlParm());
	}
