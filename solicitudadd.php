...
class csolicitud_add extends csolicitud {
	...
	function RenderRow() {
		...
		$this->email_contacto->ViewCustomAttributes = "";
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->imagen_maquinaria03);
	...
	function AddRow($rsold = NULL) {
		...
		// imagen_maquinaria03
		if ($this->imagen_maquinaria03->Visible && !$this->imagen_maquinaria03->Upload->KeepFile) {
...
<?php if ($solicitud_add->IsMobileOrModal) { ?>
	<div id="r_imagen_maquinaria03" class="form-group">
		<label id="elh_solicitud_imagen_maquinaria03" class="<?php echo $solicitud_add->LeftColumnClass ?>"><?php echo $solicitud->imagen_maquinaria03->FldCaption() ?></label>
		<div class="<?php echo $solicitud_add->RightColumnClass ?>"><div<?php echo $solicitud->imagen_maquinaria03->CellAttributes() ?>>
