...
$viewavaluoinspectorhistorico_update = NULL; // Initialize page object first

class cviewavaluoinspectorhistorico_update extends cviewavaluoinspectorhistorico {
	...
	// Page object name
	var $PageObjName = 'viewavaluoinspectorhistorico_update';
	...
	function Page_Main() {
		...
		if (count($this->RecKeys) <= 0)
			$this->Page_Terminate("viewavaluoinspectorhistoricolist.php"); // No records selected, return to list
		...
		if ($this->Recordset = $this->LoadRecordset()) {
			...
			while (!$this->Recordset->EOF) {
				if ($i == 1) {
					...
					$this->id_sucursal->setDbValue($this->Recordset->fields('id_sucursal'));
				} else {
					...
					if (!ew_CompareValue($this->id_sucursal->DbValue, $this->Recordset->fields('id_sucursal')))
	...
	function LoadFormValues() {
		...
		$this->id_sucursal->MultiUpdate = $objForm->GetValue("u_id_sucursal");
	...
	function ValidateForm() {
		...
		if ($this->id_sucursal->MultiUpdate == "1") $lUpdateCnt++;
		if ($lUpdateCnt == 0) {
...
// Create page object
if (!isset($viewavaluoinspectorhistorico_update)) $viewavaluoinspectorhistorico_update = new cviewavaluoinspectorhistorico_update();

// Page init
$viewavaluoinspectorhistorico_update->Page_Init();

// Page main
$viewavaluoinspectorhistorico_update->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$viewavaluoinspectorhistorico_update->Page_Render();
?>
...
var CurrentForm = fviewavaluoinspectorhistoricoupdate = new ew_Form("fviewavaluoinspectorhistoricoupdate", "update");

// Validate form
fviewavaluoinspectorhistoricoupdate.Validate = function() {
...
fviewavaluoinspectorhistoricoupdate.Form_CustomValidate = 
...
fviewavaluoinspectorhistoricoupdate.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fviewavaluoinspectorhistoricoupdate.Lists["x_estadointerno"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_descripcion","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"estadointerno"};
fviewavaluoinspectorhistoricoupdate.Lists["x_estadointerno"].Data = "<?php echo $viewavaluoinspectorhistorico_update->estadointerno->LookupFilterQuery(FALSE, "update") ?>";
...
<?php $viewavaluoinspectorhistorico_update->ShowPageHeader(); ?>
<?php
$viewavaluoinspectorhistorico_update->ShowMessage();
?>
<form name="fviewavaluoinspectorhistoricoupdate" id="fviewavaluoinspectorhistoricoupdate" class="<?php echo $viewavaluoinspectorhistorico_update->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($viewavaluoinspectorhistorico_update->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $viewavaluoinspectorhistorico_update->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="viewavaluoinspectorhistorico">
<input type="hidden" name="a_update" id="a_update" value="U">
<input type="hidden" name="modal" value="<?php echo intval($viewavaluoinspectorhistorico_update->IsModal) ?>">
<?php foreach ($viewavaluoinspectorhistorico_update->RecKeys as $key) { ?>
<?php $keyvalue = is_array($key) ? implode($EW_COMPOSITE_KEY_SEPARATOR, $key) : $key; ?>
<input type="hidden" name="key_m[]" value="<?php echo ew_HtmlEncode($keyvalue) ?>">
<?php } ?>
<?php if (!$viewavaluoinspectorhistorico_update->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($viewavaluoinspectorhistorico_update->IsMobileOrModal) { ?>
<div id="tbl_viewavaluoinspectorhistoricoupdate" class="ewUpdateDiv"><!-- page -->
	<div class="checkbox">
		<label><input type="checkbox" name="u" id="u" onclick="ew_SelectAll(this);"> <?php echo $Language->Phrase("UpdateSelectAll") ?></label>
	</div>
<?php } else { ?>
<table id="tbl_viewavaluoinspectorhistoricoupdate" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- desktop table -->
	<thead>
	<tr>
...
<?php if ($viewavaluoinspectorhistorico_update->IsMobileOrModal) { ?>
	<div id="r_estadointerno" class="form-group">
		<label for="x_estadointerno" class="<?php echo $viewavaluoinspectorhistorico_update->LeftColumnClass ?>"><div class="checkbox"><label>
<input type="checkbox" name="u_estadointerno" id="u_estadointerno" class="ewMultiSelect" value="1"<?php echo ($viewavaluoinspectorhistorico->estadointerno->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewavaluoinspectorhistorico->estadointerno->FldCaption() ?></label></div></label>
		<div class="<?php echo $viewavaluoinspectorhistorico_update->RightColumnClass ?>"><div<?php echo $viewavaluoinspectorhistorico->estadointerno->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_estadointerno">
		<td class="col-sm-3"<?php echo $viewavaluoinspectorhistorico->estadointerno->CellAttributes() ?>><span id="elh_viewavaluoinspectorhistorico_estadointerno"><div class="checkbox"><label for="u_estadointerno">
<input type="checkbox" name="u_estadointerno" id="u_estadointerno" class="ewMultiSelect" value="1"<?php echo ($viewavaluoinspectorhistorico->estadointerno->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewavaluoinspectorhistorico->estadointerno->FldCaption() ?></label></div></span></td>
...
<?php if ($viewavaluoinspectorhistorico_update->IsMobileOrModal) { ?>
	<div id="r_comentario" class="form-group">
		<label for="x_comentario" class="<?php echo $viewavaluoinspectorhistorico_update->LeftColumnClass ?>"><div class="checkbox"><label>
<input type="checkbox" name="u_comentario" id="u_comentario" class="ewMultiSelect" value="1"<?php echo ($viewavaluoinspectorhistorico->comentario->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewavaluoinspectorhistorico->comentario->FldCaption() ?></label></div></label>
		<div class="<?php echo $viewavaluoinspectorhistorico_update->RightColumnClass ?>"><div<?php echo $viewavaluoinspectorhistorico->comentario->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_comentario">
		<td class="col-sm-3"<?php echo $viewavaluoinspectorhistorico->comentario->CellAttributes() ?>><span id="elh_viewavaluoinspectorhistorico_comentario"><div class="checkbox"><label for="u_comentario">
<input type="checkbox" name="u_comentario" id="u_comentario" class="ewMultiSelect" value="1"<?php echo ($viewavaluoinspectorhistorico->comentario->MultiUpdate == "1") ? " checked" : "" ?>>
 <?php echo $viewavaluoinspectorhistorico->comentario->FldCaption() ?></label></div></span></td>
...
<?php } ?>
<?php if (!$viewavaluoinspectorhistorico_update->IsModal) { ?>
	<div class="form-group"><!-- buttons .form-group -->
		<div class="<?php echo $viewavaluoinspectorhistorico_update->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("UpdateBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $viewavaluoinspectorhistorico_update->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
		</div><!-- /buttons offset -->
...
<script type="text/javascript">
fviewavaluoinspectorhistoricoupdate.Init();
</script>
<?php
$viewavaluoinspectorhistorico_update->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$viewavaluoinspectorhistorico_update->Page_Terminate();
?>
