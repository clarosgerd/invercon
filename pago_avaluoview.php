...
$pago_avaluo_view = NULL; // Initialize page object first

class cpago_avaluo_view extends cpago_avaluo {
	...
	// Page object name
	var $PageObjName = 'pago_avaluo_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			$sReturnUrl = "pago_avaluolist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($pago_avaluo_view)) $pago_avaluo_view = new cpago_avaluo_view();

// Page init
$pago_avaluo_view->Page_Init();

// Page main
$pago_avaluo_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$pago_avaluo_view->Page_Render();
?>
...
var CurrentForm = fpago_avaluoview = new ew_Form("fpago_avaluoview", "view");

// Form_CustomValidate event
fpago_avaluoview.Form_CustomValidate = 
...
fpago_avaluoview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpago_avaluoview.Lists["x_pago_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_code","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"pago"};
fpago_avaluoview.Lists["x_pago_id"].Data = "<?php echo $pago_avaluo_view->pago_id->LookupFilterQuery(FALSE, "view") ?>";
fpago_avaluoview.Lists["x_avaluo_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_codigoavaluo","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"avaluo"};
fpago_avaluoview.Lists["x_avaluo_id"].Data = "<?php echo $pago_avaluo_view->avaluo_id->LookupFilterQuery(FALSE, "view") ?>";
...
<div class="ewToolbar">
<?php $pago_avaluo_view->ExportOptions->Render("body") ?>
<?php
	foreach ($pago_avaluo_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $pago_avaluo_view->ShowPageHeader(); ?>
<?php
$pago_avaluo_view->ShowMessage();
?>
<form name="fpago_avaluoview" id="fpago_avaluoview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($pago_avaluo_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $pago_avaluo_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="pago_avaluo">
<input type="hidden" name="modal" value="<?php echo intval($pago_avaluo_view->IsModal) ?>">
...
<?php echo $pago_avaluo->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $pago_avaluo->pago_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $pago_avaluo->avaluo_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $pago_avaluo->q->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
$pago_avaluo_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$pago_avaluo_view->Page_Terminate();
?>
