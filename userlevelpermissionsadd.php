...
class cuserlevelpermissions_add extends cuserlevelpermissions {
	...
	function RenderRow() {
		...
		$this->permission->ViewCustomAttributes = "";
			...
			$this->userlevelid->PlaceHolder = ew_RemoveHtml($this->userlevelid->FldTitle());
			...
			$this->_tablename->PlaceHolder = ew_RemoveHtml($this->_tablename->FldTitle());
			...
			$this->permission->PlaceHolder = ew_RemoveHtml($this->permission->FldTitle());
...
<?php } else { ?>
	<tr id="r_userlevelid">
		<td class="col-sm-3"><span id="elh_userlevelpermissions_userlevelid"><?php echo $userlevelpermissions->userlevelid->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
...
<?php } else { ?>
	<tr id="r__tablename">
		<td class="col-sm-3"><span id="elh_userlevelpermissions__tablename"><?php echo $userlevelpermissions->_tablename->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
...
<?php } else { ?>
	<tr id="r_permission">
		<td class="col-sm-3"><span id="elh_userlevelpermissions_permission"><?php echo $userlevelpermissions->permission->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
