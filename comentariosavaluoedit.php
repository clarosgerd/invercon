...
$comentariosavaluo_edit = NULL; // Initialize page object first

class ccomentariosavaluo_edit extends ccomentariosavaluo {
	...
	// Page object name
	var $PageObjName = 'comentariosavaluo_edit';
...
// Create page object
if (!isset($comentariosavaluo_edit)) $comentariosavaluo_edit = new ccomentariosavaluo_edit();

// Page init
$comentariosavaluo_edit->Page_Init();

// Page main
$comentariosavaluo_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$comentariosavaluo_edit->Page_Render();
?>
...
var CurrentForm = fcomentariosavaluoedit = new ew_Form("fcomentariosavaluoedit", "edit");

// Validate form
fcomentariosavaluoedit.Validate = function() {
...
fcomentariosavaluoedit.Form_CustomValidate = 
...
<?php $comentariosavaluo_edit->ShowPageHeader(); ?>
<?php
$comentariosavaluo_edit->ShowMessage();
?>
<form name="fcomentariosavaluoedit" id="fcomentariosavaluoedit" class="<?php echo $comentariosavaluo_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($comentariosavaluo_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $comentariosavaluo_edit->Token ?>">
<?php } ?>
...
<?php } else { ?>
<table id="tbl_comentariosavaluoedit" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($comentariosavaluo->id->Visible) { // id ?>
<?php if ($comentariosavaluo_edit->IsMobileOrModal) { ?>
	<div id="r_id" class="form-group">
		<label id="elh_comentariosavaluo_id" class="<?php echo $comentariosavaluo_edit->LeftColumnClass ?>"><?php echo $comentariosavaluo->id->FldCaption() ?></label>
		<div class="<?php echo $comentariosavaluo_edit->RightColumnClass ?>"><div<?php echo $comentariosavaluo->id->CellAttributes() ?>>
<span id="el_comentariosavaluo_id">
...
<input type="hidden" data-table="comentariosavaluo" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($comentariosavaluo->id->CurrentValue) ?>">
<?php echo $comentariosavaluo->id->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_id">
		<td class="col-sm-3"><span id="elh_comentariosavaluo_id"><?php echo $comentariosavaluo->id->FldCaption() ?></span></td>
		<td<?php echo $comentariosavaluo->id->CellAttributes() ?>>
<span id="el_comentariosavaluo_id">
<span<?php echo $comentariosavaluo->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $comentariosavaluo->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="comentariosavaluo" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($comentariosavaluo->id->CurrentValue) ?>">
<?php echo $comentariosavaluo->id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if ($comentariosavaluo_edit->IsMobileOrModal) { ?>
	<div id="r_descripcion" class="form-group">
		<label id="elh_comentariosavaluo_descripcion" for="x_descripcion" class="<?php echo $comentariosavaluo_edit->LeftColumnClass ?>"><?php echo $comentariosavaluo->descripcion->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $comentariosavaluo_edit->RightColumnClass ?>"><div<?php echo $comentariosavaluo->descripcion->CellAttributes() ?>>
...
<?php if ($comentariosavaluo_edit->IsMobileOrModal) { ?>
	<div id="r_created_at" class="form-group">
		<label id="elh_comentariosavaluo_created_at" for="x_created_at" class="<?php echo $comentariosavaluo_edit->LeftColumnClass ?>"><?php echo $comentariosavaluo->created_at->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $comentariosavaluo_edit->RightColumnClass ?>"><div<?php echo $comentariosavaluo->created_at->CellAttributes() ?>>
...
<?php } ?>
<?php if (!$comentariosavaluo_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $comentariosavaluo_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $comentariosavaluo_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
<script type="text/javascript">
fcomentariosavaluoedit.Init();
</script>
<?php
$comentariosavaluo_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$comentariosavaluo_edit->Page_Terminate();
?>
