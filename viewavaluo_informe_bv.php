...
$viewavaluo_informe_blobview = NULL; // Initialize page object first

class cviewavaluo_informe_blobview extends cviewavaluo {
	...
	// Page object name
	var $PageObjName = 'viewavaluo_informe_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'viewavaluo');
	...
	function Page_Main() {
		...
		// SQL constructor in viewavaluo class, viewavaluoinfo.php
...
// Create page object
if (!isset($viewavaluo_informe_blobview)) $viewavaluo_informe_blobview = new cviewavaluo_informe_blobview();

// Page init
$viewavaluo_informe_blobview->Page_Init();

// Page main
$viewavaluo_informe_blobview->Page_Main();
?>
<?php
$viewavaluo_informe_blobview->Page_Terminate();
?>
