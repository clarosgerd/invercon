...
<?php if ($userlevels->userlevelid->Visible) { // userlevelid ?>
	<tr id="r_userlevelid">
		<td class="col-sm-3"><span id="elh_userlevels_userlevelid"><?php echo $userlevels->userlevelid->FldCaption() ?></span></td>
...
<?php if ($userlevels->userlevelname->Visible) { // userlevelname ?>
	<tr id="r_userlevelname">
		<td class="col-sm-3"><span id="elh_userlevels_userlevelname"><?php echo $userlevels->userlevelname->FldCaption() ?></span></td>
...
<?php if (!isset($userlevels_view->Pager)) $userlevels_view->Pager = new cNumericPager($userlevels_view->StartRec, $userlevels_view->DisplayRecs, $userlevels_view->TotalRecs, $userlevels_view->RecRange, $userlevels_view->AutoHidePager) ?>
