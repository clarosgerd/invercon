...
fsucursaladd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($sucursal_add->IsModal) ?>">
<?php if (!$sucursal_add->IsMobileOrModal) { ?>
<div class="ewDesktop"><!-- desktop -->
<?php } ?>
<?php if ($sucursal_add->IsMobileOrModal) { ?>
<div class="ewAddDiv"><!-- page* -->
<?php } else { ?>
<table id="tbl_sucursaladd" class="table table-striped table-bordered table-hover table-condensed ewDesktopTable"><!-- table* -->
<?php } ?>
<?php if ($sucursal->nombre->Visible) { // nombre ?>
<?php if ($sucursal_add->IsMobileOrModal) { ?>
	<div id="r_nombre" class="form-group">
		<label id="elh_sucursal_nombre" for="x_nombre" class="<?php echo $sucursal_add->LeftColumnClass ?>"><?php echo $sucursal->nombre->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $sucursal_add->RightColumnClass ?>"><div<?php echo $sucursal->nombre->CellAttributes() ?>>
...
<?php if ($sucursal_add->IsMobileOrModal) { ?>
	<div id="r_direccion" class="form-group">
		<label id="elh_sucursal_direccion" for="x_direccion" class="<?php echo $sucursal_add->LeftColumnClass ?>"><?php echo $sucursal->direccion->FldCaption() ?></label>
		<div class="<?php echo $sucursal_add->RightColumnClass ?>"><div<?php echo $sucursal->direccion->CellAttributes() ?>>
...
<?php if ($sucursal_add->IsMobileOrModal) { ?>
	<div id="r_nombre_contacto" class="form-group">
		<label id="elh_sucursal_nombre_contacto" for="x_nombre_contacto" class="<?php echo $sucursal_add->LeftColumnClass ?>"><?php echo $sucursal->nombre_contacto->FldCaption() ?></label>
		<div class="<?php echo $sucursal_add->RightColumnClass ?>"><div<?php echo $sucursal->nombre_contacto->CellAttributes() ?>>
...
<?php if ($sucursal_add->IsMobileOrModal) { ?>
	<div id="r_email_contacto" class="form-group">
		<label id="elh_sucursal_email_contacto" for="x_email_contacto" class="<?php echo $sucursal_add->LeftColumnClass ?>"><?php echo $sucursal->email_contacto->FldCaption() ?></label>
		<div class="<?php echo $sucursal_add->RightColumnClass ?>"><div<?php echo $sucursal->email_contacto->CellAttributes() ?>>
...
<?php } ?>
<?php if (!$sucursal_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $sucursal_add->OffsetColumnClass ?>"><!-- buttons offset -->
