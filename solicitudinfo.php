...
class csolicitud extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('solicitud', 'solicitud', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// address
		$this->address = new cField('solicitud', 'solicitud', 'x_address', 'address', '`address`', '`address`', 200, -1, FALSE, '`address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->address->Sortable = TRUE; // Allow sort
		$this->fields['address'] = &$this->address;

		// phone
		$this->phone = new cField('solicitud', 'solicitud', 'x_phone', 'phone', '`phone`', '`phone`', 200, -1, FALSE, '`phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->phone->Sortable = TRUE; // Allow sort
		$this->fields['phone'] = &$this->phone;

		// cell
		$this->cell = new cField('solicitud', 'solicitud', 'x_cell', 'cell', '`cell`', '`cell`', 200, -1, FALSE, '`cell`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->cell->Sortable = TRUE; // Allow sort
		$this->fields['cell'] = &$this->cell;

		// is_active
		$this->is_active = new cField('solicitud', 'solicitud', 'x_is_active', 'is_active', '`is_active`', '`is_active`', 16, -1, FALSE, '`is_active`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// documentos
		$this->documentos = new cField('solicitud', 'solicitud', 'x_documentos', 'documentos', '`documentos`', '`documentos`', 200, -1, FALSE, '`documentos`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->documentos->Sortable = FALSE; // Allow sort
		$this->documentos->FldSelectMultiple = TRUE; // Multiple select
		$this->fields['documentos'] = &$this->documentos;

		// DateModified
		$this->DateModified = new cField('solicitud', 'solicitud', 'x_DateModified', 'DateModified', '`DateModified`', ew_CastDateFieldForLike('`DateModified`', 0, "DB"), 135, 0, FALSE, '`DateModified`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DateDeleted
		$this->DateDeleted = new cField('solicitud', 'solicitud', 'x_DateDeleted', 'DateDeleted', '`DateDeleted`', ew_CastDateFieldForLike('`DateDeleted`', 0, "DB"), 135, 0, FALSE, '`DateDeleted`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CreatedBy
		$this->CreatedBy = new cField('solicitud', 'solicitud', 'x_CreatedBy', 'CreatedBy', '`CreatedBy`', '`CreatedBy`', 200, -1, FALSE, '`CreatedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreatedBy->Sortable = FALSE; // Allow sort
		$this->fields['CreatedBy'] = &$this->CreatedBy;

		// ModifiedBy
		$this->ModifiedBy = new cField('solicitud', 'solicitud', 'x_ModifiedBy', 'ModifiedBy', '`ModifiedBy`', '`ModifiedBy`', 200, -1, FALSE, '`ModifiedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ModifiedBy->Sortable = FALSE; // Allow sort
		$this->fields['ModifiedBy'] = &$this->ModifiedBy;

		// DeletedBy
		$this->DeletedBy = new cField('solicitud', 'solicitud', 'x_DeletedBy', 'DeletedBy', '`DeletedBy`', '`DeletedBy`', 200, -1, FALSE, '`DeletedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DeletedBy->Sortable = FALSE; // Allow sort
		$this->fields['DeletedBy'] = &$this->DeletedBy;

		// latitud
		$this->latitud = new cField('solicitud', 'solicitud', 'x_latitud', 'latitud', '`latitud`', '`latitud`', 5, -1, FALSE, '`latitud`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// longitud
		$this->longitud = new cField('solicitud', 'solicitud', 'x_longitud', 'longitud', '`longitud`', '`longitud`', 5, -1, FALSE, '`longitud`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tipoinmueble
		$this->tipoinmueble = new cField('solicitud', 'solicitud', 'x_tipoinmueble', 'tipoinmueble', '`tipoinmueble`', '`tipoinmueble`', 200, -1, FALSE, '`tipoinmueble`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// id_ciudad_inmueble
		$this->id_ciudad_inmueble = new cField('solicitud', 'solicitud', 'x_id_ciudad_inmueble', 'id_ciudad_inmueble', '`id_ciudad_inmueble`', '`id_ciudad_inmueble`', 3, -1, FALSE, '`id_ciudad_inmueble`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->id_provincia_inmueble = new cField('solicitud', 'solicitud', 'x_id_provincia_inmueble', 'id_provincia_inmueble', '`id_provincia_inmueble`', '`id_provincia_inmueble`', 3, -1, FALSE, '`id_provincia_inmueble`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// imagen_inmueble01
		$this->imagen_inmueble01 = new cField('solicitud', 'solicitud', 'x_imagen_inmueble01', 'imagen_inmueble01', '`imagen_inmueble01`', '`imagen_inmueble01`', 205, -1, TRUE, '`imagen_inmueble01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_inmueble01->Sortable = FALSE; // Allow sort
		$this->fields['imagen_inmueble01'] = &$this->imagen_inmueble01;

		// imagen_inmueble02
		$this->imagen_inmueble02 = new cField('solicitud', 'solicitud', 'x_imagen_inmueble02', 'imagen_inmueble02', '`imagen_inmueble02`', '`imagen_inmueble02`', 205, -1, TRUE, '`imagen_inmueble02`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_inmueble02->Sortable = TRUE; // Allow sort
		$this->fields['imagen_inmueble02'] = &$this->imagen_inmueble02;

		// imagen_inmueble03
		$this->imagen_inmueble03 = new cField('solicitud', 'solicitud', 'x_imagen_inmueble03', 'imagen_inmueble03', '`imagen_inmueble03`', '`imagen_inmueble03`', 205, -1, TRUE, '`imagen_inmueble03`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_inmueble03->Sortable = TRUE; // Allow sort
		$this->fields['imagen_inmueble03'] = &$this->imagen_inmueble03;

		// imagen_inmueble04
		$this->imagen_inmueble04 = new cField('solicitud', 'solicitud', 'x_imagen_inmueble04', 'imagen_inmueble04', '`imagen_inmueble04`', '`imagen_inmueble04`', 205, -1, TRUE, '`imagen_inmueble04`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_inmueble04->Sortable = TRUE; // Allow sort
		$this->fields['imagen_inmueble04'] = &$this->imagen_inmueble04;

		// imagen_inmueble05
		$this->imagen_inmueble05 = new cField('solicitud', 'solicitud', 'x_imagen_inmueble05', 'imagen_inmueble05', '`imagen_inmueble05`', '`imagen_inmueble05`', 205, -1, TRUE, '`imagen_inmueble05`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_inmueble05->Sortable = TRUE; // Allow sort
		$this->fields['imagen_inmueble05'] = &$this->imagen_inmueble05;

		// imagen_inmueble06
		$this->imagen_inmueble06 = new cField('solicitud', 'solicitud', 'x_imagen_inmueble06', 'imagen_inmueble06', '`imagen_inmueble06`', '`imagen_inmueble06`', 205, -1, TRUE, '`imagen_inmueble06`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_inmueble06->Sortable = FALSE; // Allow sort
		$this->fields['imagen_inmueble06'] = &$this->imagen_inmueble06;

		// imagen_inmueble07
		$this->imagen_inmueble07 = new cField('solicitud', 'solicitud', 'x_imagen_inmueble07', 'imagen_inmueble07', '`imagen_inmueble07`', '`imagen_inmueble07`', 205, -1, TRUE, '`imagen_inmueble07`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_inmueble07->Sortable = FALSE; // Allow sort
		$this->fields['imagen_inmueble07'] = &$this->imagen_inmueble07;

		// imagen_inmueble08
		$this->imagen_inmueble08 = new cField('solicitud', 'solicitud', 'x_imagen_inmueble08', 'imagen_inmueble08', '`imagen_inmueble08`', '`imagen_inmueble08`', 205, -1, TRUE, '`imagen_inmueble08`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_inmueble08->Sortable = FALSE; // Allow sort
		$this->fields['imagen_inmueble08'] = &$this->imagen_inmueble08;

		// tipovehiculo
		$this->tipovehiculo = new cField('solicitud', 'solicitud', 'x_tipovehiculo', 'tipovehiculo', '`tipovehiculo`', '`tipovehiculo`', 200, -1, FALSE, '`tipovehiculo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// id_ciudad_vehiculo
		$this->id_ciudad_vehiculo = new cField('solicitud', 'solicitud', 'x_id_ciudad_vehiculo', 'id_ciudad_vehiculo', '`id_ciudad_vehiculo`', '`id_ciudad_vehiculo`', 3, -1, FALSE, '`id_ciudad_vehiculo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->id_provincia_vehiculo = new cField('solicitud', 'solicitud', 'x_id_provincia_vehiculo', 'id_provincia_vehiculo', '`id_provincia_vehiculo`', '`id_provincia_vehiculo`', 3, -1, FALSE, '`id_provincia_vehiculo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// imagen_vehiculo01
		$this->imagen_vehiculo01 = new cField('solicitud', 'solicitud', 'x_imagen_vehiculo01', 'imagen_vehiculo01', '`imagen_vehiculo01`', '`imagen_vehiculo01`', 205, -1, TRUE, '`imagen_vehiculo01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_vehiculo01->Sortable = FALSE; // Allow sort
		$this->fields['imagen_vehiculo01'] = &$this->imagen_vehiculo01;

		// imagen_vehiculo02
		$this->imagen_vehiculo02 = new cField('solicitud', 'solicitud', 'x_imagen_vehiculo02', 'imagen_vehiculo02', '`imagen_vehiculo02`', '`imagen_vehiculo02`', 205, -1, TRUE, '`imagen_vehiculo02`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_vehiculo02->Sortable = TRUE; // Allow sort
		$this->fields['imagen_vehiculo02'] = &$this->imagen_vehiculo02;

		// imagen_vehiculo03
		$this->imagen_vehiculo03 = new cField('solicitud', 'solicitud', 'x_imagen_vehiculo03', 'imagen_vehiculo03', '`imagen_vehiculo03`', '`imagen_vehiculo03`', 205, -1, TRUE, '`imagen_vehiculo03`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_vehiculo03->Sortable = FALSE; // Allow sort
		$this->fields['imagen_vehiculo03'] = &$this->imagen_vehiculo03;

		// imagen_vehiculo04
		$this->imagen_vehiculo04 = new cField('solicitud', 'solicitud', 'x_imagen_vehiculo04', 'imagen_vehiculo04', '`imagen_vehiculo04`', '`imagen_vehiculo04`', 205, -1, TRUE, '`imagen_vehiculo04`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_vehiculo04->Sortable = FALSE; // Allow sort
		$this->fields['imagen_vehiculo04'] = &$this->imagen_vehiculo04;

		// imagen_vehiculo05
		$this->imagen_vehiculo05 = new cField('solicitud', 'solicitud', 'x_imagen_vehiculo05', 'imagen_vehiculo05', '`imagen_vehiculo05`', '`imagen_vehiculo05`', 205, -1, TRUE, '`imagen_vehiculo05`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_vehiculo05->Sortable = TRUE; // Allow sort
		$this->fields['imagen_vehiculo05'] = &$this->imagen_vehiculo05;

		// imagen_vehiculo06
		$this->imagen_vehiculo06 = new cField('solicitud', 'solicitud', 'x_imagen_vehiculo06', 'imagen_vehiculo06', '`imagen_vehiculo06`', '`imagen_vehiculo06`', 205, -1, TRUE, '`imagen_vehiculo06`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_vehiculo06->Sortable = TRUE; // Allow sort
		$this->fields['imagen_vehiculo06'] = &$this->imagen_vehiculo06;

		// imagen_vehiculo07
		$this->imagen_vehiculo07 = new cField('solicitud', 'solicitud', 'x_imagen_vehiculo07', 'imagen_vehiculo07', '`imagen_vehiculo07`', '`imagen_vehiculo07`', 205, -1, TRUE, '`imagen_vehiculo07`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_vehiculo07->Sortable = TRUE; // Allow sort
		$this->fields['imagen_vehiculo07'] = &$this->imagen_vehiculo07;

		// imagen_vehiculo08
		$this->imagen_vehiculo08 = new cField('solicitud', 'solicitud', 'x_imagen_vehiculo08', 'imagen_vehiculo08', '`imagen_vehiculo08`', '`imagen_vehiculo08`', 205, -1, TRUE, '`imagen_vehiculo08`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_vehiculo08->Sortable = FALSE; // Allow sort
		$this->fields['imagen_vehiculo08'] = &$this->imagen_vehiculo08;

		// tipomaquinaria
		$this->tipomaquinaria = new cField('solicitud', 'solicitud', 'x_tipomaquinaria', 'tipomaquinaria', '`tipomaquinaria`', '`tipomaquinaria`', 200, -1, FALSE, '`tipomaquinaria`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->id_ciudad_maquinaria = new cField('solicitud', 'solicitud', 'x_id_ciudad_maquinaria', 'id_ciudad_maquinaria', '`id_ciudad_maquinaria`', '`id_ciudad_maquinaria`', 3, -1, FALSE, '`id_ciudad_maquinaria`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->id_provincia_maquinaria = new cField('solicitud', 'solicitud', 'x_id_provincia_maquinaria', 'id_provincia_maquinaria', '`id_provincia_maquinaria`', '`id_provincia_maquinaria`', 3, -1, FALSE, '`id_provincia_maquinaria`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// imagen_maquinaria01
		$this->imagen_maquinaria01 = new cField('solicitud', 'solicitud', 'x_imagen_maquinaria01', 'imagen_maquinaria01', '`imagen_maquinaria01`', '`imagen_maquinaria01`', 205, -1, TRUE, '`imagen_maquinaria01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_maquinaria01->Sortable = FALSE; // Allow sort
		$this->fields['imagen_maquinaria01'] = &$this->imagen_maquinaria01;

		// imagen_maquinaria02
		$this->imagen_maquinaria02 = new cField('solicitud', 'solicitud', 'x_imagen_maquinaria02', 'imagen_maquinaria02', '`imagen_maquinaria02`', '`imagen_maquinaria02`', 205, -1, TRUE, '`imagen_maquinaria02`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_maquinaria02->Sortable = TRUE; // Allow sort
		...
		// imagen_maquinaria04
		$this->imagen_maquinaria04 = new cField('solicitud', 'solicitud', 'x_imagen_maquinaria04', 'imagen_maquinaria04', '`imagen_maquinaria04`', '`imagen_maquinaria04`', 205, -1, TRUE, '`imagen_maquinaria04`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_maquinaria04->Sortable = FALSE; // Allow sort
		$this->fields['imagen_maquinaria04'] = &$this->imagen_maquinaria04;

		// imagen_maquinaria05
		$this->imagen_maquinaria05 = new cField('solicitud', 'solicitud', 'x_imagen_maquinaria05', 'imagen_maquinaria05', '`imagen_maquinaria05`', '`imagen_maquinaria05`', 205, -1, TRUE, '`imagen_maquinaria05`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_maquinaria05->Sortable = TRUE; // Allow sort
		$this->fields['imagen_maquinaria05'] = &$this->imagen_maquinaria05;

		// imagen_maquinaria06
		$this->imagen_maquinaria06 = new cField('solicitud', 'solicitud', 'x_imagen_maquinaria06', 'imagen_maquinaria06', '`imagen_maquinaria06`', '`imagen_maquinaria06`', 205, -1, TRUE, '`imagen_maquinaria06`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_maquinaria06->Sortable = TRUE; // Allow sort
		$this->fields['imagen_maquinaria06'] = &$this->imagen_maquinaria06;

		// imagen_maquinaria07
		$this->imagen_maquinaria07 = new cField('solicitud', 'solicitud', 'x_imagen_maquinaria07', 'imagen_maquinaria07', '`imagen_maquinaria07`', '`imagen_maquinaria07`', 205, -1, TRUE, '`imagen_maquinaria07`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_maquinaria07->Sortable = TRUE; // Allow sort
		$this->fields['imagen_maquinaria07'] = &$this->imagen_maquinaria07;

		// imagen_maquinaria08
		$this->imagen_maquinaria08 = new cField('solicitud', 'solicitud', 'x_imagen_maquinaria08', 'imagen_maquinaria08', '`imagen_maquinaria08`', '`imagen_maquinaria08`', 205, -1, TRUE, '`imagen_maquinaria08`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_maquinaria08->Sortable = FALSE; // Allow sort
		$this->fields['imagen_maquinaria08'] = &$this->imagen_maquinaria08;

		// tipomercaderia
		$this->tipomercaderia = new cField('solicitud', 'solicitud', 'x_tipomercaderia', 'tipomercaderia', '`tipomercaderia`', '`tipomercaderia`', 200, -1, FALSE, '`tipomercaderia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// imagen_mercaderia01
		$this->imagen_mercaderia01 = new cField('solicitud', 'solicitud', 'x_imagen_mercaderia01', 'imagen_mercaderia01', '`imagen_mercaderia01`', '`imagen_mercaderia01`', 205, -1, TRUE, '`imagen_mercaderia01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_mercaderia01->Sortable = TRUE; // Allow sort
		$this->fields['imagen_mercaderia01'] = &$this->imagen_mercaderia01;

		// documento_mercaderia
		$this->documento_mercaderia = new cField('solicitud', 'solicitud', 'x_documento_mercaderia', 'documento_mercaderia', '`documento_mercaderia`', '`documento_mercaderia`', 200, -1, FALSE, '`documento_mercaderia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->documento_mercaderia->Sortable = TRUE; // Allow sort
		$this->fields['documento_mercaderia'] = &$this->documento_mercaderia;

		// tipoespecial
		$this->tipoespecial = new cField('solicitud', 'solicitud', 'x_tipoespecial', 'tipoespecial', '`tipoespecial`', '`tipoespecial`', 200, -1, FALSE, '`tipoespecial`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->tipoespecial->Sortable = TRUE; // Allow sort
		$this->tipoespecial->FldSelectMultiple = TRUE; // Multiple select
		...
		$this->imagen_tipoespecial01 = new cField('solicitud', 'solicitud', 'x_imagen_tipoespecial01', 'imagen_tipoespecial01', '`imagen_tipoespecial01`', '`imagen_tipoespecial01`', 205, -1, TRUE, '`imagen_tipoespecial01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->imagen_tipoespecial01->Sortable = TRUE; // Allow sort
		$this->fields['imagen_tipoespecial01'] = &$this->imagen_tipoespecial01;

		// email_contacto
		$this->email_contacto = new cField('solicitud', 'solicitud', 'x_email_contacto', 'email_contacto', '`email_contacto`', '`email_contacto`', 200, -1, FALSE, '`email_contacto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->email_contacto->Sortable = TRUE; // Allow sort
		$this->email_contacto->UsePleaseSelect = TRUE; // Use PleaseSelect by default
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "avaluo") {
			$sDetailUrl = $GLOBALS["avaluo"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "solicitudlist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`solicitud`";
	}
	...
	function getSqlWhere() { // Where
		...
		$this->TableFilter = "`is_active`= '0' AND `id_sucursal`='".$_SESSION["sucursal"]."'";
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "solicitudedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "solicitudadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("solicitudview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("solicitudview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "solicitudadd.php?" . $this->UrlParm($parm);
		else
			$url = "solicitudadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("solicitudedit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("solicitudedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("solicitudadd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("solicitudadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("solicituddelete.php", $this->UrlParm());
	}
	...
	// Common render codes
		...
		if (strval($this->is_active->CurrentValue) <> "") {
			$this->is_active->ViewValue = "";
			$arwrk = explode(",", strval($this->is_active->CurrentValue));
			$cnt = count($arwrk);
			for ($ari = 0; $ari < $cnt; $ari++) {
				$this->is_active->ViewValue .= $this->is_active->OptionCaption(trim($arwrk[$ari]));
				if ($ari < $cnt-1) $this->is_active->ViewValue .= ew_ViewOptionSeparator($ari);
			}
		} else {
		...
		// documentos
		if (strval($this->documentos->CurrentValue) <> "") {
			$arwrk = explode(",", $this->documentos->CurrentValue);
			$sFilterWrk = "";
		...
		if ($sWhereWrk <> "") $sSqlWrk .= " WHERE " . $sWhereWrk;
			$rswrk = Conn()->Execute($sSqlWrk);
			if ($rswrk && !$rswrk->EOF) { // Lookup values found
				$this->documentos->ViewValue = "";
				$ari = 0;
				while (!$rswrk->EOF) {
					$arwrk = array();
					$arwrk[1] = $rswrk->fields('DispFld');
					$this->documentos->ViewValue .= $this->documentos->DisplayValue($arwrk);
					$rswrk->MoveNext();
					if (!$rswrk->EOF) $this->documentos->ViewValue .= ew_ViewOptionSeparator($ari); // Separate Options
					$ari++;
				}
				$rswrk->Close();
			} else {
			...
			$this->documentos->ViewValue = NULL;
		}
		...
		if (!ew_Empty($this->imagen_inmueble01->Upload->DbValue)) {
			$this->imagen_inmueble01->ViewValue = "solicitud_imagen_inmueble01_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_inmueble06->Upload->DbValue)) {
			$this->imagen_inmueble06->ViewValue = "solicitud_imagen_inmueble06_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_inmueble07->Upload->DbValue)) {
			$this->imagen_inmueble07->ViewValue = "solicitud_imagen_inmueble07_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_inmueble08->Upload->DbValue)) {
			$this->imagen_inmueble08->ViewValue = "solicitud_imagen_inmueble08_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_vehiculo01->Upload->DbValue)) {
			$this->imagen_vehiculo01->ViewValue = "solicitud_imagen_vehiculo01_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_vehiculo04->Upload->DbValue)) {
			$this->imagen_vehiculo04->ViewValue = "solicitud_imagen_vehiculo04_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_vehiculo08->Upload->DbValue)) {
			$this->imagen_vehiculo08->ViewValue = "solicitud_imagen_vehiculo08_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_maquinaria01->Upload->DbValue)) {
			$this->imagen_maquinaria01->ViewValue = "solicitud_imagen_maquinaria01_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_maquinaria04->Upload->DbValue)) {
			$this->imagen_maquinaria04->ViewValue = "solicitud_imagen_maquinaria04_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!ew_Empty($this->imagen_maquinaria08->Upload->DbValue)) {
			$this->imagen_maquinaria08->ViewValue = "solicitud_imagen_maquinaria08_bv.php?" . "id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_inmueble01->Upload->DbValue)) {
			$this->imagen_inmueble01->HrefValue = "solicitud_imagen_inmueble01_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_inmueble01->HrefValue2 = "solicitud_imagen_inmueble01_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_inmueble06->Upload->DbValue)) {
			$this->imagen_inmueble06->HrefValue = "solicitud_imagen_inmueble06_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_inmueble06->HrefValue2 = "solicitud_imagen_inmueble06_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_inmueble07->Upload->DbValue)) {
			$this->imagen_inmueble07->HrefValue = "solicitud_imagen_inmueble07_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_inmueble07->HrefValue2 = "solicitud_imagen_inmueble07_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_inmueble08->Upload->DbValue)) {
			$this->imagen_inmueble08->HrefValue = "solicitud_imagen_inmueble08_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_inmueble08->HrefValue2 = "solicitud_imagen_inmueble08_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_vehiculo01->Upload->DbValue)) {
			$this->imagen_vehiculo01->HrefValue = "solicitud_imagen_vehiculo01_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_vehiculo01->HrefValue2 = "solicitud_imagen_vehiculo01_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_vehiculo04->Upload->DbValue)) {
			$this->imagen_vehiculo04->HrefValue = "solicitud_imagen_vehiculo04_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_vehiculo04->HrefValue2 = "solicitud_imagen_vehiculo04_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_vehiculo08->Upload->DbValue)) {
			$this->imagen_vehiculo08->HrefValue = "solicitud_imagen_vehiculo08_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_vehiculo08->HrefValue2 = "solicitud_imagen_vehiculo08_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_maquinaria01->Upload->DbValue)) {
			$this->imagen_maquinaria01->HrefValue = "solicitud_imagen_maquinaria01_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_maquinaria01->HrefValue2 = "solicitud_imagen_maquinaria01_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_maquinaria04->Upload->DbValue)) {
			$this->imagen_maquinaria04->HrefValue = "solicitud_imagen_maquinaria04_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_maquinaria04->HrefValue2 = "solicitud_imagen_maquinaria04_bv.php?id=" . $this->id->CurrentValue;
		...
		if (!empty($this->imagen_maquinaria08->Upload->DbValue)) {
			$this->imagen_maquinaria08->HrefValue = "solicitud_imagen_maquinaria08_bv.php?id=" . $this->id->CurrentValue;
		...
		$this->imagen_maquinaria08->HrefValue2 = "solicitud_imagen_maquinaria08_bv.php?id=" . $this->id->CurrentValue;
	...
	function RenderEditRow() {
		...
		if (strval($this->is_active->CurrentValue) <> "") {
			$this->is_active->EditValue = "";
			$arwrk = explode(",", strval($this->is_active->CurrentValue));
			$cnt = count($arwrk);
			for ($ari = 0; $ari < $cnt; $ari++) {
				$this->is_active->EditValue .= $this->is_active->OptionCaption(trim($arwrk[$ari]));
				if ($ari < $cnt-1) $this->is_active->EditValue .= ew_ViewOptionSeparator($ari);
			}
		} else {
			$this->is_active->EditValue = NULL;
		}
		$this->is_active->ViewCustomAttributes = "";
		...
		if (!ew_Empty($this->imagen_inmueble01->Upload->DbValue)) {
			$this->imagen_inmueble01->EditValue = "solicitud_imagen_inmueble01_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_inmueble01->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_inmueble01->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_inmueble06->Upload->DbValue)) {
			$this->imagen_inmueble06->EditValue = "solicitud_imagen_inmueble06_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_inmueble06->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_inmueble06->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_inmueble07->Upload->DbValue)) {
			$this->imagen_inmueble07->EditValue = "solicitud_imagen_inmueble07_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_inmueble07->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_inmueble07->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_inmueble08->Upload->DbValue)) {
			$this->imagen_inmueble08->EditValue = "solicitud_imagen_inmueble08_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_inmueble08->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_inmueble08->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_vehiculo01->Upload->DbValue)) {
			$this->imagen_vehiculo01->EditValue = "solicitud_imagen_vehiculo01_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_vehiculo01->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_vehiculo01->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_vehiculo04->Upload->DbValue)) {
			$this->imagen_vehiculo04->EditValue = "solicitud_imagen_vehiculo04_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_vehiculo04->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_vehiculo04->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_vehiculo08->Upload->DbValue)) {
			$this->imagen_vehiculo08->EditValue = "solicitud_imagen_vehiculo08_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_vehiculo08->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_vehiculo08->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_maquinaria01->Upload->DbValue)) {
			$this->imagen_maquinaria01->EditValue = "solicitud_imagen_maquinaria01_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_maquinaria01->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_maquinaria01->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_maquinaria04->Upload->DbValue)) {
			$this->imagen_maquinaria04->EditValue = "solicitud_imagen_maquinaria04_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_maquinaria04->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_maquinaria04->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!ew_Empty($this->imagen_maquinaria08->Upload->DbValue)) {
			$this->imagen_maquinaria08->EditValue = "solicitud_imagen_maquinaria08_bv.php?" . "id=" . $this->id->CurrentValue;
			$this->imagen_maquinaria08->IsBlobImage = ew_IsImageFile(ew_ContentExt(substr($this->imagen_maquinaria08->Upload->DbValue, 0, 11)));
		} else {
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->imagen_vehiculo02->Exportable) $Doc->ExportCaption($this->imagen_vehiculo02);
					...
					if ($this->imagen_mercaderia01->Exportable) $Doc->ExportCaption($this->imagen_mercaderia01);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->imagen_vehiculo02->Exportable) $Doc->ExportField($this->imagen_vehiculo02);
						...
						if ($this->imagen_mercaderia01->Exportable) $Doc->ExportField($this->imagen_mercaderia01);
	...
	function Row_Inserted($rsold, &$rsnew) {
	 ...
	 $idcurrent=$this->Connection()->Insert_ID();
			$tipoinmueble = array();
			$quantity2 = ew_Execute("INSERT INTO `cliente`(`name`, `lastname`, `email`, `address`, `phone`, `phone_cell`) VALUES ('".$rsnew["name"]."','".$rsnew["lastname"]."','".$rsnew["email"]."','".$rsnew["address"]."','".$rsnew["phone"]."','".$rsnew["cell"]."')");
			$new__id = ew_ExecuteScalar("SELECT LAST_INSERT_ID();");
			$tipoinmueble=explode(",", $rsnew["tipoinmueble"]);
			$tipovehiculo=explode(",", $rsnew["tipovehiculo"]);
