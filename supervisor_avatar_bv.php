...
$supervisor_avatar_blobview = NULL; // Initialize page object first

class csupervisor_avatar_blobview extends csupervisor {
	...
	// Page object name
	var $PageObjName = 'supervisor_avatar_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'supervisor');
	...
	function Page_Main() {
		...
		// SQL constructor in supervisor class, supervisorinfo.php
...
// Create page object
if (!isset($supervisor_avatar_blobview)) $supervisor_avatar_blobview = new csupervisor_avatar_blobview();

// Page init
$supervisor_avatar_blobview->Page_Init();

// Page main
$supervisor_avatar_blobview->Page_Main();
?>
<?php
$supervisor_avatar_blobview->Page_Terminate();
?>
