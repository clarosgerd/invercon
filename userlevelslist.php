...
<div id="xsr_1" class="ewRow">
	...
	<input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" class="form-control" value="<?php echo ew_HtmlEncode($userlevels_list->BasicSearch->getKeyword()) ?>">
...
<?php if (!isset($userlevels_list->Pager)) $userlevels_list->Pager = new cNumericPager($userlevels_list->StartRec, $userlevels_list->DisplayRecs, $userlevels_list->TotalRecs, $userlevels_list->RecRange, $userlevels_list->AutoHidePager) ?>
