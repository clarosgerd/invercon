...
$inspector_avatar_blobview = NULL; // Initialize page object first

class cinspector_avatar_blobview extends cinspector {
	...
	// Page object name
	var $PageObjName = 'inspector_avatar_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'inspector');
	...
	function Page_Main() {
		...
		// SQL constructor in inspector class, inspectorinfo.php
...
// Create page object
if (!isset($inspector_avatar_blobview)) $inspector_avatar_blobview = new cinspector_avatar_blobview();

// Page init
$inspector_avatar_blobview->Page_Init();

// Page main
$inspector_avatar_blobview->Page_Main();
?>
<?php
$inspector_avatar_blobview->Page_Terminate();
?>
