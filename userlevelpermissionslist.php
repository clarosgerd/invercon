...
<div id="xsr_1" class="ewRow">
	...
	<input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" class="form-control" value="<?php echo ew_HtmlEncode($userlevelpermissions_list->BasicSearch->getKeyword()) ?>">
...
<?php if (!isset($userlevelpermissions_list->Pager)) $userlevelpermissions_list->Pager = new cNumericPager($userlevelpermissions_list->StartRec, $userlevelpermissions_list->DisplayRecs, $userlevelpermissions_list->TotalRecs, $userlevelpermissions_list->RecRange, $userlevelpermissions_list->AutoHidePager) ?>
