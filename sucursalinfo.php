...
class csucursal extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('sucursal', 'sucursal', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// direccion
		$this->direccion = new cField('sucursal', 'sucursal', 'x_direccion', 'direccion', '`direccion`', '`direccion`', 201, -1, FALSE, '`direccion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->direccion->Sortable = TRUE; // Allow sort
		$this->fields['direccion'] = &$this->direccion;

		// nombre_contacto
		$this->nombre_contacto = new cField('sucursal', 'sucursal', 'x_nombre_contacto', 'nombre_contacto', '`nombre_contacto`', '`nombre_contacto`', 200, -1, FALSE, '`nombre_contacto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nombre_contacto->Sortable = TRUE; // Allow sort
		$this->fields['nombre_contacto'] = &$this->nombre_contacto;

		// email_contacto
		$this->email_contacto = new cField('sucursal', 'sucursal', 'x_email_contacto', 'email_contacto', '`email_contacto`', '`email_contacto`', 200, -1, FALSE, '`email_contacto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "sucursaledit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "sucursaladd.php")
	...
	function RenderEditRow() {
		...
		$this->email_contacto->EditValue = $this->email_contacto->CurrentValue;
