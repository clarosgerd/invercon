...
foficialcreditolist.Lists["x_id_rol"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"userlevels"};
foficialcreditolist.Lists["x_id_rol"].Data = "<?php echo $oficialcredito_list->id_rol->LookupFilterQuery(FALSE, "list") ?>";
