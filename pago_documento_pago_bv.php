...
$pago_documento_pago_blobview = NULL; // Initialize page object first

class cpago_documento_pago_blobview extends cpago {
	...
	// Page object name
	var $PageObjName = 'pago_documento_pago_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'pago');
...
// Create page object
if (!isset($pago_documento_pago_blobview)) $pago_documento_pago_blobview = new cpago_documento_pago_blobview();

// Page init
$pago_documento_pago_blobview->Page_Init();

// Page main
$pago_documento_pago_blobview->Page_Main();
?>
<?php
$pago_documento_pago_blobview->Page_Terminate();
?>
